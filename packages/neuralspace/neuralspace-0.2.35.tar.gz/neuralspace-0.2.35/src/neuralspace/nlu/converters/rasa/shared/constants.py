...
RESPONSES_SCHEMA_FILE = "nlu/converters/rasa/training_data/schemas/responses.yml"
SCHEMA_EXTENSIONS_FILE = "nlu/converters/rasa/pykwalify_extensions.py"
