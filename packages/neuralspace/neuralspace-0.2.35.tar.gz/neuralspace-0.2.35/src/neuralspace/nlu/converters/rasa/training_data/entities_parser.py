...
from neuralspace.nlu.converters.rasa.exceptions import InvalidEntityFormatException
from neuralspace.nlu.converters.rasa.message import Message
from neuralspace.nlu.converters.rasa.shared.constants import DOCS_URL_TRAINING_DATA_NLU
from neuralspace.nlu.converters.rasa.shared.io import validate_training_data
...
def get_validated_dict(json_str: Text) -> Dict[Text, Text]:
    ...
    """
    import json
    from neuralspace.nlu.converters.rasa.training_data.schemas import (
