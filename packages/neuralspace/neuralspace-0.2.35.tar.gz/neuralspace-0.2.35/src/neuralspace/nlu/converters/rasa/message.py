...
from neuralspace.nlu.converters.rasa.exceptions import RasaException
from neuralspace.nlu.converters.rasa.shared.constants import DIAGNOSTIC_DATA
...
class Message:
    ...
    def fingerprint(self) -> Text:
        ...
        """
        return deep_container_fingerprint(self.data)
    ...
    def find_overlapping_entities(
        ...
        for i, entity in enumerate(entities_with_location):
            for other_entity in entities_with_location[i + 1 :]:  # noqa : E203
