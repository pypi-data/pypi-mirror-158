...
from neuralspace.nlu.converters.rasa.shared.constants import INTENT_MESSAGE_PREFIX
from neuralspace.nlu.converters.rasa.shared.io import read_file, write_text_file
...
class TrainingDataWriter:
    ...
    def generate_list_item(text: Text) -> Text:
        ...
        from neuralspace.nlu.converters.rasa.shared.common import encode_string
    ...
    def generate_entity(
        ...
        if isinstance(entity, list):
            entity_text = text[
                entity[0][ENTITY_ATTRIBUTE_START] : entity[0][  # noqa : E203
                    ENTITY_ATTRIBUTE_END
                ]
            ]
            return (
            ...
            entity_text = text[
                entity[ENTITY_ATTRIBUTE_START] : entity[  # noqa : E203
                    ENTITY_ATTRIBUTE_END
                ]
            ]
