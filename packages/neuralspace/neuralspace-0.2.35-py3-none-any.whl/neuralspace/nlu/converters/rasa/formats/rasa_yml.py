...
from neuralspace.nlu.converters.rasa.data import is_likely_yaml_file
from neuralspace.nlu.converters.rasa.exceptions import YamlException
...
from neuralspace.nlu.converters.rasa.training_data import (
    entities_parser,
    synonyms_parser,
)
from neuralspace.nlu.converters.rasa.training_data.lookup_table_parser import (
    add_item_to_lookup_tables,
)
from neuralspace.nlu.converters.rasa.training_data.training_data import TrainingData
from neuralspace.nlu.converters.rasa.util import has_string_escape_chars
...
NLU_SCHEMA_FILE = "nlu/converters/rasa/training_data/schemas/nlu.yml"
...
class RasaYAMLReader(TrainingDataReader):
    ...
    def _parse_lookup(self, nlu_item: Dict[Text, Any]) -> None:
        ...
        for example in self._parse_multiline_example(lookup_item_name, examples):
            add_item_to_lookup_tables(lookup_item_name, example, self.lookup_tables)
