...
from neuralspace.nlu.converters.rasa.formats.dialogflow import (
    DIALOGFLOW_AGENT,
    DIALOGFLOW_ENTITIES,
...
from neuralspace.nlu.converters.rasa.shared.io import list_files, read_file
...
def _reader_factory(fformat: Text) -> Optional["TrainingDataReader"]:
    ...
    from neuralspace.nlu.converters.rasa.formats.luis import LuisReader
    from neuralspace.nlu.converters.rasa.formats.markdown import MarkdownReader
    from neuralspace.nlu.converters.rasa.formats.markdown_nlg import NLGMarkdownReader
    from neuralspace.nlu.converters.rasa.formats.rasa import RasaReader
    from neuralspace.nlu.converters.rasa.formats.rasa_yml import RasaYAMLReader
    from neuralspace.nlu.converters.rasa.formats.wit import WitReader
    from neuralspace.nlu.converters.rasa.formats.dialogflow import DialogflowReader
...
) -> Optional["TrainingData"]:  # noqa : F821
