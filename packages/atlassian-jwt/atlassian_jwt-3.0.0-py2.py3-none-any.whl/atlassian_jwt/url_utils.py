...
def canonicalize_request(http_method, url):
    ...
    Example:
        Give then following request
            ...
            GET "/path/to/service?zee_last=param&repeated=parameter
                1&first=param&repeated=parameter 2"
    ...
    # This code ensures that in python 2 if you pass a unicode string with
    # ascii characters that it will be converted into a str. If you pass a
    # unicode str with non-ascii characters then its not a valid URL so
    # we just error out.
    #
