...
class UsersManagementApi(object):
    ...
    def usersid_user_config_delete(self, id_user, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.usersid_user_config_delete(id_user, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str id_user: Hint: you can use 'me' or 'all' (required)
        :param UserConfigKeys keys:
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.usersid_user_config_delete_with_http_info(id_user, **kwargs)  # noqa: E501

    def usersid_user_config_delete_with_http_info(self, id_user, **kwargs):  # noqa: E501
        """Delete the given user configurations. deletions on keys prefixed by 'biapi.' (except callback_url) are ignored  # noqa: E501

        - keys (string): list of coma separated keys to be deleted.<br><br>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.usersid_user_config_delete_with_http_info(id_user, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method usersid_user_config_delete" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        if self.api_client.client_side_validation and ('id_user' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `id_user` when calling `usersid_user_config_delete`")  # noqa: E501
        ...
        if 'keys' in local_var_params:
            body_params = local_var_params['keys']
    ...
    def usersid_user_config_get(self, id_user, **kwargs):  # noqa: E501
        """Get configuration of a user.  # noqa: E501

        <br><br>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.usersid_user_config_get(id_user, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.usersid_user_config_get_with_http_info(id_user, **kwargs)  # noqa: E501

    def usersid_user_config_get_with_http_info(self, id_user, **kwargs):  # noqa: E501
        """Get configuration of a user.  # noqa: E501

        <br><br>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.usersid_user_config_get_with_http_info(id_user, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method usersid_user_config_get" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'id_user' is set
        if self.api_client.client_side_validation and ('id_user' not in local_var_params or  # noqa: E501
                                                        local_var_params['id_user'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `id_user` when calling `usersid_user_config_get`")  # noqa: E501
    ...
    def usersid_user_config_post(self, id_user, **kwargs):  # noqa: E501
        """Change configuration of a user. modifications on keys prefixed by 'biapi.' (except callback_url) are ignored  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.usersid_user_config_post(id_user, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.usersid_user_config_post_with_http_info(id_user, **kwargs)  # noqa: E501

    def usersid_user_config_post_with_http_info(self, id_user, **kwargs):  # noqa: E501
        """Change configuration of a user. modifications on keys prefixed by 'biapi.' (except callback_url) are ignored  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.usersid_user_config_post_with_http_info(id_user, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method usersid_user_config_post" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'id_user' is set
        if self.api_client.client_side_validation and ('id_user' not in local_var_params or  # noqa: E501
                                                        local_var_params['id_user'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `id_user` when calling `usersid_user_config_post`")  # noqa: E501
    ...
    def usersid_user_delete(self, id_user, **kwargs):  # noqa: E501
        """Delete the user  # noqa: E501

        This endpoint deletes the user.<br><br>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.usersid_user_delete(id_user, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.usersid_user_delete_with_http_info(id_user, **kwargs)  # noqa: E501

    def usersid_user_delete_with_http_info(self, id_user, **kwargs):  # noqa: E501
        """Delete the user  # noqa: E501

        This endpoint deletes the user.<br><br>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.usersid_user_delete_with_http_info(id_user, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method usersid_user_delete" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'id_user' is set
        if self.api_client.client_side_validation and ('id_user' not in local_var_params or  # noqa: E501
                                                        local_var_params['id_user'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `id_user` when calling `usersid_user_delete`")  # noqa: E501
    ...
    def usersid_user_token_post(self, id_user, application, **kwargs):  # noqa: E501
        """Create a token  # noqa: E501

        Create an access_token for this user and get it.<br><br>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.usersid_user_token_post(id_user, application, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.usersid_user_token_post_with_http_info(id_user, application, **kwargs)  # noqa: E501

    def usersid_user_token_post_with_http_info(self, id_user, application, **kwargs):  # noqa: E501
        """Create a token  # noqa: E501

        Create an access_token for this user and get it.<br><br>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.usersid_user_token_post_with_http_info(id_user, application, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(UserToken, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method usersid_user_token_post" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'id_user' is set
        if self.api_client.client_side_validation and ('id_user' not in local_var_params or  # noqa: E501
                                                        local_var_params['id_user'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `id_user` when calling `usersid_user_token_post`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('application' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `application` when calling `usersid_user_token_post`")  # noqa: E501
