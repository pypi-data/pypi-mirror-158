...
class OIDCApi(object):
    ...
    def oidc_whitelistid_whitelist_delete(self, id_whitelist, **kwargs):  # noqa: E501
        """Delete the supplied authorized redirect uri  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.oidc_whitelistid_whitelist_delete(id_whitelist, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.oidc_whitelistid_whitelist_delete_with_http_info(id_whitelist, **kwargs)  # noqa: E501

    def oidc_whitelistid_whitelist_delete_with_http_info(self, id_whitelist, **kwargs):  # noqa: E501
        """Delete the supplied authorized redirect uri  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.oidc_whitelistid_whitelist_delete_with_http_info(id_whitelist, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method oidc_whitelistid_whitelist_delete" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'id_whitelist' is set
        if self.api_client.client_side_validation and ('id_whitelist' not in local_var_params or  # noqa: E501
                                                        local_var_params['id_whitelist'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `id_whitelist` when calling `oidc_whitelistid_whitelist_delete`")  # noqa: E501
    ...
    def oidc_whitelistid_whitelist_post(self, id_whitelist, redirect_uri, **kwargs):  # noqa: E501
        """Edit a authorized redirect uri  # noqa: E501

        Edit the uri for the supplied authorized redirect uri.<br><br>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.oidc_whitelistid_whitelist_post(id_whitelist, redirect_uri, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.oidc_whitelistid_whitelist_post_with_http_info(id_whitelist, redirect_uri, **kwargs)  # noqa: E501

    def oidc_whitelistid_whitelist_post_with_http_info(self, id_whitelist, redirect_uri, **kwargs):  # noqa: E501
        """Edit a authorized redirect uri  # noqa: E501

        Edit the uri for the supplied authorized redirect uri.<br><br>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.oidc_whitelistid_whitelist_post_with_http_info(id_whitelist, redirect_uri, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method oidc_whitelistid_whitelist_post" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'id_whitelist' is set
        if self.api_client.client_side_validation and ('id_whitelist' not in local_var_params or  # noqa: E501
                                                        local_var_params['id_whitelist'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `id_whitelist` when calling `oidc_whitelistid_whitelist_post`")  # noqa: E501
        # verify the required parameter 'redirect_uri' is set
        if self.api_client.client_side_validation and ('redirect_uri' not in local_var_params or  # noqa: E501
                                                        local_var_params['redirect_uri'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `redirect_uri` when calling `oidc_whitelistid_whitelist_post`")  # noqa: E501
