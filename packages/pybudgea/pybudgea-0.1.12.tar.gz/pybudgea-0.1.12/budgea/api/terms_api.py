...
class TermsApi(object):
    ...
    def terms_get_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(Terms, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def terms_post(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param str expand:
        :param file file_content: file containing the terms, optional
        :param str language: two letters code of the language of the inserted terms if provided. default: 'fr'
    ...
    def termsid_term_post(self, id_term, **kwargs):  # noqa: E501
        """Add terms content for a language. Only for the active terms, there is no use to update obsolete terms  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.termsid_term_post(id_term, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param int id_term: (required)
        :param str expand:
        :param file file_content: file containing the terms
        :param str language: two letter code of the language to inserted
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.termsid_term_post_with_http_info(id_term, **kwargs)  # noqa: E501

    def termsid_term_post_with_http_info(self, id_term, **kwargs):  # noqa: E501
        """Add terms content for a language. Only for the active terms, there is no use to update obsolete terms  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.termsid_term_post_with_http_info(id_term, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method termsid_term_post" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'id_term' is set
        if self.api_client.client_side_validation and ('id_term' not in local_var_params or  # noqa: E501
                                                        local_var_params['id_term'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `id_term` when calling `termsid_term_post`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'id_term' in local_var_params:
            path_params['id_term'] = local_var_params['id_term']  # noqa: E501
    ...
    def usersid_user_terms_get(self, id_user, **kwargs):  # noqa: E501
        """Get active terms object for a specific user, only one terms can be active  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.usersid_user_terms_get(id_user, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.usersid_user_terms_get_with_http_info(id_user, **kwargs)  # noqa: E501

    def usersid_user_terms_get_with_http_info(self, id_user, **kwargs):  # noqa: E501
        """Get active terms object for a specific user, only one terms can be active  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.usersid_user_terms_get_with_http_info(id_user, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method usersid_user_terms_get" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        if self.api_client.client_side_validation and ('id_user' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `id_user` when calling `usersid_user_terms_get`")  # noqa: E501
    ...
    def usersid_user_terms_post(self, id_user, **kwargs):  # noqa: E501
        """Register user's consent for a specific terms id  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.usersid_user_terms_post(id_user, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.usersid_user_terms_post_with_http_info(id_user, **kwargs)  # noqa: E501

    def usersid_user_terms_post_with_http_info(self, id_user, **kwargs):  # noqa: E501
        """Register user's consent for a specific terms id  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.usersid_user_terms_post_with_http_info(id_user, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method usersid_user_terms_post" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'id_user' is set
        if self.api_client.client_side_validation and ('id_user' not in local_var_params or  # noqa: E501
                                                        local_var_params['id_user'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `id_user` when calling `usersid_user_terms_post`")  # noqa: E501
