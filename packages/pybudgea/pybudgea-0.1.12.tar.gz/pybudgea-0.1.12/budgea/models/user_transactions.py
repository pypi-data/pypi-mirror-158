...
"""
CodegenModel{parent='null', parentSchema='null', interfaces=null, allParents=null, parentModel=null, interfaceModels=null, children=null, anyOf=[], oneOf=[], allOf=[], name='UserTransactions', classname='UserTransactions', title='null', description='null', classVarName='user_transactions', modelJson='{
...
,required=True)
    ...
    def validates_transactions(self, transactions):
        if transactions is None:  # noqa: E501
            raise ValidationError("Invalid value for `transactions`, must not be `None`")  # noqa: E501
        pass
    ...
    def post_load(self, data, **kwargs):
        ...
        return UserTransactions(local_vars_configuration=config, **data)


class UserTransactions(object):
    """NOTE: This class is auto generated by OpenAPI Generator.
    Ref: https://openapi-generator.tech
    ...
    def __init__(self, total=missing, transactions=missing, local_vars_configuration=None):  # noqa: E501
        """UserTransactions - a model defined in OpenAPI"""  # noqa: E501
        ...
        if self.local_vars_configuration.client_side_validation:
            validated, errors = UserTransactionsSchema().load({
                'total': total,
                'transactions': transactions
            })
            for key in errors:
    ...
    def to_dict(self):
        ...
        return UserTransactionsSchema().dump(self)
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UserTransactions):
            return False
