...
"""
CodegenModel{parent='null', parentSchema='null', interfaces=null, allParents=null, parentModel=null, interfaceModels=null, children=null, anyOf=[], oneOf=[], allOf=[], name='Connections', classname='Connections', title='null', description='null', classVarName='connections', modelJson='{
...
class ConnectionsSchema(Schema):
...
,required=True)
    ...
    def post_load(self, data, **kwargs):
        ...
        return Connections(local_vars_configuration=config, **data)
...
class Connections(object):
    ...
    def __init__(self, connections=missing, total=missing, local_vars_configuration=None):  # noqa: E501
        ...
        if self.local_vars_configuration.client_side_validation:
            validated, errors = ConnectionsSchema().load({
                'connections': connections,
                'total': total
            })
            for key in errors:
    ...
    def to_dict(self):
        ...
        return ConnectionsSchema().dump(self)
