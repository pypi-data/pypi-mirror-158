...
"""
CodegenModel{parent='null', parentSchema='null', interfaces=null, allParents=null, parentModel=null, interfaceModels=null, children=null, anyOf=[], oneOf=[], allOf=[], name='UserBalance', classname='UserBalance', title='null', description='null', classVarName='user_balance', modelJson='{
  "type" : "object",
  "properties" : {
    "balance" : {
      "type" : "number",
  ...
  "items" : {
    "$ref" : "#/components/schemas/UserBalanceCurrency"
                    ...
                    symbol = '0', )', jsonSchema='{
  "$ref" : "#/components/schemas/UserBalanceCurrency"
}', minimum='null', maximum='null', exclusiveMinimum=false, exclusiveMaximum=false, hasMore=false, required=false, deprecated=false, secondaryParam=false, hasMoreNonReadOnly=false, isPrimitiveType=false, isModel=true, isContainer=false, isString=false, isNumeric=false, isInteger=false, isLong=false, isNumber=false, isFloat=false, isDouble=false, isByteArray=false, isBinary=false, isFile=false, isBoolean=false, isDate=false, isDateTime=false, isUuid=false, isUri=false, isEmail=false, isFreeFormObject=false, isListContainer=false, isMapContainer=false, isEnum=false, isReadOnly=false, isWriteOnly=false, isNullable=false, isSelfReference=false, isCircularReference=false, isDiscriminator=false, _enum=null, allowableValues=null, items=null, mostInnerItems=null, vendorExtensions={}, hasValidation=false, isInherited=false, discriminatorValue='null', nameInCamelCase='Currencies', nameInSnakeCase='CURRENCIES', enumName='null', maxItems=null, minItems=null, maxProperties=null, minProperties=null, uniqueItems=false, multipleOf=null, isXmlAttribute=false, xmlPrefix='null', xmlName='null', xmlNamespace='null', isXmlWrapped=false}, mostInnerItems=CodegenProperty{openApiType='UserBalanceCurrency', baseName='currencies', complexType='UserBalanceCurrency', getter='getCurrencies', setter='setCurrencies', description='null', dataType='UserBalanceCurrency', datatypeWithEnum='UserBalanceCurrency', dataFormat='null', name='currencies', min='null', max='null', defaultValue='null', defaultValueWithParam=' = data.currencies;', baseType='UserBalanceCurrency', containerType='null', title='null', unescapedDescription='null', maxLength=null, minLength=null, pattern='null', example='budgea.models.user_balance_currency.UserBalanceCurrency(
                    balance = 1.337, 
                    expenses = 1.337, 
                    incomes = 1.337, 
                    remains = 1.337, 
                    symbol = '0', )', jsonSchema='{
  "$ref" : "#/components/schemas/UserBalanceCurrency"
}', minimum='null', maximum='null', exclusiveMinimum=false, exclusiveMaximum=false, hasMore=false, required=false, deprecated=false, secondaryParam=false, hasMoreNonReadOnly=false, isPrimitiveType=false, isModel=true, isContainer=false, isString=false, isNumeric=false, isInteger=false, isLong=false, isNumber=false, isFloat=false, isDouble=false, isByteArray=false, isBinary=false, isFile=false, isBoolean=false, isDate=false, isDateTime=false, isUuid=false, isUri=false, isEmail=false, isFreeFormObject=false, isListContainer=false, isMapContainer=false, isEnum=false, isReadOnly=false, isWriteOnly=false, isNullable=false, isSelfReference=false, isCircularReference=false, isDiscriminator=false, _enum=null, allowableValues=null, items=null, mostInnerItems=null, vendorExtensions={}, hasValidation=false, isInherited=false, discriminatorValue='null', nameInCamelCase='Currencies', nameInSnakeCase='CURRENCIES', enumName='null', maxItems=null, minItems=null, maxProperties=null, minProperties=null, uniqueItems=false, multipleOf=null, isXmlAttribute=false, xmlPrefix='null', xmlName='null', xmlNamespace='null', isXmlWrapped=false}, vendorExtensions={}, hasValidation=false, isInherited=false, discriminatorValue='null', nameInCamelCase='Currencies', nameInSnakeCase='CURRENCIES', enumName='null', maxItems=null, minItems=null, maxProperties=null, minProperties=null, uniqueItems=false, multipleOf=null, isXmlAttribute=false, xmlPrefix='null', xmlName='null', xmlNamespace='null', isXmlWrapped=false}, CodegenProperty{openApiType='number', baseName='expenses', complexType='null', getter='getExpenses', setter='setExpenses', description='null', dataType='float', datatypeWithEnum='float', dataFormat='float', name='expenses', min='null', max='null', defaultValue='null', defaultValueWithParam=' = data.expenses;', baseType='float', containerType='null', title='null', unescapedDescription='null', maxLength=null, minLength=null, pattern='null', example='1.337', jsonSchema='{
  "type" : "number",
  "format" : "float"
}', minimum='null', maximum='null', exclusiveMinimum=false, exclusiveMaximum=false, hasMore=true, required=false, deprecated=false, secondaryParam=false, hasMoreNonReadOnly=false, isPrimitiveType=true, isModel=false, isContainer=false, isString=false, isNumeric=true, isInteger=false, isLong=false, isNumber=false, isFloat=true, isDouble=false, isByteArray=false, isBinary=false, isFile=false, isBoolean=false, isDate=false, isDateTime=false, isUuid=false, isUri=false, isEmail=false, isFreeFormObject=false, isListContainer=false, isMapContainer=false, isEnum=false, isReadOnly=false, isWriteOnly=false, isNullable=false, isSelfReference=false, isCircularReference=false, isDiscriminator=false, _enum=null, allowableValues=null, items=null, mostInnerItems=null, vendorExtensions={}, hasValidation=false, isInherited=false, discriminatorValue='null', nameInCamelCase='Expenses', nameInSnakeCase='EXPENSES', enumName='null', maxItems=null, minItems=null, maxProperties=null, minProperties=null, uniqueItems=false, multipleOf=null, isXmlAttribute=false, xmlPrefix='null', xmlName='null', xmlNamespace='null', isXmlWrapped=false}, CodegenProperty{openApiType='number', baseName='incomes', complexType='null', getter='getIncomes', setter='setIncomes', description='null', dataType='float', datatypeWithEnum='float', dataFormat='float', name='incomes', min='null', max='null', defaultValue='null', defaultValueWithParam=' = data.incomes;', baseType='float', containerType='null', title='null', unescapedDescription='null', maxLength=null, minLength=null, pattern='null', example='1.337', jsonSchema='{
  "type" : "number",
  "format" : "float"
}', minimum='null', maximum='null', exclusiveMinimum=false, exclusiveMaximum=false, hasMore=true, required=false, deprecated=false, secondaryParam=false, hasMoreNonReadOnly=false, isPrimitiveType=true, isModel=false, isContainer=false, isString=false, isNumeric=true, isInteger=false, isLong=false, isNumber=false, isFloat=true, isDouble=false, isByteArray=false, isBinary=false, isFile=false, isBoolean=false, isDate=false, isDateTime=false, isUuid=false, isUri=false, isEmail=false, isFreeFormObject=false, isListContainer=false, isMapContainer=false, isEnum=false, isReadOnly=false, isWriteOnly=false, isNullable=false, isSelfReference=false, isCircularReference=false, isDiscriminator=false, _enum=null, allowableValues=null, items=null, mostInnerItems=null, vendorExtensions={}, hasValidation=false, isInherited=false, discriminatorValue='null', nameInCamelCase='Incomes', nameInSnakeCase='INCOMES', enumName='null', maxItems=null, minItems=null, maxProperties=null, minProperties=null, uniqueItems=false, multipleOf=null, isXmlAttribute=false, xmlPrefix='null', xmlName='null', xmlNamespace='null', isXmlWrapped=false}, CodegenProperty{openApiType='string', baseName='max_date', complexType='null', getter='getMaxDate', setter='setMaxDate', description='null', dataType='date', datatypeWithEnum='date', dataFormat='date', name='max_date', min='null', max='null', defaultValue='null', defaultValueWithParam=' = data.max_date;', baseType='date', containerType='null', title='null', unescapedDescription='null', maxLength=null, minLength=null, pattern='null', example='datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date()', jsonSchema='{
  "type" : "string",
  "format" : "date"
}', minimum='null', maximum='null', exclusiveMinimum=false, exclusiveMaximum=false, hasMore=true, required=false, deprecated=false, secondaryParam=false, hasMoreNonReadOnly=false, isPrimitiveType=true, isModel=false, isContainer=false, isString=false, isNumeric=false, isInteger=false, isLong=false, isNumber=false, isFloat=false, isDouble=false, isByteArray=false, isBinary=false, isFile=false, isBoolean=false, isDate=true, isDateTime=false, isUuid=false, isUri=false, isEmail=false, isFreeFormObject=false, isListContainer=false, isMapContainer=false, isEnum=false, isReadOnly=false, isWriteOnly=false, isNullable=false, isSelfReference=false, isCircularReference=false, isDiscriminator=false, _enum=null, allowableValues=null, items=null, mostInnerItems=null, vendorExtensions={}, hasValidation=false, isInherited=false, discriminatorValue='null', nameInCamelCase='MaxDate', nameInSnakeCase='MAX_DATE', enumName='null', maxItems=null, minItems=null, maxProperties=null, minProperties=null, uniqueItems=false, multipleOf=null, isXmlAttribute=false, xmlPrefix='null', xmlName='null', xmlNamespace='null', isXmlWrapped=false}, CodegenProperty{openApiType='string', baseName='min_date', complexType='null', getter='getMinDate', setter='setMinDate', description='null', dataType='date', datatypeWithEnum='date', dataFormat='date', name='min_date', min='null', max='null', defaultValue='null', defaultValueWithParam=' = data.min_date;', baseType='date', containerType='null', title='null', unescapedDescription='null', maxLength=null, minLength=null, pattern='null', example='datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date()', jsonSchema='{
  "type" : "string",
  "format" : "date"
}', minimum='null', maximum='null', exclusiveMinimum=false, exclusiveMaximum=false, hasMore=true, required=false, deprecated=false, secondaryParam=false, hasMoreNonReadOnly=false, isPrimitiveType=true, isModel=false, isContainer=false, isString=false, isNumeric=false, isInteger=false, isLong=false, isNumber=false, isFloat=false, isDouble=false, isByteArray=false, isBinary=false, isFile=false, isBoolean=false, isDate=true, isDateTime=false, isUuid=false, isUri=false, isEmail=false, isFreeFormObject=false, isListContainer=false, isMapContainer=false, isEnum=false, isReadOnly=false, isWriteOnly=false, isNullable=false, isSelfReference=false, isCircularReference=false, isDiscriminator=false, _enum=null, allowableValues=null, items=null, mostInnerItems=null, vendorExtensions={}, hasValidation=false, isInherited=false, discriminatorValue='null', nameInCamelCase='MinDate', nameInSnakeCase='MIN_DATE', enumName='null', maxItems=null, minItems=null, maxProperties=null, minProperties=null, uniqueItems=false, multipleOf=null, isXmlAttribute=false, xmlPrefix='null', xmlName='null', xmlNamespace='null', isXmlWrapped=false}, CodegenProperty{openApiType='number', baseName='remains', complexType='null', getter='getRemains', setter='setRemains', description='null', dataType='float', datatypeWithEnum='float', dataFormat='float', name='remains', min='null', max='null', defaultValue='null', defaultValueWithParam=' = data.remains;', baseType='float', containerType='null', title='null', unescapedDescription='null', maxLength=null, minLength=null, pattern='null', example='1.337', jsonSchema='{
  "type" : "number",
  "format" : "float"
}', minimum='null', maximum='null', exclusiveMinimum=false, exclusiveMaximum=false, hasMore=true, required=false, deprecated=false, secondaryParam=false, hasMoreNonReadOnly=false, isPrimitiveType=true, isModel=false, isContainer=false, isString=false, isNumeric=true, isInteger=false, isLong=false, isNumber=false, isFloat=true, isDouble=false, isByteArray=false, isBinary=false, isFile=false, isBoolean=false, isDate=false, isDateTime=false, isUuid=false, isUri=false, isEmail=false, isFreeFormObject=false, isListContainer=false, isMapContainer=false, isEnum=false, isReadOnly=false, isWriteOnly=false, isNullable=false, isSelfReference=false, isCircularReference=false, isDiscriminator=false, _enum=null, allowableValues=null, items=null, mostInnerItems=null, vendorExtensions={}, hasValidation=false, isInherited=false, discriminatorValue='null', nameInCamelCase='Remains', nameInSnakeCase='REMAINS', enumName='null', maxItems=null, minItems=null, maxProperties=null, minProperties=null, uniqueItems=false, multipleOf=null, isXmlAttribute=false, xmlPrefix='null', xmlName='null', xmlNamespace='null', isXmlWrapped=false}, CodegenProperty{openApiType='array', baseName='transactions', complexType='Transaction', getter='getTransactions', setter='setTransactions', description='null', dataType='list[Transaction]', datatypeWithEnum='list[Transaction]', dataFormat='null', name='transactions', min='null', max='null', defaultValue='null', defaultValueWithParam=' = data.transactions;', baseType='list', containerType='array', title='null', unescapedDescription='null', maxLength=null, minLength=null, pattern='null', example='[
...
class UserBalanceSchema(Schema):
    ...
    converted = marshmallow.fields.Boolean()

    currencies = marshmallow.fields.List(budgea.fields.Nested('UserBalanceCurrency')('UserBalanceCurrencySchema', )
,)

    expenses = marshmallow.fields.Float()

    incomes = marshmallow.fields.Float()

    max_date = budgea.fields.Date()

    min_date = budgea.fields.Date()

    remains = marshmallow.fields.Float()
...
,)
    ...
    @validates("converted")
    def validates_converted(self, converted):
        pass

    @validates("currencies")
    def validates_currencies(self, currencies):
        pass

    @validates("expenses")
    def validates_expenses(self, expenses):
        pass

    @validates("incomes")
    def validates_incomes(self, incomes):
        pass

    @validates("max_date")
    def validates_max_date(self, max_date):
        pass

    @validates("min_date")
    def validates_min_date(self, min_date):
        pass

    @validates("remains")
    def validates_remains(self, remains):
        pass
    ...
    def post_load(self, data, **kwargs):
        ...
        return UserBalance(local_vars_configuration=config, **data)
...
class UserBalance(object):
    ...
    def __init__(self, balance=missing, converted=missing, currencies=missing, expenses=missing, incomes=missing, max_date=missing, min_date=missing, remains=missing, transactions=missing, local_vars_configuration=None):  # noqa: E501
        ...
        if self.local_vars_configuration.client_side_validation:
            validated, errors = UserBalanceSchema().load({
                'balance': balance,
                'converted': converted,
                'currencies': currencies,
                'expenses': expenses,
            ...
            self.converted = validated.converted
            self.currencies = validated.currencies
            self.expenses = validated.expenses
            self.incomes = validated.incomes
            self.max_date = validated.max_date
            self.min_date = validated.min_date
            self.remains = validated.remains
    ...
    def to_dict(self):
        ...
        return UserBalanceSchema().dump(self)
