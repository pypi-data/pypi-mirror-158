...
"""
CodegenModel{parent='null', parentSchema='null', interfaces=null, allParents=null, parentModel=null, interfaceModels=null, children=null, anyOf=[], oneOf=[], allOf=[], name='UserTransfers', classname='UserTransfers', title='null', description='null', classVarName='user_transfers', modelJson='{
  "required" : [ "transfers" ],
  "properties" : {
    "total" : {
      "type" : "number",
...
}', dataType='object', xmlPrefix='null', xmlNamespace='null', xmlName='null', classFilename='user_transfers', unescapedDescription='null', discriminator=null, defaultValue='null', arrayModelType='null', isAlias=false, isString=false, isInteger=false, isLong=false, isNumber=false, isNumeric=false, isFloat=false, isDouble=false, vars=[CodegenProperty{openApiType='number', baseName='total', complexType='null', getter='getTotal', setter='setTotal', description='total number of results', dataType='float', datatypeWithEnum='float', dataFormat='null', name='total', min='null', max='null', defaultValue='null', defaultValueWithParam=' = data.total;', baseType='float', containerType='null', title='null', unescapedDescription='total number of results', maxLength=null, minLength=null, pattern='null', example='1.337', jsonSchema='{
  "type" : "number",
  "description" : "total number of results"
}', minimum='null', maximum='null', exclusiveMinimum=false, exclusiveMaximum=false, hasMore=true, required=false, deprecated=false, secondaryParam=false, hasMoreNonReadOnly=false, isPrimitiveType=true, isModel=false, isContainer=false, isString=false, isNumeric=true, isInteger=false, isLong=false, isNumber=true, isFloat=false, isDouble=false, isByteArray=false, isBinary=false, isFile=false, isBoolean=false, isDate=false, isDateTime=false, isUuid=false, isUri=false, isEmail=false, isFreeFormObject=false, isListContainer=false, isMapContainer=false, isEnum=false, isReadOnly=false, isWriteOnly=false, isNullable=false, isSelfReference=false, isCircularReference=false, isDiscriminator=false, _enum=null, allowableValues=null, items=null, mostInnerItems=null, vendorExtensions={}, hasValidation=false, isInherited=false, discriminatorValue='null', nameInCamelCase='Total', nameInSnakeCase='TOTAL', enumName='null', maxItems=null, minItems=null, maxProperties=null, minProperties=null, uniqueItems=false, multipleOf=null, isXmlAttribute=false, xmlPrefix='null', xmlName='null', xmlNamespace='null', isXmlWrapped=false}, CodegenProperty{openApiType='array', baseName='transfers', complexType='Transfer', getter='getTransfers', setter='setTransfers', description='null', dataType='list[Transfer]', datatypeWithEnum='list[Transfer]', dataFormat='null', name='transfers', min='null', max='null', defaultValue='null', defaultValueWithParam=' = data.transfers;', baseType='list', containerType='array', title='null', unescapedDescription='null', maxLength=null, minLength=null, pattern='null', example='[
  ...
  "type" : "number",
  "description" : "total number of results"
}', minimum='null', maximum='null', exclusiveMinimum=false, exclusiveMaximum=false, hasMore=false, required=false, deprecated=false, secondaryParam=false, hasMoreNonReadOnly=false, isPrimitiveType=true, isModel=false, isContainer=false, isString=false, isNumeric=true, isInteger=false, isLong=false, isNumber=true, isFloat=false, isDouble=false, isByteArray=false, isBinary=false, isFile=false, isBoolean=false, isDate=false, isDateTime=false, isUuid=false, isUri=false, isEmail=false, isFreeFormObject=false, isListContainer=false, isMapContainer=false, isEnum=false, isReadOnly=false, isWriteOnly=false, isNullable=false, isSelfReference=false, isCircularReference=false, isDiscriminator=false, _enum=null, allowableValues=null, items=null, mostInnerItems=null, vendorExtensions={}, hasValidation=false, isInherited=false, discriminatorValue='null', nameInCamelCase='Total', nameInSnakeCase='TOTAL', enumName='null', maxItems=null, minItems=null, maxProperties=null, minProperties=null, uniqueItems=false, multipleOf=null, isXmlAttribute=false, xmlPrefix='null', xmlName='null', xmlNamespace='null', isXmlWrapped=false}], readOnlyVars=[], readWriteVars=[CodegenProperty{openApiType='number', baseName='total', complexType='null', getter='getTotal', setter='setTotal', description='total number of results', dataType='float', datatypeWithEnum='float', dataFormat='null', name='total', min='null', max='null', defaultValue='null', defaultValueWithParam=' = data.total;', baseType='float', containerType='null', title='null', unescapedDescription='total number of results', maxLength=null, minLength=null, pattern='null', example='1.337', jsonSchema='{
  "type" : "number",
  "description" : "total number of results"
}', minimum='null', maximum='null', exclusiveMinimum=false, exclusiveMaximum=false, hasMore=true, required=false, deprecated=false, secondaryParam=false, hasMoreNonReadOnly=false, isPrimitiveType=true, isModel=false, isContainer=false, isString=false, isNumeric=true, isInteger=false, isLong=false, isNumber=true, isFloat=false, isDouble=false, isByteArray=false, isBinary=false, isFile=false, isBoolean=false, isDate=false, isDateTime=false, isUuid=false, isUri=false, isEmail=false, isFreeFormObject=false, isListContainer=false, isMapContainer=false, isEnum=false, isReadOnly=false, isWriteOnly=false, isNullable=false, isSelfReference=false, isCircularReference=false, isDiscriminator=false, _enum=null, allowableValues=null, items=null, mostInnerItems=null, vendorExtensions={}, hasValidation=false, isInherited=false, discriminatorValue='null', nameInCamelCase='Total', nameInSnakeCase='TOTAL', enumName='null', maxItems=null, minItems=null, maxProperties=null, minProperties=null, uniqueItems=false, multipleOf=null, isXmlAttribute=false, xmlPrefix='null', xmlName='null', xmlNamespace='null', isXmlWrapped=false}, CodegenProperty{openApiType='array', baseName='transfers', complexType='Transfer', getter='getTransfers', setter='setTransfers', description='null', dataType='list[Transfer]', datatypeWithEnum='list[Transfer]', dataFormat='null', name='transfers', min='null', max='null', defaultValue='null', defaultValueWithParam=' = data.transfers;', baseType='list', containerType='array', title='null', unescapedDescription='null', maxLength=null, minLength=null, pattern='null', example='[
                    budgea.models.transfer.Transfer(
  ...
  "$ref" : "#/components/schemas/Transfer"
                    ...
                    webid = '0', )', jsonSchema='{
  "$ref" : "#/components/schemas/Transfer"
}', minimum='null', maximum='null', exclusiveMinimum=false, exclusiveMaximum=false, hasMore=false, required=false, deprecated=false, secondaryParam=false, hasMoreNonReadOnly=false, isPrimitiveType=false, isModel=true, isContainer=false, isString=false, isNumeric=false, isInteger=false, isLong=false, isNumber=false, isFloat=false, isDouble=false, isByteArray=false, isBinary=false, isFile=false, isBoolean=false, isDate=false, isDateTime=false, isUuid=false, isUri=false, isEmail=false, isFreeFormObject=false, isListContainer=false, isMapContainer=false, isEnum=false, isReadOnly=false, isWriteOnly=false, isNullable=false, isSelfReference=false, isCircularReference=false, isDiscriminator=false, _enum=null, allowableValues=null, items=null, mostInnerItems=null, vendorExtensions={}, hasValidation=false, isInherited=false, discriminatorValue='null', nameInCamelCase='Transfers', nameInSnakeCase='TRANSFERS', enumName='null', maxItems=null, minItems=null, maxProperties=null, minProperties=null, uniqueItems=false, multipleOf=null, isXmlAttribute=false, xmlPrefix='null', xmlName='null', xmlNamespace='null', isXmlWrapped=false}, vendorExtensions={}, hasValidation=false, isInherited=false, discriminatorValue='null', nameInCamelCase='Transfers', nameInSnakeCase='TRANSFERS', enumName='null', maxItems=null, minItems=null, maxProperties=null, minProperties=null, uniqueItems=false, multipleOf=null, isXmlAttribute=false, xmlPrefix='null', xmlName='null', xmlNamespace='null', isXmlWrapped=false}], parentVars=[], allowableValues=null, mandatory=[transfers], allMandatory=[transfers], imports=[Transfer], hasVars=true, emptyVars=false, hasMoreModels=false, hasEnums=false, isEnum=false, isNullable=false, hasRequired=true, hasOptional=true, isArrayModel=false, hasChildren=false, isMapModel=false, isDeprecated=false, hasOnlyReadOnly=false, externalDocumentation=null, vendorExtensions={}, additionalPropertiesType='null', maxProperties=null, minProperties=null, uniqueItems=false, maxItems=null, minItems=null, maxLength=null, minLength=null, exclusiveMinimum=false, exclusiveMaximum=false, minimum='null', maximum='null', pattern='null', multipleOf='null'}
"""


class UserTransfersSchema(Schema):
    """NOTE: This class is auto generated by OpenAPI Generator.
    Ref: https://openapi-generator.tech

    Do not edit the class manually.
    """
    total = marshmallow.fields.Number()
...
,required=True)
    ...
    def validates_transfers(self, transfers):
        if transfers is None:  # noqa: E501
            raise ValidationError("Invalid value for `transfers`, must not be `None`")  # noqa: E501
        pass
    ...
    def post_load(self, data, **kwargs):
        ...
        return UserTransfers(local_vars_configuration=config, **data)


class UserTransfers(object):
    """NOTE: This class is auto generated by OpenAPI Generator.
    Ref: https://openapi-generator.tech
    ...
    def __init__(self, total=missing, transfers=missing, local_vars_configuration=None):  # noqa: E501
        """UserTransfers - a model defined in OpenAPI"""  # noqa: E501
        ...
        if self.local_vars_configuration.client_side_validation:
            validated, errors = UserTransfersSchema().load({
                'total': total,
                'transfers': transfers
            })
            for key in errors:
    ...
    def to_dict(self):
        ...
        return UserTransfersSchema().dump(self)
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UserTransfers):
            return False
