...
"""
CodegenModel{parent='null', parentSchema='null', interfaces=null, allParents=null, parentModel=null, interfaceModels=null, children=null, anyOf=[], oneOf=[], allOf=[], name='UserInvestments', classname='UserInvestments', title='UserInvestments', description='null', classVarName='user_investments', modelJson='{
...
}', dataType='object', xmlPrefix='null', xmlNamespace='null', xmlName='null', classFilename='user_investments', unescapedDescription='null', discriminator=null, defaultValue='null', arrayModelType='null', isAlias=false, isString=false, isInteger=false, isLong=false, isNumber=false, isNumeric=false, isFloat=false, isDouble=false, vars=[CodegenProperty{openApiType='array', baseName='investments', complexType='Investment', getter='getInvestments', setter='setInvestments', description='null', dataType='list[Investment]', datatypeWithEnum='list[Investment]', dataFormat='null', name='investments', min='null', max='null', defaultValue='null', defaultValueWithParam=' = data.investments;', baseType='list', containerType='array', title='investments', unescapedDescription='null', maxLength=null, minLength=null, pattern='null', example='[
  ...
  "items" : {
    "$ref" : "#/components/schemas/Investment"
                    ...
                    unitvalue = 1.337, 
                    valuation = 1.337, 
                    vdate = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), )', jsonSchema='{
  "$ref" : "#/components/schemas/Investment"
...
,required=True)
    ...
    def validates_investments(self, investments):
        if investments is None:  # noqa: E501
            raise ValidationError("Invalid value for `investments`, must not be `None`")  # noqa: E501
        pass
    ...
    def post_load(self, data, **kwargs):
        ...
        return UserInvestments(local_vars_configuration=config, **data)


class UserInvestments(object):
    """NOTE: This class is auto generated by OpenAPI Generator.
    Ref: https://openapi-generator.tech
    ...
    def __init__(self, investments=missing, total=missing, local_vars_configuration=None):  # noqa: E501
        """UserInvestments - a model defined in OpenAPI"""  # noqa: E501
        ...
        if self.local_vars_configuration.client_side_validation:
            validated, errors = UserInvestmentsSchema().load({
                'investments': investments,
                'total': total
            })
            for key in errors:
    ...
    def to_dict(self):
        ...
        return UserInvestmentsSchema().dump(self)
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UserInvestments):
            return False
