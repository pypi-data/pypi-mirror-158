...
"""
CodegenModel{parent='null', parentSchema='null', interfaces=null, allParents=null, parentModel=null, interfaceModels=null, children=null, anyOf=[], oneOf=[], allOf=[], name='Push', classname='Push', title='null', description='null', classVarName='push', modelJson='{
  "type" : "object",
  "properties" : {
    "connection" : {
...
}', dataType='object', xmlPrefix='null', xmlNamespace='null', xmlName='null', classFilename='push', unescapedDescription='null', discriminator=null, defaultValue='null', arrayModelType='null', isAlias=false, isString=false, isInteger=false, isLong=false, isNumber=false, isNumeric=false, isFloat=false, isDouble=false, vars=[CodegenProperty{openApiType='Connection', baseName='connection', complexType='Connection', getter='getConnection', setter='setConnection', description='null', dataType='Connection', datatypeWithEnum='Connection', dataFormat='null', name='connection', min='null', max='null', defaultValue='null', defaultValueWithParam=' = data.connection;', baseType='Connection', containerType='null', title='null', unescapedDescription='null', maxLength=null, minLength=null, pattern='null', example='budgea.models.connection.Connection(
                    accounts = [
  ...
  "$ref" : "#/components/schemas/Connection"
}', minimum='null', maximum='null', exclusiveMinimum=false, exclusiveMaximum=false, hasMore=true, required=false, deprecated=false, secondaryParam=false, hasMoreNonReadOnly=false, isPrimitiveType=false, isModel=true, isContainer=false, isString=false, isNumeric=false, isInteger=false, isLong=false, isNumber=false, isFloat=false, isDouble=false, isByteArray=false, isBinary=false, isFile=false, isBoolean=false, isDate=false, isDateTime=false, isUuid=false, isUri=false, isEmail=false, isFreeFormObject=false, isListContainer=false, isMapContainer=false, isEnum=false, isReadOnly=false, isWriteOnly=false, isNullable=false, isSelfReference=false, isCircularReference=false, isDiscriminator=false, _enum=null, allowableValues=null, items=null, mostInnerItems=null, vendorExtensions={}, hasValidation=false, isInherited=false, discriminatorValue='null', nameInCamelCase='Connection', nameInSnakeCase='CONNECTION', enumName='null', maxItems=null, minItems=null, maxProperties=null, minProperties=null, uniqueItems=false, multipleOf=null, isXmlAttribute=false, xmlPrefix='null', xmlName='null', xmlNamespace='null', isXmlWrapped=false}, CodegenProperty{openApiType='string', baseName='push_type', complexType='null', getter='getPushType', setter='setPushType', description='null', dataType='str', datatypeWithEnum='str', dataFormat='null', name='push_type', min='null', max='null', defaultValue='null', defaultValueWithParam=' = data.push_type;', baseType='str', containerType='null', title='null', unescapedDescription='null', maxLength=null, minLength=null, pattern='null', example=''0'', jsonSchema='{
  "type" : "string"
}', minimum='null', maximum='null', exclusiveMinimum=false, exclusiveMaximum=false, hasMore=true, required=false, deprecated=false, secondaryParam=false, hasMoreNonReadOnly=false, isPrimitiveType=true, isModel=false, isContainer=false, isString=true, isNumeric=false, isInteger=false, isLong=false, isNumber=false, isFloat=false, isDouble=false, isByteArray=false, isBinary=false, isFile=false, isBoolean=false, isDate=false, isDateTime=false, isUuid=false, isUri=false, isEmail=false, isFreeFormObject=false, isListContainer=false, isMapContainer=false, isEnum=false, isReadOnly=false, isWriteOnly=false, isNullable=false, isSelfReference=false, isCircularReference=false, isDiscriminator=false, _enum=null, allowableValues=null, items=null, mostInnerItems=null, vendorExtensions={}, hasValidation=false, isInherited=false, discriminatorValue='null', nameInCamelCase='PushType', nameInSnakeCase='PUSH_TYPE', enumName='null', maxItems=null, minItems=null, maxProperties=null, minProperties=null, uniqueItems=false, multipleOf=null, isXmlAttribute=false, xmlPrefix='null', xmlName='null', xmlNamespace='null', isXmlWrapped=false}, CodegenProperty{openApiType='User', baseName='user', complexType='User', getter='getUser', setter='setUser', description='null', dataType='User', datatypeWithEnum='User', dataFormat='null', name='user', min='null', max='null', defaultValue='null', defaultValueWithParam=' = data.user;', baseType='User', containerType='null', title='null', unescapedDescription='null', maxLength=null, minLength=null, pattern='null', example='budgea.models.user.User(
                    id = 56, 
                    platform = 'web', 
                    signin = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), )', jsonSchema='{
  "$ref" : "#/components/schemas/User"
}', minimum='null', maximum='null', exclusiveMinimum=false, exclusiveMaximum=false, hasMore=false, required=false, deprecated=false, secondaryParam=false, hasMoreNonReadOnly=false, isPrimitiveType=false, isModel=true, isContainer=false, isString=false, isNumeric=false, isInteger=false, isLong=false, isNumber=false, isFloat=false, isDouble=false, isByteArray=false, isBinary=false, isFile=false, isBoolean=false, isDate=false, isDateTime=false, isUuid=false, isUri=false, isEmail=false, isFreeFormObject=false, isListContainer=false, isMapContainer=false, isEnum=false, isReadOnly=false, isWriteOnly=false, isNullable=false, isSelfReference=false, isCircularReference=false, isDiscriminator=false, _enum=null, allowableValues=null, items=null, mostInnerItems=null, vendorExtensions={}, hasValidation=false, isInherited=false, discriminatorValue='null', nameInCamelCase='User', nameInSnakeCase='USER', enumName='null', maxItems=null, minItems=null, maxProperties=null, minProperties=null, uniqueItems=false, multipleOf=null, isXmlAttribute=false, xmlPrefix='null', xmlName='null', xmlNamespace='null', isXmlWrapped=false}], allVars=[CodegenProperty{openApiType='Connection', baseName='connection', complexType='Connection', getter='getConnection', setter='setConnection', description='null', dataType='Connection', datatypeWithEnum='Connection', dataFormat='null', name='connection', min='null', max='null', defaultValue='null', defaultValueWithParam=' = data.connection;', baseType='Connection', containerType='null', title='null', unescapedDescription='null', maxLength=null, minLength=null, pattern='null', example='budgea.models.connection.Connection(
                    accounts = [
                        budgea.models.connection_account.ConnectionAccount(
                            balance = 1.337, 
                            bic = '0', 
...
class PushSchema(Schema):
    ...
    """
    connection = budgea.fields.Nested('Connection')('ConnectionSchema', )

    push_type = marshmallow.fields.String()

    user = budgea.fields.Nested('User')('UserSchema', )

    @validates("connection")
    def validates_connection(self, connection):
        pass

    @validates("push_type")
    def validates_push_type(self, push_type):
        pass

    @validates("user")
    def validates_user(self, user):
        pass
    ...
    def post_load(self, data, **kwargs):
        ...
        return Push(local_vars_configuration=config, **data)
...
class Push(object):
    ...
    def __init__(self, connection=missing, push_type=missing, user=missing, local_vars_configuration=None):  # noqa: E501
        """Push - a model defined in OpenAPI"""  # noqa: E501
        ...
        if self.local_vars_configuration.client_side_validation:
            validated, errors = PushSchema().load({
                'connection': connection,
                'push_type': push_type,
                'user': user
            })
            ...
            self.connection = validated.connection
            self.push_type = validated.push_type
            self.user = validated.user
        else:
