...
"""
CodegenModel{parent='null', parentSchema='null', interfaces=null, allParents=null, parentModel=null, interfaceModels=null, children=null, anyOf=[], oneOf=[], allOf=[], name='UserBalances', classname='UserBalances', title='null', description='null', classVarName='user_balances', modelJson='{
  "type" : "object",
  "properties" : {
    "balances" : {
      "type" : "array",
...
}', dataType='object', xmlPrefix='null', xmlNamespace='null', xmlName='null', classFilename='user_balances', unescapedDescription='null', discriminator=null, defaultValue='null', arrayModelType='null', isAlias=false, isString=false, isInteger=false, isLong=false, isNumber=false, isNumeric=false, isFloat=false, isDouble=false, vars=[CodegenProperty{openApiType='array', baseName='balances', complexType='UserBalance', getter='getBalances', setter='setBalances', description='null', dataType='list[UserBalance]', datatypeWithEnum='list[UserBalance]', dataFormat='null', name='balances', min='null', max='null', defaultValue='null', defaultValueWithParam=' = data.balances;', baseType='list', containerType='array', title='null', unescapedDescription='null', maxLength=null, minLength=null, pattern='null', example='[
                    budgea.models.user_balance.UserBalance(
                        balance = 1.337, 
                        converted = True, 
                        currencies = [
                        ...
                        expenses = 1.337, 
                        incomes = 1.337, 
                        max_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
                        min_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
                        remains = 1.337, 
                        transactions = [
  ...
  "$ref" : "#/components/schemas/UserBalance"
}', minimum='null', maximum='null', exclusiveMinimum=false, exclusiveMaximum=false, hasMore=false, required=false, deprecated=false, secondaryParam=false, hasMoreNonReadOnly=false, isPrimitiveType=false, isModel=true, isContainer=false, isString=false, isNumeric=false, isInteger=false, isLong=false, isNumber=false, isFloat=false, isDouble=false, isByteArray=false, isBinary=false, isFile=false, isBoolean=false, isDate=false, isDateTime=false, isUuid=false, isUri=false, isEmail=false, isFreeFormObject=false, isListContainer=false, isMapContainer=false, isEnum=false, isReadOnly=false, isWriteOnly=false, isNullable=false, isSelfReference=false, isCircularReference=false, isDiscriminator=false, _enum=null, allowableValues=null, items=null, mostInnerItems=null, vendorExtensions={}, hasValidation=false, isInherited=false, discriminatorValue='null', nameInCamelCase='Balances', nameInSnakeCase='BALANCES', enumName='null', maxItems=null, minItems=null, maxProperties=null, minProperties=null, uniqueItems=false, multipleOf=null, isXmlAttribute=false, xmlPrefix='null', xmlName='null', xmlNamespace='null', isXmlWrapped=false}, vendorExtensions={}, hasValidation=false, isInherited=false, discriminatorValue='null', nameInCamelCase='Balances', nameInSnakeCase='BALANCES', enumName='null', maxItems=null, minItems=null, maxProperties=null, minProperties=null, uniqueItems=false, multipleOf=null, isXmlAttribute=false, xmlPrefix='null', xmlName='null', xmlNamespace='null', isXmlWrapped=false}, CodegenProperty{openApiType='string', baseName='first_date', complexType='null', getter='getFirstDate', setter='setFirstDate', description='null', dataType='date', datatypeWithEnum='date', dataFormat='date', name='first_date', min='null', max='null', defaultValue='null', defaultValueWithParam=' = data.first_date;', baseType='date', containerType='null', title='null', unescapedDescription='null', maxLength=null, minLength=null, pattern='null', example='datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date()', jsonSchema='{
  "type" : "string",
  "format" : "date"
}', minimum='null', maximum='null', exclusiveMinimum=false, exclusiveMaximum=false, hasMore=true, required=false, deprecated=false, secondaryParam=false, hasMoreNonReadOnly=false, isPrimitiveType=true, isModel=false, isContainer=false, isString=false, isNumeric=false, isInteger=false, isLong=false, isNumber=false, isFloat=false, isDouble=false, isByteArray=false, isBinary=false, isFile=false, isBoolean=false, isDate=true, isDateTime=false, isUuid=false, isUri=false, isEmail=false, isFreeFormObject=false, isListContainer=false, isMapContainer=false, isEnum=false, isReadOnly=false, isWriteOnly=false, isNullable=false, isSelfReference=false, isCircularReference=false, isDiscriminator=false, _enum=null, allowableValues=null, items=null, mostInnerItems=null, vendorExtensions={}, hasValidation=false, isInherited=false, discriminatorValue='null', nameInCamelCase='FirstDate', nameInSnakeCase='FIRST_DATE', enumName='null', maxItems=null, minItems=null, maxProperties=null, minProperties=null, uniqueItems=false, multipleOf=null, isXmlAttribute=false, xmlPrefix='null', xmlName='null', xmlNamespace='null', isXmlWrapped=false}, CodegenProperty{openApiType='string', baseName='last_date', complexType='null', getter='getLastDate', setter='setLastDate', description='null', dataType='date', datatypeWithEnum='date', dataFormat='date', name='last_date', min='null', max='null', defaultValue='null', defaultValueWithParam=' = data.last_date;', baseType='date', containerType='null', title='null', unescapedDescription='null', maxLength=null, minLength=null, pattern='null', example='datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date()', jsonSchema='{
  "type" : "string",
  "format" : "date"
}', minimum='null', maximum='null', exclusiveMinimum=false, exclusiveMaximum=false, hasMore=true, required=false, deprecated=false, secondaryParam=false, hasMoreNonReadOnly=false, isPrimitiveType=true, isModel=false, isContainer=false, isString=false, isNumeric=false, isInteger=false, isLong=false, isNumber=false, isFloat=false, isDouble=false, isByteArray=false, isBinary=false, isFile=false, isBoolean=false, isDate=true, isDateTime=false, isUuid=false, isUri=false, isEmail=false, isFreeFormObject=false, isListContainer=false, isMapContainer=false, isEnum=false, isReadOnly=false, isWriteOnly=false, isNullable=false, isSelfReference=false, isCircularReference=false, isDiscriminator=false, _enum=null, allowableValues=null, items=null, mostInnerItems=null, vendorExtensions={}, hasValidation=false, isInherited=false, discriminatorValue='null', nameInCamelCase='LastDate', nameInSnakeCase='LAST_DATE', enumName='null', maxItems=null, minItems=null, maxProperties=null, minProperties=null, uniqueItems=false, multipleOf=null, isXmlAttribute=false, xmlPrefix='null', xmlName='null', xmlNamespace='null', isXmlWrapped=false}, CodegenProperty{openApiType='string', baseName='result_max_date', complexType='null', getter='getResultMaxDate', setter='setResultMaxDate', description='null', dataType='date', datatypeWithEnum='date', dataFormat='date', name='result_max_date', min='null', max='null', defaultValue='null', defaultValueWithParam=' = data.result_max_date;', baseType='date', containerType='null', title='null', unescapedDescription='null', maxLength=null, minLength=null, pattern='null', example='datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date()', jsonSchema='{
  "type" : "string",
  "format" : "date"
}', minimum='null', maximum='null', exclusiveMinimum=false, exclusiveMaximum=false, hasMore=true, required=false, deprecated=false, secondaryParam=false, hasMoreNonReadOnly=false, isPrimitiveType=true, isModel=false, isContainer=false, isString=false, isNumeric=false, isInteger=false, isLong=false, isNumber=false, isFloat=false, isDouble=false, isByteArray=false, isBinary=false, isFile=false, isBoolean=false, isDate=true, isDateTime=false, isUuid=false, isUri=false, isEmail=false, isFreeFormObject=false, isListContainer=false, isMapContainer=false, isEnum=false, isReadOnly=false, isWriteOnly=false, isNullable=false, isSelfReference=false, isCircularReference=false, isDiscriminator=false, _enum=null, allowableValues=null, items=null, mostInnerItems=null, vendorExtensions={}, hasValidation=false, isInherited=false, discriminatorValue='null', nameInCamelCase='ResultMaxDate', nameInSnakeCase='RESULT_MAX_DATE', enumName='null', maxItems=null, minItems=null, maxProperties=null, minProperties=null, uniqueItems=false, multipleOf=null, isXmlAttribute=false, xmlPrefix='null', xmlName='null', xmlNamespace='null', isXmlWrapped=false}, CodegenProperty{openApiType='string', baseName='result_min_date', complexType='null', getter='getResultMinDate', setter='setResultMinDate', description='null', dataType='date', datatypeWithEnum='date', dataFormat='date', name='result_min_date', min='null', max='null', defaultValue='null', defaultValueWithParam=' = data.result_min_date;', baseType='date', containerType='null', title='null', unescapedDescription='null', maxLength=null, minLength=null, pattern='null', example='datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date()', jsonSchema='{
  "type" : "string",
  "format" : "date"
}', minimum='null', maximum='null', exclusiveMinimum=false, exclusiveMaximum=false, hasMore=true, required=false, deprecated=false, secondaryParam=false, hasMoreNonReadOnly=false, isPrimitiveType=true, isModel=false, isContainer=false, isString=false, isNumeric=false, isInteger=false, isLong=false, isNumber=false, isFloat=false, isDouble=false, isByteArray=false, isBinary=false, isFile=false, isBoolean=false, isDate=true, isDateTime=false, isUuid=false, isUri=false, isEmail=false, isFreeFormObject=false, isListContainer=false, isMapContainer=false, isEnum=false, isReadOnly=false, isWriteOnly=false, isNullable=false, isSelfReference=false, isCircularReference=false, isDiscriminator=false, _enum=null, allowableValues=null, items=null, mostInnerItems=null, vendorExtensions={}, hasValidation=false, isInherited=false, discriminatorValue='null', nameInCamelCase='ResultMinDate', nameInSnakeCase='RESULT_MIN_DATE', enumName='null', maxItems=null, minItems=null, maxProperties=null, minProperties=null, uniqueItems=false, multipleOf=null, isXmlAttribute=false, xmlPrefix='null', xmlName='null', xmlNamespace='null', isXmlWrapped=false}, CodegenProperty{openApiType='integer', baseName='total', complexType='null', getter='getTotal', setter='setTotal', description='null', dataType='int', datatypeWithEnum='int', dataFormat='null', name='total', min='null', max='null', defaultValue='null', defaultValueWithParam=' = data.total;', baseType='int', containerType='null', title='null', unescapedDescription='null', maxLength=null, minLength=null, pattern='null', example='56', jsonSchema='{
  "type" : "integer"
}', minimum='null', maximum='null', exclusiveMinimum=false, exclusiveMaximum=false, hasMore=false, required=false, deprecated=false, secondaryParam=false, hasMoreNonReadOnly=false, isPrimitiveType=true, isModel=false, isContainer=false, isString=false, isNumeric=true, isInteger=true, isLong=false, isNumber=false, isFloat=false, isDouble=false, isByteArray=false, isBinary=false, isFile=false, isBoolean=false, isDate=false, isDateTime=false, isUuid=false, isUri=false, isEmail=false, isFreeFormObject=false, isListContainer=false, isMapContainer=false, isEnum=false, isReadOnly=false, isWriteOnly=false, isNullable=false, isSelfReference=false, isCircularReference=false, isDiscriminator=false, _enum=null, allowableValues=null, items=null, mostInnerItems=null, vendorExtensions={}, hasValidation=false, isInherited=false, discriminatorValue='null', nameInCamelCase='Total', nameInSnakeCase='TOTAL', enumName='null', maxItems=null, minItems=null, maxProperties=null, minProperties=null, uniqueItems=false, multipleOf=null, isXmlAttribute=false, xmlPrefix='null', xmlName='null', xmlNamespace='null', isXmlWrapped=false}], allVars=[CodegenProperty{openApiType='array', baseName='balances', complexType='UserBalance', getter='getBalances', setter='setBalances', description='null', dataType='list[UserBalance]', datatypeWithEnum='list[UserBalance]', dataFormat='null', name='balances', min='null', max='null', defaultValue='null', defaultValueWithParam=' = data.balances;', baseType='list', containerType='array', title='null', unescapedDescription='null', maxLength=null, minLength=null, pattern='null', example='[
                    budgea.models.user_balance.UserBalance(
                        balance = 1.337, 
                        converted = True, 
                        currencies = [
  ...
  "type" : "integer"
}', minimum='null', maximum='null', exclusiveMinimum=false, exclusiveMaximum=false, hasMore=false, required=false, deprecated=false, secondaryParam=false, hasMoreNonReadOnly=false, isPrimitiveType=true, isModel=false, isContainer=false, isString=false, isNumeric=true, isInteger=true, isLong=false, isNumber=false, isFloat=false, isDouble=false, isByteArray=false, isBinary=false, isFile=false, isBoolean=false, isDate=false, isDateTime=false, isUuid=false, isUri=false, isEmail=false, isFreeFormObject=false, isListContainer=false, isMapContainer=false, isEnum=false, isReadOnly=false, isWriteOnly=false, isNullable=false, isSelfReference=false, isCircularReference=false, isDiscriminator=false, _enum=null, allowableValues=null, items=null, mostInnerItems=null, vendorExtensions={}, hasValidation=false, isInherited=false, discriminatorValue='null', nameInCamelCase='Total', nameInSnakeCase='TOTAL', enumName='null', maxItems=null, minItems=null, maxProperties=null, minProperties=null, uniqueItems=false, multipleOf=null, isXmlAttribute=false, xmlPrefix='null', xmlName='null', xmlNamespace='null', isXmlWrapped=false}], parentVars=[], allowableValues=null, mandatory=[], allMandatory=[], imports=[UserBalance], hasVars=true, emptyVars=false, hasMoreModels=false, hasEnums=false, isEnum=false, isNullable=false, hasRequired=false, hasOptional=true, isArrayModel=false, hasChildren=false, isMapModel=false, isDeprecated=false, hasOnlyReadOnly=false, externalDocumentation=null, vendorExtensions={}, additionalPropertiesType='null', maxProperties=null, minProperties=null, uniqueItems=false, maxItems=null, minItems=null, maxLength=null, minLength=null, exclusiveMinimum=false, exclusiveMaximum=false, minimum='null', maximum='null', pattern='null', multipleOf='null'}
"""


class UserBalancesSchema(Schema):
    """NOTE: This class is auto generated by OpenAPI Generator.
    Ref: https://openapi-generator.tech

    Do not edit the class manually.
    """
    balances = marshmallow.fields.List(budgea.fields.Nested('UserBalance')('UserBalanceSchema', )
,)

    first_date = budgea.fields.Date()

    last_date = budgea.fields.Date()

    result_max_date = budgea.fields.Date()

    result_min_date = budgea.fields.Date()

    total = marshmallow.fields.Integer()

    @validates("balances")
    def validates_balances(self, balances):
        pass

    @validates("first_date")
    def validates_first_date(self, first_date):
        pass

    @validates("last_date")
    def validates_last_date(self, last_date):
        pass

    @validates("result_max_date")
    def validates_result_max_date(self, result_max_date):
        pass

    @validates("result_min_date")
    def validates_result_min_date(self, result_min_date):
        pass

    @validates("total")
    def validates_total(self, total):
        pass
    ...
    def post_load(self, data, **kwargs):
        ...
        return UserBalances(local_vars_configuration=config, **data)
...
class UserBalances(object):
    ...
    def __init__(self, balances=missing, first_date=missing, last_date=missing, result_max_date=missing, result_min_date=missing, total=missing, local_vars_configuration=None):  # noqa: E501
        ...
        if self.local_vars_configuration.client_side_validation:
            validated, errors = UserBalancesSchema().load({
                'balances': balances,
                'first_date': first_date,
                'last_date': last_date,
                'result_max_date': result_max_date,
            ...
            self.balances = validated.balances
            self.first_date = validated.first_date
            self.last_date = validated.last_date
            self.result_max_date = validated.result_max_date
            self.result_min_date = validated.result_min_date
            self.total = validated.total
        else:
    ...
    def to_dict(self):
        ...
        return UserBalancesSchema().dump(self)
