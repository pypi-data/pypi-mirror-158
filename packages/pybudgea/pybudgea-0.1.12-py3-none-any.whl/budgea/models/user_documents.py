...
"""
CodegenModel{parent='null', parentSchema='null', interfaces=null, allParents=null, parentModel=null, interfaceModels=null, children=null, anyOf=[], oneOf=[], allOf=[], name='UserDocuments', classname='UserDocuments', title='null', description='null', classVarName='user_documents', modelJson='{
  "required" : [ "documents" ],
  "properties" : {
    "documents" : {
      "type" : "array",
...
}', dataType='object', xmlPrefix='null', xmlNamespace='null', xmlName='null', classFilename='user_documents', unescapedDescription='null', discriminator=null, defaultValue='null', arrayModelType='null', isAlias=false, isString=false, isInteger=false, isLong=false, isNumber=false, isNumeric=false, isFloat=false, isDouble=false, vars=[CodegenProperty{openApiType='array', baseName='documents', complexType='Document', getter='getDocuments', setter='setDocuments', description='null', dataType='list[Document]', datatypeWithEnum='list[Document]', dataFormat='null', name='documents', min='null', max='null', defaultValue='null', defaultValueWithParam=' = data.documents;', baseType='list', containerType='array', title='null', unescapedDescription='null', maxLength=null, minLength=null, pattern='null', example='[
...
,required=True)
    ...
    def post_load(self, data, **kwargs):
        ...
        return UserDocuments(local_vars_configuration=config, **data)


class UserDocuments(object):
    """NOTE: This class is auto generated by OpenAPI Generator.
    Ref: https://openapi-generator.tech
    ...
    def __init__(self, documents=missing, total=missing, local_vars_configuration=None):  # noqa: E501
        """UserDocuments - a model defined in OpenAPI"""  # noqa: E501
        ...
        if self.local_vars_configuration.client_side_validation:
            validated, errors = UserDocumentsSchema().load({
                'documents': documents,
                'total': total
            })
            for key in errors:
            ...
            self.documents = validated.documents
    ...
    def to_dict(self):
        ...
        return UserDocumentsSchema().dump(self)
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UserDocuments):
            return False
