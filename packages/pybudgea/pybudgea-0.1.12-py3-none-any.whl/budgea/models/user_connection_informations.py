...
"""
CodegenModel{parent='null', parentSchema='null', interfaces=null, allParents=null, parentModel=null, interfaceModels=null, children=null, anyOf=[], oneOf=[], allOf=[], name='UserConnectionInformations', classname='UserConnectionInformations', title='null', description='null', classVarName='user_connection_informations', modelJson='{
...
}', dataType='object', xmlPrefix='null', xmlNamespace='null', xmlName='null', classFilename='user_connection_informations', unescapedDescription='null', discriminator=null, defaultValue='null', arrayModelType='null', isAlias=false, isString=false, isInteger=false, isLong=false, isNumber=false, isNumeric=false, isFloat=false, isDouble=false, vars=[CodegenProperty{openApiType='array', baseName='connections', complexType='Connection', getter='getConnections', setter='setConnections', description='null', dataType='list[Connection]', datatypeWithEnum='list[Connection]', dataFormat='null', name='connections', min='null', max='null', defaultValue='null', defaultValueWithParam=' = data.connections;', baseType='list', containerType='array', title='null', unescapedDescription='null', maxLength=null, minLength=null, pattern='null', example='[
  ...
  "$ref" : "#/components/schemas/Connection"
}', minimum='null', maximum='null', exclusiveMinimum=false, exclusiveMaximum=false, hasMore=false, required=false, deprecated=false, secondaryParam=false, hasMoreNonReadOnly=false, isPrimitiveType=false, isModel=true, isContainer=false, isString=false, isNumeric=false, isInteger=false, isLong=false, isNumber=false, isFloat=false, isDouble=false, isByteArray=false, isBinary=false, isFile=false, isBoolean=false, isDate=false, isDateTime=false, isUuid=false, isUri=false, isEmail=false, isFreeFormObject=false, isListContainer=false, isMapContainer=false, isEnum=false, isReadOnly=false, isWriteOnly=false, isNullable=false, isSelfReference=false, isCircularReference=false, isDiscriminator=false, _enum=null, allowableValues=null, items=null, mostInnerItems=null, vendorExtensions={}, hasValidation=false, isInherited=false, discriminatorValue='null', nameInCamelCase='Connections', nameInSnakeCase='CONNECTIONS', enumName='null', maxItems=null, minItems=null, maxProperties=null, minProperties=null, uniqueItems=false, multipleOf=null, isXmlAttribute=false, xmlPrefix='null', xmlName='null', xmlNamespace='null', isXmlWrapped=false}, vendorExtensions={}, hasValidation=false, isInherited=false, discriminatorValue='null', nameInCamelCase='Connections', nameInSnakeCase='CONNECTIONS', enumName='null', maxItems=null, minItems=null, maxProperties=null, minProperties=null, uniqueItems=false, multipleOf=null, isXmlAttribute=false, xmlPrefix='null', xmlName='null', xmlNamespace='null', isXmlWrapped=false}, CodegenProperty{openApiType='integer', baseName='total', complexType='null', getter='getTotal', setter='setTotal', description='total number of results', dataType='int', datatypeWithEnum='int', dataFormat='null', name='total', min='null', max='null', defaultValue='null', defaultValueWithParam=' = data.total;', baseType='int', containerType='null', title='null', unescapedDescription='total number of results', maxLength=null, minLength=null, pattern='null', example='56', jsonSchema='{
  "type" : "integer",
  "description" : "total number of results"
...
,required=True)
    ...
    def validates_connections(self, connections):
        if connections is None:  # noqa: E501
            raise ValidationError("Invalid value for `connections`, must not be `None`")  # noqa: E501
        pass
    ...
    def post_load(self, data, **kwargs):
        ...
        return UserConnectionInformations(local_vars_configuration=config, **data)


class UserConnectionInformations(object):
    """NOTE: This class is auto generated by OpenAPI Generator.
    Ref: https://openapi-generator.tech
    ...
    def __init__(self, connections=missing, total=missing, local_vars_configuration=None):  # noqa: E501
        """UserConnectionInformations - a model defined in OpenAPI"""  # noqa: E501
        ...
        if self.local_vars_configuration.client_side_validation:
            validated, errors = UserConnectionInformationsSchema().load({
                'connections': connections,
                'total': total
            })
            for key in errors:
    ...
    def to_dict(self):
        ...
        return UserConnectionInformationsSchema().dump(self)
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UserConnectionInformations):
            return False
