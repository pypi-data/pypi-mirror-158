...
"""
CodegenModel{parent='null', parentSchema='null', interfaces=null, allParents=null, parentModel=null, interfaceModels=null, children=null, anyOf=[], oneOf=[], allOf=[], name='UserAccounts', classname='UserAccounts', title='null', description='null', classVarName='user_accounts', modelJson='{
  "required" : [ "accounts" ],
  "properties" : {
    "accounts" : {
      "type" : "array",
...
}', dataType='object', xmlPrefix='null', xmlNamespace='null', xmlName='null', classFilename='user_accounts', unescapedDescription='null', discriminator=null, defaultValue='null', arrayModelType='null', isAlias=false, isString=false, isInteger=false, isLong=false, isNumber=false, isNumeric=false, isFloat=false, isDouble=false, vars=[CodegenProperty{openApiType='array', baseName='accounts', complexType='Account', getter='getAccounts', setter='setAccounts', description='null', dataType='list[Account]', datatypeWithEnum='list[Account]', dataFormat='null', name='accounts', min='null', max='null', defaultValue='null', defaultValueWithParam=' = data.accounts;', baseType='list', containerType='array', title='null', unescapedDescription='null', maxLength=null, minLength=null, pattern='null', example='[
                    budgea.models.account.Account(
                        balance = 1.337, 
                        bookmarked = 56, 
                        coming = 1.337, 
                        company_name = '0', 
                        ...
                        disabled = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        display = True, 
                        error = '0', 
                        iban = '0', 
                        id = 56, 
...
,required=True)
    ...
    def validates_accounts(self, accounts):
        if accounts is None:  # noqa: E501
            raise ValidationError("Invalid value for `accounts`, must not be `None`")  # noqa: E501
        pass
    ...
    def post_load(self, data, **kwargs):
        ...
        return UserAccounts(local_vars_configuration=config, **data)
...
class UserAccounts(object):
    ...
    def __init__(self, accounts=missing, total=missing, local_vars_configuration=None):  # noqa: E501
        ...
        if self.local_vars_configuration.client_side_validation:
            validated, errors = UserAccountsSchema().load({
                'accounts': accounts,
                'total': total
            })
            for key in errors:
    ...
    def to_dict(self):
        ...
        return UserAccountsSchema().dump(self)
