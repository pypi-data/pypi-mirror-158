import os, random
import requests, user_agent, json, uuid, re, mechanize, instaloader
...
class check_email:
    ...
    def instagram(email: str) -> str:
        ...
        data = 'signed_body=acd10e3607b478b845184ff7af8d796aec14425d5f00276567ea0876b1ff2630.%7B%22_csrftoken%22%3A%22rZj5Y3kci0OWbO8AMUi0mWwcBnUgnJDY%22%2C%22q%22%3A%22' + str(
            email) + '%22%2C%22_uid%22%3A%226758469524%22%2C%22guid%22%3A%22a475d908-a663-4895-ac60-c0ab0853d6df%22%2C%22device_id%22%3A%22android-1a9898fad127fa2a%22%2C%22_uuid%22%3A%22a475d908-a663-4895-ac60-c0ab0853d6df%22%7D&ig_sig_key_version=4'
        res = requests.post(url, headers=headers, data=data).json()
        try:
            if 'multiple_users_found' in res:
                return {'status': 'Success', 'email': True}
    ...
    def face(email: str) -> str:
        url = "https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email=" + str(
            email) + "&locale=en_US&password=@GDOTools&sdk=ios&generate_session_cookies=1&sig=3f555f99fb61fcd7aa0c44f58f522ef6"
