...
class User:
    ...
    def get_user_id(user_id: Optional[int]) -> int:
        ...
        If the passed user_id is None, then the id of the currently logged-in user will be returned.
        ...
        """
        if not user_id:
            user_id = User.details()["id"]  # type: ignore
    ...
    @staticmethod
    def disable(user: Union[int, List[int], str, List[str]]) -> pd.DataFrame:
    ...
    @staticmethod
    def enable(user: Union[int, List[int], str, List[str]]) -> pd.DataFrame:
    ...
    def details(
        ...
        return Client._post_data(
            relative_url=f"/user/details", data=dict(user_id_or_name=user)
        )
    ...
    @staticmethod
    def _get_mfa_provision_url() -> str:
        ...
        response = Client._get_data(relative_url=f"/user/mfa/generate")
        return response["mfa_url"]

    @staticmethod
    def enable_mfa() -> PilImage:
        ...
        ```
        """
        qr_code = qrcode.make(User._get_mfa_provision_url())
    ...
    @staticmethod
    def disable_mfa(user: Optional[Union[int, str]] = None) -> pd.DataFrame:
        ...
        user_id = User.details(user=user)["id"]
        response = Client._get_data(relative_url=f"/user/mfa/{user_id}/disable")
