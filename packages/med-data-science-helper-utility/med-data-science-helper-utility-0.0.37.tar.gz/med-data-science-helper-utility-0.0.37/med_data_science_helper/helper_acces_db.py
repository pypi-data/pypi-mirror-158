...
def get_siagie_por_anio(anio,id_grado=None,id_grado_list=None,modalidad=None,modalidad_list=None,dtypes_columns=None,
                        ...
                        id_persona_df=None,id_nivel=None,id_nivel_list=None,macro_region=None,ser_anio_menos_1=False, desercion=False, reduce_mem_usage=False):  
    ...
    if macro_region   is not None:        
        ...
        if ser_anio_menos_1:
            ...
            df_serv = pd.concat([get_df_servicios(macro_region=macro_region,anio=anio) , 
                                      get_df_servicios(macro_region=macro_region,anio=anio_menos_1) ])
