...
4,5,6,7 - robotic arm
    ...
    def measure_distance(self, flags = [1,0,0,1]):
        '''
        Measure distances to avoid collision. 
        We cannot put this funciton in a side thread loop. Must use it in the main thread.
    ...
    def get_image(self):
        ...
        if acc.RUNNING == False:
            ...
            self.measure_distance(flags=[1,1,0,0]) # update distances
            s = "Distances[FBLR] = " + str(self.distance_F) + str(self.distance_B) + ', ' + str(self.distance_L) + ',' + str(self.distance_R)
