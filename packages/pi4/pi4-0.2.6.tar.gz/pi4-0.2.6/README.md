...
This package also include an 'ai' module. The module is mainly targeted at edge devices (largely depends on tf-lite and other lightweight frameworks). However, it can also be used for general-purposed ai and image processing applications. 
