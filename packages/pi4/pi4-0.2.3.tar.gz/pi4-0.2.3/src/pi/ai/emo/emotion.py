...
It uses a two-step process: 1. detect face by opencv (haar cascades) 2. emotion classification on the detected face.
'''
...
ROOT = os.path.dirname(__file__)
 # Load the model
model = Sequential()
classifier = load_model(ROOT + '/ferjj.h5') # This model has a set of 6 classes
...
face_classifier = cv2.CascadeClassifier(ROOT + '/Haarcascades/haarcascade_frontalface_default.xml')
