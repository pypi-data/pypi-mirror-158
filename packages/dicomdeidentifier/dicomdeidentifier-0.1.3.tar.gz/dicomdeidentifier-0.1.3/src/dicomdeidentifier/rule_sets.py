...
from idiscore.operators import Remove, Keep, Empty, HashUID, Replace
...
timeshift_custom_ruleset = RuleSet(
    ...
    rules=[
        ...
        Rule(SingleTag("00209161"), HashUID()),					# Concatenation UID
        ...
        Rule(SingleTag("30100006"), HashUID()),					# Conceptual Volume UID
        Rule(SingleTag("00403001"), Remove()),					# Confidentiality Constraint on Patient Data Description
        Rule(SingleTag("30100013"), HashUID()),					# Constituent Conceptual Volume UID
        ...
        Rule(SingleTag("00181002"), HashUID()),					# Device UID
        Rule(SingleTag("FFFAFFFA"), Remove()),					# Digital Signatures Sequence
        Rule(SingleTag("04000100"), HashUID()),					# Digital Signature UID
        Rule(SingleTag("00209164"), HashUID()),				    # Dimension Organization UID
        ...
        Rule(SingleTag("300A0013"), HashUID()),					# Dose Reference UID
        Rule(SingleTag("3010006E"), HashUID()),					# Dosimetric Objective UID
        ...
        Rule(SingleTag("00200052"), HashUID()),					# Frame of Reference UID
        ...
        Rule(SingleTag("00080014"), HashUID()),					# Instance Creator UID
        ...
        Rule(SingleTag("00083010"), HashUID()),					# Irradiation Event UID
        ...
        Rule(SingleTag("00281214"), HashUID()),				    # Large Palette Color Lookup Table UID
        ...
        Rule(SingleTag("0018100B"), HashUID()),					# Manufacturer's Device Class UID
        ...
        Rule(SingleTag("003A0310"), HashUID()),					# Multiplex Group UID
        ...
        Rule(SingleTag("0040A402"), HashUID()),					# Observation Subject UID (Trial)
        Rule(SingleTag("0040A171"), HashUID()),					# Observation UID
        ...
        Rule(SingleTag("00281199"), HashUID()),				    # Palette Color Lookup Table UID
        ...
        Rule(SingleTag("300A0650"), HashUID()),                 # Patient Setup UID
        ...
        Rule(SingleTag("00701101"), HashUID()),					# Presentation Display Collection UID
        Rule(SingleTag("00701102"), HashUID()),					# Presentation Sequence Collection UID
        ...
        Rule(SingleTag("3010000B"), HashUID()),					# Referenced Conceptual Volume UID
        Rule(SingleTag("04000402"), Remove()),					# Referenced Digital Signature Sequence
        Rule(SingleTag("300A0083"), HashUID()),					# Referenced Dose Reference UID
        Rule(SingleTag("3010006F"), HashUID()),					# Referenced Dosimetric Objective UID
        Rule(SingleTag("30100031"), HashUID()),					# Referenced Fiducials UID
        Rule(SingleTag("30060024"), HashUID()),					# Referenced Frame of Reference UID
        Rule(SingleTag("00404023"), HashUID()),
        Rule(SingleTag("00081140"), HashUID()),					# Referenced Image Sequence
        Rule(SingleTag("0040A172"), HashUID()),					# Referenced Observation UID (Trial)
        ...
        Rule(SingleTag("3010003B"), HashUID()),					# RT Treatment Phase UID
        ...
        Rule(SingleTag("30100015"), HashUID()),					# Source Conceptual Volume UID
        ...
        Rule(SingleTag("00400554"), HashUID()),					# Specimen UID
        Rule(SingleTag("00081010"), Remove()),					# Station Name
        Rule(SingleTag("00880140"), HashUID()),					# Storage Media File-set UID
        ...
        Rule(SingleTag("00200200"), HashUID()),					# Synchronization Frame of Reference UID
        Rule(SingleTag("00182042"), HashUID()),					# Target UID
        Rule(SingleTag("0040A354"), Remove()),					# Telephone Number (Trial)
        Rule(SingleTag("0040DB0D"), HashUID()),					# Template Extension Creator UID
        Rule(SingleTag("0040DB0C"), HashUID()),					# Template Extension Organization UID
        ...
        Rule(SingleTag("00620021"), HashUID()),					# Tracking UID
        Rule(SingleTag("00081195"), HashUID()),				    # Transaction UID
        ...
        Rule(SingleTag("300A0609"), HashUID()),					# Treatment Position Group UID
        Rule(SingleTag("300A0700"), HashUID()),					# Treatment Session UID
        ...
        Rule(SingleTag("0040A124"), HashUID()),					# UID
