...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, total_timeout=None, rate_limit=None, proxy_url=None, max_retries=None, client_cert=None, headers=None, pulp_labels=None, download_concurrency=None, pulp_last_updated=None, url=None, pulp_created=None, pulp_href=None, sock_read_timeout=None, connect_timeout=None, ca_cert=None, sock_connect_timeout=None, name=None, tls_validation=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
