...
class AnsibleGitRemote(object):
    ...
    def __init__(self, username=None, proxy_username=None, total_timeout=None, proxy_password=None, rate_limit=None, proxy_url=None, max_retries=None, client_cert=None, headers=None, pulp_labels=None, download_concurrency=None, url=None, client_key=None, sock_read_timeout=None, connect_timeout=None, password=None, ca_cert=None, sock_connect_timeout=None, name=None, tls_validation=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
