...
class AnsibleGitRemote(object):
    ...
    def __init__(self, name=None, client_key=None, password=None, ca_cert=None, proxy_password=None, tls_validation=None, url=None, download_concurrency=None, username=None, proxy_username=None, rate_limit=None, sock_connect_timeout=None, total_timeout=None, sock_read_timeout=None, pulp_labels=None, max_retries=None, proxy_url=None, connect_timeout=None, client_cert=None, headers=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
