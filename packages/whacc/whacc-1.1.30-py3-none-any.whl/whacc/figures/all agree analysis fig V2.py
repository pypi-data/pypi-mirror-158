...
for ind in range(3):
    ...
    x_or[x_or>0] = 1
    df_list = []
    df_list.append(analysis.thresholded_error_types(x_and, human_one, edge_threshold=4, thresholds=[0.5]))
    df_list.append(analysis.thresholded_error_types(x_or, human_one, edge_threshold=4, thresholds=[0.5]))
    df_list.append(analysis.thresholded_error_types(x_and, whacc, edge_threshold=4, thresholds=[0.5]))
