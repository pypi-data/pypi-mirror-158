...
// (431:6) {#each _headers as { value, id }
...
// (412:2) <Upload    flex={false}    center={false}    boundedheight={false}    click={false}    on:load={(e) => blob_to_string(data_uri_to_blob(e.detail.data))}    bind:dragging   >
		...
		if ($$self.$$.dirty[0] & /*values, headers*/ 402653184) {
			{
				if (values && !Array.isArray(values)) {
					if (Array.isArray(values.headers)) $$invalidate(27, headers = values.headers);
