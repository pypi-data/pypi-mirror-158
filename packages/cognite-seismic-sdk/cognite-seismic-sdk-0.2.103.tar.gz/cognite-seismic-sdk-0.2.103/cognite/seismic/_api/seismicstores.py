...
"""
        ...
        if get_all:
            ...
            if mode == "seismic_store":
                ...
                req = SearchSeismicStoresRequest(file=spec, coverage=coverage)
            else:
                raise Exception("mode should be one of: survey, seismic_store, file")
        ...
        results = self.query.SearchSeismicStores(req)
        for s in results:
    ...
    def edit(
        ...
        *,
        ...
        return SeismicStore.from_proto(self.query.EditSeismicStore(request))
