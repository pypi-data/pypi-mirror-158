    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('screening_identifier', models.CharField(db_index=True, max_length=50)),
                ('report_datetime', models.DateTimeField(default=edc_utils.date.get_utcnow, verbose_name='Report Date and Time')),
                ('other_reason', edc_model.models.fields.other_charfield.OtherCharField(blank=True, max_length=35, null=True, verbose_name='If other, please specify ...')),
                ...
                ('reason', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='edc_refusal.refusalreasons', verbose_name='Reason for refusal to join')),
