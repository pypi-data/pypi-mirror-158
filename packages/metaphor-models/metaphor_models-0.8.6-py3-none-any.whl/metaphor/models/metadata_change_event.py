...
class FieldTagAssociations:
    field_path: Optional[str] = None
    """Stores Entity IDs for the Governed Tag Namespaces that are associated with this schema
    field
    """
...
class SQLSchema:
    ...
    def from_dict(obj: Any) -> 'SQLSchema':
        ...
        materialization = from_union([Materialization, from_none], obj.get("materialization"))
    ...
    def to_dict(self) -> dict:
        ...
        result["materialization"] = from_union([lambda x: to_enum(Materialization, x), from_none], self.materialization)
...
class KnowledgeCardLogicalID:
    """Implemented in{@linkKnowledgeCard}output type
...
class VirtualView:
    ...
    def from_dict(obj: Any) -> 'VirtualView':
        ...
        return VirtualView(created_at, id, asset_contacts, virtual_view_created_at, dbt_model, deleted_at, entity_type, virtual_view_id, last_modified_at, logical_id, looker_explore, looker_view, ownership_assignment, power_bi_dataset, tableau_datasource, tag_assignment, thought_spot)
