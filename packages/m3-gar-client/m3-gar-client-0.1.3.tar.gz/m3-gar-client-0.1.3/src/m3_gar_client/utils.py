...
from m3_gar_constants import GAR_HIERARCHIES
from m3_gar_constants import GAR_HIERARCHY_MUN
...
def correct_keyboard_layout(text):
    ...
    # Сделано здесь до того момента, пока не будет сделана обработка на стороне
    # REST API
