...
def test_driver():
    ...
    while True:
        try:
            ...
            # print(client.ping(target_address='6:4/604/192.168.1.184'))

            # print(client.write(values={'6_4_2_analogValue_2': 21, '6_4_1_analogValue_1': 22}))
...
def test_simulate():
    ...
    dict_point = {'6_4_1_analogValue_1': {'object_type': 'analogValue', 'instance_number': 1, 'present_value': 1.0, 'object_name': 'AV 1', 'description': '6_4_1_analogValue_1'},
                  '6_4_2_analogValue_2': {'object_type': 'analogValue', 'instance_number': 2, 'present_value': 2.0, 'object_name': 'Av 2', 'description': '6_4_2_analogValue_2'},
                  }
...
def test_scan():
    ...
    while True:
        try:
            ...
            # results = client.ping(target_address='192.168.1.255')
            ...
            results = client.ping(target_address='6:4/604/192.168.1.184')
            print(results)
            # results = client.ping(target_address='192.168.1.184')

            # results = client.scan(target_address='6:4/604/192.168.1.184')
            results = client.scan(target_address='6:4/604/192.168.1.184', ping_check=False)
            # print(client.scan())
            print(results)
        except Exception as e:
            print(e.__str__())
