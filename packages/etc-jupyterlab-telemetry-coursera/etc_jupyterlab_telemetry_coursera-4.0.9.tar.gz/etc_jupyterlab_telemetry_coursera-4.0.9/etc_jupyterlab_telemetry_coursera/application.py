        ...
        try:
            ...
            if self.telemetry_file_path:
                ...
                if telemetry_file_path.is_file():
                    #  If telemetry isn't explicitly enabled look for the presence of the touch file in order to activate telemetry.
                    #  This is useful when telemetry should be activated by the presence of a file in the Lab home directory.
                    self.telemetry = True
                    #  Telemetry is on and there is a telemetry touch file; hence, read its contents and append it to the bucket_url.
