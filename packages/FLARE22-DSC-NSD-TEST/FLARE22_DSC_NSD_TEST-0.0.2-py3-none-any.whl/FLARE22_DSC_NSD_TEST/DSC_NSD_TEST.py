...
import pandas as pd
from FLARE22_DSC_NSD_TEST.SurfaceDice import compute_surface_distances, compute_surface_dice_at_tolerance, compute_dice_coefficient
join = os.path.join
...
def DSC_NSD(seg_path, gt_path, save_path, save_name):
