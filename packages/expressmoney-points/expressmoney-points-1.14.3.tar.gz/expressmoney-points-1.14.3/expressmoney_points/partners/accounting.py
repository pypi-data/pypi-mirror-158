...
class ChargbackCreateContract(Contract):
    amount = serializers.DecimalField(max_digits=16, decimal_places=0)
    bank_card_id = serializers.IntegerField(min_value=1)
...
class ChargbackPoint(CreatePointMixin, ContractPoint):
    _point_id = ChargbackID()
    _create_contract = ChargbackCreateContract
