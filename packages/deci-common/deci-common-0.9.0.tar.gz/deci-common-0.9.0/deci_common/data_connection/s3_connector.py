...
from deci_common.decorators.explicit_params_validator import explicit_params_validation
...
class S3Connector(ILogger):
    ...
    def __init__(self, env: str = None, bucket_name: str = None):
        """
    ...
    def create_bucket(self, s3_client: boto3.Session.client = None) -> bool:
        """
    ...
    def check_bucket_exists(self, bucket_name: str = None, s3_resource: boto3.Session.resource = None) -> bool:
    ...
    def delete_bucket(self, s3_resource: boto3.Session.resource = None):
        """
    ...
    def rename_key(self, source_key: str, destination_key: str):
    ...
    def download_keys_by_prefix(
        self, s3_bucket_path_prefix: str, local_download_dir: str, s3_file_path_prefix: str = ""
    ):
        """
    ...
    def create_presigned_download_url(self, object_name: str, expiration=3600, download_name: str = None):
