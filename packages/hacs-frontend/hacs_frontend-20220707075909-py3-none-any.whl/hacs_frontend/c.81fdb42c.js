import{a as e,h as a,e as i,t,i as s,$ as o,at as n,o as r,A as d,ae as l,r as c,n as h,H as p,m,L as u,N as v,au as g,a0 as y,a1 as x,av as f,ai as _,s as k,d as b}from"./main-dc658e23.js";import{c as $}from"./c.4a97632a.js";import"./c.e7c36a6a.js";import{s as w}from"./c.6c71a8c2.js";import{a as z}from"./c.fe747ba2.js";import{m as j}from"./c.6b5d960f.js";import{u as R}from"./c.2b5e839b.js";import"./c.ee53ccde.js";import"./c.79cff34d.js";import"./c.743a15a1.js";import"./c.87096173.js";import"./c.8e28b461.js";e([h("ha-expansion-panel")],(function(e,a){return{F:class extends a{constructor(...a){super(...a),e(this)}},d:[{kind:"field",decorators:[i({type:Boolean,reflect:!0})],key:"expanded",value:()=>!1},{kind:"field",decorators:[i({type:Boolean,reflect:!0})],key:"outlined",value:()=>!1},{kind:"field",decorators:[i()],key:"header",value:void 0},{kind:"field",decorators:[i()],key:"secondary",value:void 0},{kind:"field",decorators:[t()],key:"_showContent",value(){return this.expanded}},{kind:"field",decorators:[s(".container")],key:"_container",value:void 0},{kind:"method",key:"render",value:function(){return o`
      <div
        id="summary"
      ...
      >
        <div class=${r({content:!0,narrow:this.narrow})}>
          ...
          ${this._releaseNotes.length>0?this._releaseNotes.map((e=>o`
                  ...
                  `)):""}
          ${a.can_download?"":o`<ha-alert alert-type="error" .rtl=${$(this.hass)}>
          ...
          ${null!==(e=this._error)&&void 0!==e&&e.message?o`<ha-alert alert-type="error" .rtl=${$(this.hass)}>
                  ${this._error.message}
                </ha-alert>`:""}
        </div>
        <mwc-button
    ...
    `:o``}},{kind:"method",key:"_updateRepository",value:async function(){this._updating=!0;const e=this._getRepository(this.hacs.repositories,this.repository);e&&("commit"!==e.version_or_commit?await z(this.hass,e.id,e.available_version):await z(this.hass,e.id),"plugin"===e.category&&"storage"===this.hacs.info.lovelace_mode&&await R(this.hass,e,e.available_version),this._updating=!1,this.dispatchEvent(new Event("hacs-dialog-closed",{bubbles:!0,composed:!0})),"plugin"===e.category&&w(this,{title:this.hacs.localize("common.reload"),text:o`${this.hacs.localize("dialog.reload.description")}<br />${this.hacs.localize("dialog.reload.confirm")}`,dismissText:this.hacs.localize("common.cancel"),confirmText:this.hacs.localize("common.reload"),confirm:()=>{_.location.href=_.location.href}}))}},{kind:"method",key:"_getChanglogURL",value:function(){const e=this._getRepository(this.hacs.repositories,this.repository);if(e)return"commit"===e.version_or_commit?`https://github.com/${e.full_name}/compare/${e.installed_version}...${e.available_version}`:`https://github.com/${e.full_name}/releases`}},{kind:"get",static:!0,key:"styles",value:function(){return[k,b,c`
        .content {
          width: 360px;
          display: contents;
        }
      ...
      `]}}]}}),p);export{C as HacsUpdateDialog};
