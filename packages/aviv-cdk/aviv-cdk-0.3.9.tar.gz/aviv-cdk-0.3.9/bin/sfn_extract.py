...
# def localImportValue(self, value):
#     stackfx = value.split('lambdasExportsOutputFnGetAtt')
#     fxarn = stackfx[1].split('Arn')
#     return fxarn[0]

# Functions.stuffit = localImportValue
# Functions.MAP['Fn::ImportValue'] = 'stuffit'
# # OR stuff directly with all Fn::ImportValue
# #Function._import_value_cache = dict()
...
def cli(template: str):
    ...
    for k, r in tpl['Resources'].items():
        ...
        # print("{}\n{}".format(k, definition))
        jsondef = json.loads(definition)
        print(json.dumps(jsondef, indent=4))
