...
class NxPyDocs():
    ...
    def nxpydocs(self):
        ...
        if self.command == "all":
            for single_command in self.supported_templates:
                ...
                pp.pprint(json.dumps(parsed_json,indent=4, sort_keys=True))
    ...
    def yaml_file(self, parsed_json):
        clean_yaml = yaml.dump(json.loads(json.dumps(parsed_json,indent=4, sort_keys=True)), default_flow_style=False)
