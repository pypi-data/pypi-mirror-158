...
def predict(input_path='./inputs',output_path='./outputs',model_path='./work_dir/swinunetr_3class',model_name='swinunetr',show_overlay=False,num_class=3,input_size=256):
    ...
    checkpoint = torch.load(join(model_path, 'best_Dice_model.pth'), map_location=torch.device(device))
