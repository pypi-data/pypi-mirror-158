...
from op import Config, Object, get, items, keys, update, values
from op import cdir, edit, format, register
from op import Db, fns, hook, load, last, save
...
class Test_Object(unittest.TestCase):
    ...
    def test_import(self):
        self.assertEqual(tuple(dir(op)), attrs1)
    ...
    def test_Object__module__(self):
        self.assertTrue(Object().__module__, "ob")
    ...
    def test_Object__otype__(self):
        self.assertEqual(Object().__otype__, "op.Object")
    ...
    def test_Object__stp__(self):
        o = Object()
        self.assertTrue("op.Object" in o.__stp__)
    ...
    def test_fns(self):
        from op import Config, Object, save
        Config.workdir = ".test"
        o = Object()
        save(o)
        self.assertTrue("Object" in fns("op.Object")[0])
