...
from jsonstatpy.utility import lst2html


class JsonStatDataSet:
    """Represents a JsonStat dataset

        >>> import os, jsonstatpy  # doctest: +ELLIPSIS
        >>> filename = os.path.join(jsonstatpy._examples_dir, "www.json-stat.org", "oecd-canada-col.json")
        >>> dataset = jsonstatpy.from_file(filename).dataset(0)
        >>> dataset.label
