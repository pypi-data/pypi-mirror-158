...
from jsonstatpy.downloader import *
...
def from_json(json_data):
    ...
    >>> jsonstatpy.from_json(json_data)
...
def from_url(url, pathname=None):
    ...
    >>> jsonstatpy.cache_dir("/tmp")
    '/tmp'
    >>> o = jsonstatpy.from_url(uri)
    >>> print(o)
    JsonstatCollection contains the following JsonStatDataSet:
    +-----+----------+
    | pos | dataset  |
...
def validate(spec):
    ...
    from jsonstatpy.schema import JsonStatSchema
