...
from typing import Any, cast, Dict, List, Optional, Tuple, TYPE_CHECKING, TypeVar, Union
...
from datarobot.enums import ACCURACY_METRIC, DEFAULT_MAX_WAIT
...
if TYPE_CHECKING:
    ...
    class ForecastDateSettingsDict(TypedDict):
        enabled: bool
        column_name: str
        datetime_format: str
...
class Deployment(APIObject, DeploymentQueryBuilderMixin, BrowserMixin):
    ...
    @classmethod
    def get(cls, deployment_id: str) -> TDeployment:
    ...
    def submit_actuals(self, data, batch_size: int = 10000) -> None:
    ...
    def get_predictions_by_forecast_date_settings(self) -> "ForecastDateSettingsDict":
    ...
    def update_challenger_models_settings(
        self, challenger_models_enabled: bool, max_wait: int = DEFAULT_MAX_WAIT
    ) -> None:
    ...
    def get_prediction_intervals_settings(self) -> Dict[str, Union[bool, List[int]]]:
    ...
    def update_prediction_intervals_settings(
        self, percentiles: List[int], enabled: bool = True, max_wait: int = DEFAULT_MAX_WAIT
    ) -> None:
    ...
    def update_secondary_dataset_config(
        self, secondary_dataset_config_id: str, credential_ids: Optional[List[str]] = None
    ) -> str:
