...
New Features
************
- Added experimental support for retrieving document thumbnails :class:`DocumentThumbnail <datarobot._experimental.models.documentai.document.DocumentThumbnail>` and :class:`DocumentThumbnailFile <datarobot._experimental.models.documentai.document.DocumentThumbnailFile>`
...
- Added a new method for getting the canonical URI for a class :meth:`Project.get_uri <datarobot.models.Project.get_uri>`, :meth:`Model.get_uri <datarobot.models.Model.get_uri>` & :meth:`Deployment.get_uri <datarobot.models.Deployment.get_uri>`

- Added a new method for opening a class in a browser per their URI :meth:`Project.get_uri <datarobot.models.Project.open_in_browser>`, :meth:`Model.open_in_browser <datarobot.models.Model.open_in_browser>` & :meth:`Deployment.open_in_browser <datarobot.models.Deployment.open_in_browser>`
