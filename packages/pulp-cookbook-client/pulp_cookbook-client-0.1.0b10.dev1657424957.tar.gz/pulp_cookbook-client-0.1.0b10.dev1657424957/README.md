...
- API version: v3
- Package version: 0.1.0b10.dev1657424957
...
version = 'version_example' # str | version of the cookbook (optional)
    ...
    try:
        ...
        api_response = api_instance.create(name, file=file, repository=repository, artifact=artifact, upload=upload, version=version)
        pprint(api_response)
