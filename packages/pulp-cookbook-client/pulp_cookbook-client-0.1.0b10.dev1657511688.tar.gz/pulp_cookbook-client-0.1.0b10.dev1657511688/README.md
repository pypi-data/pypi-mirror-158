...
- API version: v3
- Package version: 0.1.0b10.dev1657511688
...
version = 'version_example' # str | version of the cookbook (optional)
    ...
    try:
        ...
        api_response = api_instance.create(name, file=file, repository=repository, upload=upload, artifact=artifact, version=version)
        pprint(api_response)
