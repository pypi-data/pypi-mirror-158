...
- API version: v3
- Package version: 0.1.0b10.dev1657338103
...
version = 'version_example' # str | version of the cookbook (optional)
    ...
    try:
        ...
        api_response = api_instance.create(name, artifact=artifact, repository=repository, upload=upload, file=file, version=version)
        pprint(api_response)
