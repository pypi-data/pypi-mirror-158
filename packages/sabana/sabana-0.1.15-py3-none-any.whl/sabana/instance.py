...
class Instance:
    ...
    def __init__(self, image_file=None, image=None, url=None):
        try:
            config = get_config()
        ...
        try:
            ...
            print(
                "{} Instance {}/{}:{} is down".format(
                    icon_check, self.user, self.image_name, self.image_tag
                )
            )
            self.is_up = False
            self.instance_url == ""
    ...
    def execute(self, program):
        ...
        try:
            print(icon_rocket, "Requesting program execution in Sabana")
