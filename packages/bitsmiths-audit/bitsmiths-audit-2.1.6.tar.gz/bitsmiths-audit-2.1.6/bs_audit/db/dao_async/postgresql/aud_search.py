...
order by
  ...
  c.name""")
        ...
        self._dbstmnt.bind_out("aud_tbl_id", str)
        self._dbstmnt.bind_out("aud_tbl_key", str)
        self._dbstmnt.bind_out("col_aud_id", int, 8)
        self._dbstmnt.bind_out("col_name", str)
        self._dbstmnt.bind_out("col_before", str)
        self._dbstmnt.bind_out("col_after", str)
    ...
    async def fetch(self) -> bool:
        ...
        self.orec.col.aud_id = self._dbstmnt.result[10]
        self.orec.col.name = self._dbstmnt.result[11]
        self.orec.col.before = self._dbstmnt.result[12]
        self.orec.col.after = self._dbstmnt.result[13]

        return True

    async def fetch_iter(self) -> oAudSearch:
        """
    ...
    async def fetch_all(self, out_list: oAudSearch.List, clearList: bool = True) -> int:
        """
