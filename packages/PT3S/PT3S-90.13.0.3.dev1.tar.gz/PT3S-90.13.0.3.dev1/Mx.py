...
class Mx():
    ...
    def readMxsVecsResultsForObjectType(self
        ,Sir3sVecIDReExp='^KNOT~\*~\*~\*~PH$' # gewuenschte Kanaele (gewuenschter Kanal) eines Objekttyps als regexp
        ,dfVecAggCols=False # 0,1,2,... sind Labels (sonst (default): pks sind Labels) 
        ...
        try:           
            ...
            Sir3sIDsMatching=[Sir3sID for Sir3sID in self.mxColumnNamesVecs if re.search(Sir3sVecIDReExp,Sir3sID) != None]
