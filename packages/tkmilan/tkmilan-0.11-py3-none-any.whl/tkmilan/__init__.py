...
class Tree(ttk.Treeview, mixin.SingleWidget):
    ...
    def __init__(self, parent, *, variable: typing.Optional[varTree] = None,
                 ...
                 **kwargs):
        self.wstyle = style
        if columns_stretch is False or columnConfig is not None:
            columns_stretch = []  # Disable
        else:
            if __debug__:
        ...
        columnConfig = columnConfig or {
            'stretch': True if columns_stretch is True else False,
        }
        if columns_stretch is True:  # Overriden on "columnConfig", no need to touch it anymore
            columns_stretch = []
        ...
        for cid, cobj in columns.items():
            ...
            if cid in columns_stretch:  # Override stretch value
                ccol.stretch = True
            wcolumns[cid] = ccol
        ...
        if None in columns_stretch:  # Override stretch value
            self.lcolumn.stretch = True
        wshow = []
