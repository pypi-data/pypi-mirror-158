...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, pulp_labels=None, name=None, latest_version_href=None, retain_repo_versions=None, versions_href=None, manifest_signing_service=None, pulp_created=None, pulp_href=None, description=None, local_vars_configuration=None):  # noqa: E501
