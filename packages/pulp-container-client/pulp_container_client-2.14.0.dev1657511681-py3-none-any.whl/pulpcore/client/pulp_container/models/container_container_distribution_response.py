...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, pulp_labels=None, name=None, repository=None, content_guard=None, base_path=None, pulp_created=None, pulp_href=None, repository_version=None, registry_path=None, namespace=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
