...
class PatchedcontainerContainerPushRepository(object):
    ...
    def __init__(self, pulp_labels=None, retain_repo_versions=None, description=None, name=None, manifest_signing_service=None, local_vars_configuration=None):  # noqa: E501
