...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, pulp_labels=None, pulp_created=None, description=None, pulp_href=None, retain_repo_versions=None, versions_href=None, name=None, latest_version_href=None, local_vars_configuration=None):  # noqa: E501
