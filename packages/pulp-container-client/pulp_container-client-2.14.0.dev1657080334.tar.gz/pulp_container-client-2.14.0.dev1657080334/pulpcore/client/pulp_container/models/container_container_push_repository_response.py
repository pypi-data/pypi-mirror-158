...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, manifest_signing_service=None, latest_version_href=None, pulp_labels=None, pulp_href=None, name=None, versions_href=None, retain_repo_versions=None, pulp_created=None, description=None, local_vars_configuration=None):  # noqa: E501
