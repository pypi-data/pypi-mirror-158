    ...
    def _turbo_m(self):
        ...
        while self.n_evals < self.max_evals: #not self.state.restart_triggered: 
            ...
            for turbo_id, round_batch_size in enumerate(range(self.n_trust_regions)):
                ...
                print(f"sub_turbo_X {turbo_id}.shape {sub_turbo_X.shape}")
                print(f"sub_turbo_Y {turbo_id}.shape {sub_turbo_Y.shape}")
            ...
            print("X_nexts_batch", X_nexts_stacked)

            print("X_nexts_batch", X_nexts_batch)
            print("mask", mask)
            print("mask == 0", mask == 0)
            print("mask == 1", mask == 1)
            print("mask == 2", mask == 2)
            ...
            for i in range(self.n_trust_regions):
                ...
                print(f"X_next_spec {i} {X_next_spec}")

                print(f"Y_next_spec {i} {Y_next_spec}")
                #assert False, f''
