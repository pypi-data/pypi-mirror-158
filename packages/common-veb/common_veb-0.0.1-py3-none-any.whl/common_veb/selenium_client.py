...
class seleniumClient():
    ...
    def _create_local_dir(self, file_name:str, file_extension: str):
        ...
        if not os.path.exists(f'./temp_data/'):
                os.mkdir(f'./temp_data/')         
        local_path = f'./temp_data/{file}'
    ...
    def get_file(self, element_type:str, element_name:str, file_name:str, file_extension:str):
        ...
        # retry pattern with some back off
            time.sleep(i*i)
            try:
                local_path, file = self._create_local_dir(file_name, file_extension)
                ...
                if i < 2:
                    ...
                    sys.exit(1)
        logging.info('Succesfully retrieved file and stored here: {local_file}')
        return local_file
