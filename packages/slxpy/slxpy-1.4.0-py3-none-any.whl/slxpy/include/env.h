...
namespace slxpy::env::spec {
    ...
    kwargs={}
))--", id, reward_threshold, max_episode_steps, terminal_bonus_reward, IndexingModeNames[static_cast<uint8_t>(indexing_mode)], nondeterministic, auto_reset, strict_reset, need_render, action_repeat, ActionRepeatModeNames[static_cast<uint8_t>(action_repeat_mode)], std::string(pybind11::repr(kwargs)));
        }
    };
    ...
    void slxpy_bind_spec(::pybind11::module_& s) {
        ...
        pybind11::enum_<ActionRepeatMode> ActionRepeatMode_PB(s, "ActionRepeatMode");
        ActionRepeatMode_PB
