...
class CropinClient:
    ...
    def get_plot_details(self, plot_ids: list):
        return self.insight_service_client.get_plot_details(plot_ids)
    ...
    def download_image(self, plot_id: str, image_name, image_type, date):
        return self.insight_service_client.download_image(plot_id, image_name, image_type, date)
