...
class V1V2Compat:
    ...
    def publish_events_batch_schema(self, events_path: Union[Path, str], publish_schema: Dict[str, Any]) -> None:
        return self.client_v2.publish_events_batch_schema(events_path, publish_schema)
