...
run_once = [True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True,True]

def draw_image(image, xy, draw_img, image_value):
    global player_speed, change_x,change_y
    rect = list(xy)
    if run_once[image_value -1]:
        images[image_value-1] = pygame.Rect(rect[0],rect[1],image.get_width(),image.get_height())
        run_once[image_value -1] = False
    if change_x == 'x-':
...
def player(image,x,y,move_left,move_right,move_up,move_down,jump,speed, collide_sides, sticky_keys, camera_follower):
    image_player = None
    run_once = True
    global jump_velocity, jumped, time, last_time, camera,change_x,player_speed,change_y
    dt = t.time() - last_time
    dt *= frames
    last_time = t.time()
    player_speed = speed
