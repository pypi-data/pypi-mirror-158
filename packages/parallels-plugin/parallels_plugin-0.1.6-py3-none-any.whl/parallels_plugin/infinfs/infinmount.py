...
INPUT_SPEC_CONFIG = '/root/.mlflow-parallels/input_data_spec'
...
def get_input_spec_json(input_name=None):
    ...
    specs = json.loads(base64.b64decode(args.inp_contents[7:]).decode('utf-8'))
    print('input_data_spec decoded=' + str(specs))
