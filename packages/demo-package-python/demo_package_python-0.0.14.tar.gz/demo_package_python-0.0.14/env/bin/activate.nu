...
def-env activate-virtualenv [] {
    ...
    let virtual-env = '/home/lvjhn/Projects/Package Building Instructions/packaging/demo-package-python/env'
    let bin = 'bin'
    let path-sep = ':'
...
alias deactivate = source '/home/lvjhn/Projects/Package Building Instructions/packaging/demo-package-python/env/bin/deactivate.nu'
