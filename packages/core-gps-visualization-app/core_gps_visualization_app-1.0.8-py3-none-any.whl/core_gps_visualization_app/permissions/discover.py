""" Initialize permissions for core gps visualization app
"""
import logging
...
def init_permissions():
    ...
    try:
        ...
        visualization_access_perm = Permission.objects.get(codename=visualization_rights.visualization_access)
