...
from httprunner_zt import logger
from httprunner_zt.__about__ import __description__, __version__
from httprunner_zt.api import HttpRunner
from httprunner_zt.compat import is_py2
from httprunner_zt.utils import (create_scaffold, get_python2_retire_msg,
...
def main_locust():
    ...
    """
    try:
        from httprunner_zt import locusts
    except ImportError:
