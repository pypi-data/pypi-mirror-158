...
#  =================== LED FUNC  =================== #
    ...
    def set_rgb_led_on(self,pin:int=LED_PIN):
        ...
        r = min( 100, max( 0, round(self.__led_data_dict[pin].red * MAXRATE)))
        g = min( 100, max( 0, round(self.__led_data_dict[pin].green * MAXRATE)))
        b = min( 100, max( 0, round(self.__led_data_dict[pin].blue * MAXRATE)))
