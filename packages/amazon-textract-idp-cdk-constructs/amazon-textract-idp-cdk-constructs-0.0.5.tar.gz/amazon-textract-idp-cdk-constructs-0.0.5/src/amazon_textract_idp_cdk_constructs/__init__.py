...
class CSVToAuroraTask(
    ...
    def csv_to_aurora_number_rows_inserted_metric(
        ...
        return typing.cast(aws_cdk.aws_cloudwatch.IMetric, jsii.get(self, "csvToAuroraNumberRowsInsertedMetric"))

    @csv_to_aurora_number_rows_inserted_metric.setter
    def csv_to_aurora_number_rows_inserted_metric(
        self,
        value: aws_cdk.aws_cloudwatch.IMetric,
    ) -> None:
...
class TextractGenericAsyncSfnTask(
    ...
    def __init__(
        ...
        *,
        ...
        :param lambda_log_level: log level for Lambda function, supports DEBUG|INFO|WARNING|ERROR|FATAL.
        :param name: The name of the execution, same as that of StartExecution. Default: - None
        :param textract_api: Which API to call - atm only GENERIC and EXPENSE are called. When called without features, StartDetectText is called, when called with features StartAnalyzeDocument is called
        :param textract_async_call_backoff_rate: retyr backoff rate, default is 1.1.
        :param textract_async_call_interval: time to wait before next retry, default is 1.
    ...
    def async_duration_metric(self) -> aws_cdk.aws_cloudwatch.IMetric:
        return typing.cast(aws_cdk.aws_cloudwatch.IMetric, jsii.get(self, "asyncDurationMetric"))

    @async_duration_metric.setter
    def async_duration_metric(self, value: aws_cdk.aws_cloudwatch.IMetric) -> None:
        jsii.set(self, "asyncDurationMetric", value)

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="asyncJobFinshedMetric")
    def async_job_finshed_metric(self) -> aws_cdk.aws_cloudwatch.IMetric:
        return typing.cast(aws_cdk.aws_cloudwatch.IMetric, jsii.get(self, "asyncJobFinshedMetric"))

    @async_job_finshed_metric.setter
    def async_job_finshed_metric(self, value: aws_cdk.aws_cloudwatch.IMetric) -> None:
        jsii.set(self, "asyncJobFinshedMetric", value)

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="asyncJobStartedMetric")
    def async_job_started_metric(self) -> aws_cdk.aws_cloudwatch.IMetric:
        return typing.cast(aws_cdk.aws_cloudwatch.IMetric, jsii.get(self, "asyncJobStartedMetric"))

    @async_job_started_metric.setter
    def async_job_started_metric(self, value: aws_cdk.aws_cloudwatch.IMetric) -> None:
        jsii.set(self, "asyncJobStartedMetric", value)

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="asyncNumberPagesMetric")
    def async_number_pages_metric(self) -> aws_cdk.aws_cloudwatch.IMetric:
        return typing.cast(aws_cdk.aws_cloudwatch.IMetric, jsii.get(self, "asyncNumberPagesMetric"))

    @async_number_pages_metric.setter
    def async_number_pages_metric(self, value: aws_cdk.aws_cloudwatch.IMetric) -> None:
        jsii.set(self, "asyncNumberPagesMetric", value)

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="asyncNumberPagesSendMetric")
    def async_number_pages_send_metric(self) -> aws_cdk.aws_cloudwatch.IMetric:
        return typing.cast(aws_cdk.aws_cloudwatch.IMetric, jsii.get(self, "asyncNumberPagesSendMetric"))
...
class TextractGenericSyncSfnTask(
    ...
    def sync_duration_metric(self) -> aws_cdk.aws_cloudwatch.IMetric:
        return typing.cast(aws_cdk.aws_cloudwatch.IMetric, jsii.get(self, "syncDurationMetric"))

    @sync_duration_metric.setter
    def sync_duration_metric(self, value: aws_cdk.aws_cloudwatch.IMetric) -> None:
        jsii.set(self, "syncDurationMetric", value)

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="syncNumberPagesMetric")
    def sync_number_pages_metric(self) -> aws_cdk.aws_cloudwatch.IMetric:
        return typing.cast(aws_cdk.aws_cloudwatch.IMetric, jsii.get(self, "syncNumberPagesMetric"))

    @sync_number_pages_metric.setter
    def sync_number_pages_metric(self, value: aws_cdk.aws_cloudwatch.IMetric) -> None:
        jsii.set(self, "syncNumberPagesMetric", value)

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="syncNumberPagesSendMetric")
    def sync_number_pages_send_metric(self) -> aws_cdk.aws_cloudwatch.IMetric:
        return typing.cast(aws_cdk.aws_cloudwatch.IMetric, jsii.get(self, "syncNumberPagesSendMetric"))
    ...
    def sync_timed_out_metric(self) -> aws_cdk.aws_cloudwatch.IMetric:
        return typing.cast(aws_cdk.aws_cloudwatch.IMetric, jsii.get(self, "syncTimedOutMetric"))

    @sync_timed_out_metric.setter
    def sync_timed_out_metric(self, value: aws_cdk.aws_cloudwatch.IMetric) -> None:
