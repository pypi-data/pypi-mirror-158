...
def percent_BEP_flowrate(
    ...
    Args:
        pump_liquid_flowrate: Pump liquid flowrate [:math:`\mathrm{\frac{m^3}{s}}`].
...
def recycle_valve_power_loss(
    ...
    The calculation does not take into account the difference in pump efficiency at different flow rates. This is acceptable because pumps are usually sized to take into account extra flow due to recirculation.
