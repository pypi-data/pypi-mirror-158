...
def rolling_stddev_timedelta(
    ...
    Rolling standard deviation computed for the time deltas of the observations. The purpose of this
    metric is to measure the amount of variation or dispersion in the frequency of time series data points.
