...
@check_types
def status_flag_filter(data: pd.Series, filter_by: pd.Series, int_to_keep: int = 0, align_timesteps: bool = False):
    """Status flag filter
    ...
    Raises:
        UserRuntimeError: Timeseries returns no data. This could be due to the absence of sufficient data in either `data`
