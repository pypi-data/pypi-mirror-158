...
class BaseExperiment:
    ...
    def delete_saved_model(
        ...
        **hparams
        ...
        if BaseNet in inspect.getmro(model_type) or ConvNet in inspect.getmro(model_type):
