...
class _UNet(nn.Module):
    ...
    def __init__(
        ...
        self.dims = rearrange_dims(dims=dims, dataformats=dataformats) # (in_channels, height, width)
...
class _PixelCNN(nn.Module):
    def __init__(
        ...
        self.dims = rearrange_dims(dims=dims, dataformats=dataformats)
