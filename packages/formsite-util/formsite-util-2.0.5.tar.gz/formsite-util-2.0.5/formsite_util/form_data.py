...
class FormData:
    ...
    def __init__(
        ...
        cached_items_path: str = None,
    ) -> None:
        """FormData constructor

        Args:
            results_df (pd.DataFrame, optional): Pre-initialize with particular results. Defaults to None.
            items (dict, optional): Pre-initalize with particular items. Defaults to None.
            cached_results_path (str, optional): Pre-initialize with cached results. Defaults to None.
            cached_items_path (str, optional): Pre-initialize with cached items. Defaults to None.
    ...
    @property
    def data_labels(self) -> Optional[pd.DataFrame]:
    ...
    def __repr__(self) -> str:
        if self.data is not None and self.items is not None:
