...
from monostate._string_utils import class_case_to_snake_case
...
class MonoState(abc.ABC):
    ...
    def __init__(self, instance_kwarg_name=SNAKE_CASE_CLASS_NAME):
        ...
        self.__instance_kwarg_name = class_case_to_snake_case(self.__class__.__name__) if instance_kwarg_name == SNAKE_CASE_CLASS_NAME else instance_kwarg_name
