...
class DBG_ARGUS(enum.Enum):
    MACH_WAIT_REASON = 0x41
    MACH_WAKEUP_REASON = 0x42
    MACH_TS_MAINTENANCE = 0x43
    MACH_CALLCREATE = 0x44
    MACH_CALLCANCEL = 0x45


class DBG_UMALLOC(enum.Enum):
    DBG_UMALLOC_EXTERNAL = 0x1  # for external entry points into malloc
    DBG_UMALLOC_INTERNAL = 0x2  # for tracing internal malloc state


class DBG_UMALLOC_EXTERNAL(enum.Enum):
    DBG_UMALLOC_EXTERNAL_MALLOC = 0x01
    DBG_UMALLOC_EXTERNAL_FREE = 0x02
    DBG_UMALLOC_EXTERNAL_REALLOC = 0x03
    DBG_UMALLOC_EXTERNAL_MEMALIGN = 0X04
    DBG_UMALLOC_EXTERNAL_CALLOC = 0X05
    DBG_UMALLOC_EXTERNAL_VALLOC = 0X06


class DBG_UMALLOC_INTERNAL(enum.Enum):
    DBG_UMALLOC_INTERNAL_NANO_MALLOC = 0X1
    DBG_UMALLOC_INTERNAL_TINY_MALLOC = 0X2
    DBG_UMALLOC_INTERNAL_SMALL_MALLOC = 0X3
    DBG_UMALLOC_INTERNAL_LARGE_MALLOC = 0X4
    DBG_UMALLOC_INTERNAL_NANO_FREE = 0X5
    DBG_UMALLOC_INTERNAL_TINY_FREE = 0X6
    DBG_UMALLOC_INTERNAL_SMALL_FREE = 0X7
    DBG_UMALLOC_INTERNAL_LARGE_FREE = 0X8
    DBG_UMALLOC_INTERNAL_MALLOC_MEMORY_PRESSURE = 0X9
    DBG_UMALLOC_INTERNAL_NANO_MEMORY_PRESSURE = 0XA
    DBG_UMALLOC_INTERNAL_MADVISE = 0XB
    DBG_UMALLOC_INTERNAL_NANOV2_REGION_ALLOCATION = 0X10
...
class DBG_MACH(enum.Enum):
    ...
    DBG_MACH_HV            = 0xAC ## /* Hypervisor subsystem */
...
class DBG_MACH_IPC(enum.Enum):
    ...
    MACH_IPC_VOUCHER_REMOVE              = 0xe
    MACH_IPC_VOUCHER_BANK                = 0xf
    MACH_IPC_VOUCHER_REUSE               = 0x10
    MACH_IPC_MSG_DUMP			         = 0x11
    MACH_IPC_MSG_BOARDER		         = 0x12
    MACH_IPC_MSG_DSC			         = 0x13
    MACH_IPC_MSG_TRAP			         = 0x14
    MACH_IPC_MSG_INTERNAL_DSC	         = 0x15
    MACH_IPC_THREAD_VOUCHER		         = 0x16
...
class DBG_MACH_PMAP(enum.Enum):
    ...
    PMAP__DESTROY           = 0x1
    PMAP__PROTECT           = 0x2
    PMAP__PAGE_PROTECT      = 0x3
    PMAP__ENTER             = 0x4
    PMAP__REMOVE            = 0x5
    PMAP__NEST              = 0x6
    PMAP__UNNEST            = 0x7
    PMAP__FLUSH_TLBS        = 0x8
    PMAP__UPDATE_INTERRUPT  = 0x9
    PMAP__ATTRIBUTE_CLEAR   = 0xa
    PMAP__REUSABLE          = 0xb
    PMAP__QUERY_RESIDENT    = 0xc
    PMAP__FLUSH_KERN_TLBS   = 0xd
    PMAP__FLUSH_DELAYED_TLBS        = 0xe
    PMAP__FLUSH_TLBS_TO     = 0xf
    PMAP__FLUSH_EPT         = 0x10
    PMAP__FAST_FAULT        = 0x11
    PMAP__SWITCH            = 0x12
    PMAP__TTE               = 0x13
    PMAP__SWITCH_USER_TTB   = 0x14
    PMAP__UPDATE_CACHING    = 0x15
    PMAP__ATTRIBUTE_CLEAR_RANGE = 0x16
    PMAP__CLEAR_USER_TTB    = 0x17
    PMAP__IOMMU_INIT        = 0x18
    PMAP__IOMMU_IOVMALLOC   = 0x19
    PMAP__IOMMU_IOVMFREE    = 0x1a
    PMAP__IOMMU_MAP         = 0x1b
    PMAP__IOMMU_UNMAP       = 0x1c
    PMAP__IOMMU_IOCTL       = 0x1d
    PMAP__IOMMU_GRANT_PAGE  = 0x1e
...
class DBG_MACH_HV(enum.Enum):
    HV_GUEST_ENTER = 0x000
    HV_GUEST_ERROR = 0x001
...
class BANK_ACCOUNT_INFO(enum.Enum):
    ...
    BANK_VOUCHER_REDEEM           = 0x4    # /* Bank ledger(energy field) rolled up to tasks. */
