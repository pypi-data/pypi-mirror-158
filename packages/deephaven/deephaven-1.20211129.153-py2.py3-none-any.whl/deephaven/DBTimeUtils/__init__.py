...
@_passThrough
def consistentDateNy():
    return _java_type_.consistentDateNy()
...
@_passThrough
def makeInstant(nanos):
    return _java_type_.makeInstant(nanos)


@_passThrough
def makeZonedDateTime(*args):
    return _java_type_.makeZonedDateTime(*args)
...
@_passThrough
def toEpochNano(value):
    return _java_type_.toEpochNano(value)
