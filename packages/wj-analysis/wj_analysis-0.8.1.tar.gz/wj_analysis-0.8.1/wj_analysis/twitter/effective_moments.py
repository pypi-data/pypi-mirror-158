...
class EffectMomentsTW:
    def __init__(self, df_tw, trends=False, grouped=True):
        """Effective moments Twitter
        This class calculates the average of the effectiveness in one day,
        the average of the effectiveness per hour in a week
        and the effectiveness of the hours of a week for twitter
    ...
    def moments(self):
        ...
        try:
            df_original = self.df_org[colum_tweet]
        ...
        try:
            ...
            for sel_group in group:
                ...
                if grouped is True:
                    temp_1 = temp_1.groupby(["day", grouped_id], as_index=False).agg(
                        {"engagement_rate_by_post": "mean", "tweet_id": "count"}
                    )
                else:
            ...
            for group in group:
                ...
                if grouped is True:
                    ...
                    ).agg({"engagement_rate_by_post": "mean", "tweet_id": "count"})
                else:
                    temp_1 = temp_1.groupby(
