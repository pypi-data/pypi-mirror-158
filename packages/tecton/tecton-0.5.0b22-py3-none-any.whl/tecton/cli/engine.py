    ...
    def print(self, debug: bool, recreates_suppressed: bool):
        ...
        if recreates_suppressed:
            printer.safe_print(
                ...
                f"changes without recreating or rematerializing data. Suppressing recreates incorrectly may "
                f"corrupt feature data, and should only be used when you are absolutely certain it will not "
                f"break the feature pipeline, and when it is beneficial to suppress recreates. Unrelated "
                f"changes should also be applied separately.\n\n"
                f"PLEASE TRIPLE CHECK THE PLAN OUTPUT BEFORE APPLYING.",
                Style.RESET_ALL,
            )
