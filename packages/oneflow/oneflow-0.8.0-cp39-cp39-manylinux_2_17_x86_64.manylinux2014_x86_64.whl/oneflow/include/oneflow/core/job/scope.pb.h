...
class ScopeProto :
 ...
 public:
  ...
  enum : int {
    ...
    kOptMirroredParallelConfFieldNumber = 50,
  ...
  // required .oneflow.OptMirroredParallel opt_mirrored_parallel_conf = 50;
  bool has_opt_mirrored_parallel_conf() const;
  void clear_opt_mirrored_parallel_conf();
  const ::oneflow::OptMirroredParallel& opt_mirrored_parallel_conf() const;
  ::oneflow::OptMirroredParallel* release_opt_mirrored_parallel_conf();
  ::oneflow::OptMirroredParallel* mutable_opt_mirrored_parallel_conf();
  void set_allocated_opt_mirrored_parallel_conf(::oneflow::OptMirroredParallel* opt_mirrored_parallel_conf);
 ...
 private:
  ...
  ::oneflow::OptMirroredParallel* opt_mirrored_parallel_conf_;
...
// required .oneflow.OptMirroredParallel opt_mirrored_parallel_conf = 50;
inline bool ScopeProto::has_opt_mirrored_parallel_conf() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline const ::oneflow::OptMirroredParallel& ScopeProto::opt_mirrored_parallel_conf() const {
  const ::oneflow::OptMirroredParallel* p = opt_mirrored_parallel_conf_;
  // @@protoc_insertion_point(field_get:oneflow.ScopeProto.opt_mirrored_parallel_conf)
  return p != nullptr ? *p : *reinterpret_cast<const ::oneflow::OptMirroredParallel*>(
      &::oneflow::_OptMirroredParallel_default_instance_);
}
inline ::oneflow::OptMirroredParallel* ScopeProto::release_opt_mirrored_parallel_conf() {
  // @@protoc_insertion_point(field_release:oneflow.ScopeProto.opt_mirrored_parallel_conf)
  _has_bits_[0] &= ~0x00000004u;
  ::oneflow::OptMirroredParallel* temp = opt_mirrored_parallel_conf_;
  opt_mirrored_parallel_conf_ = nullptr;
  return temp;
}
inline ::oneflow::OptMirroredParallel* ScopeProto::mutable_opt_mirrored_parallel_conf() {
  _has_bits_[0] |= 0x00000004u;
  if (opt_mirrored_parallel_conf_ == nullptr) {
    auto* p = CreateMaybeMessage<::oneflow::OptMirroredParallel>(GetArenaNoVirtual());
    opt_mirrored_parallel_conf_ = p;
  }
  // @@protoc_insertion_point(field_mutable:oneflow.ScopeProto.opt_mirrored_parallel_conf)
  return opt_mirrored_parallel_conf_;
}
inline void ScopeProto::set_allocated_opt_mirrored_parallel_conf(::oneflow::OptMirroredParallel* opt_mirrored_parallel_conf) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(opt_mirrored_parallel_conf_);
  }
  if (opt_mirrored_parallel_conf) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena = nullptr;
    if (message_arena != submessage_arena) {
      opt_mirrored_parallel_conf = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, opt_mirrored_parallel_conf, submessage_arena);
    }
    _has_bits_[0] |= 0x00000004u;
  } else {
    _has_bits_[0] &= ~0x00000004u;
  }
  opt_mirrored_parallel_conf_ = opt_mirrored_parallel_conf;
  // @@protoc_insertion_point(field_set_allocated:oneflow.ScopeProto.opt_mirrored_parallel_conf)
}
