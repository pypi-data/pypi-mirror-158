...
Maybe<one::Tensor> DivGrad(const std::shared_ptr<one::Tensor>& y, const std::shared_ptr<one::Tensor>& z, const std::shared_ptr<one::Tensor>& dz);
...
Maybe<one::Tensor> PowXGrad(const std::shared_ptr<one::Tensor>& dz, const std::shared_ptr<one::Tensor>& x, const std::shared_ptr<one::Tensor>& y);

Maybe<one::Tensor> PowYGrad(const std::shared_ptr<one::Tensor>& dz, const std::shared_ptr<one::Tensor>& x, const std::shared_ptr<one::Tensor>& y);
...
Maybe<one::Tensor> BroadcastPowXGrad(const std::shared_ptr<one::Tensor>& dz, const std::shared_ptr<one::Tensor>& x, const std::shared_ptr<one::Tensor>& y, const std::shared_ptr<one::Tensor>& z);

Maybe<one::Tensor> BroadcastPowYGrad(const std::shared_ptr<one::Tensor>& dz, const std::shared_ptr<one::Tensor>& x, const std::shared_ptr<one::Tensor>& y, const std::shared_ptr<one::Tensor>& z);
...
Maybe<one::Tensor> SigmoidGrad(const std::shared_ptr<one::Tensor>& x, const std::shared_ptr<one::Tensor>& dy);
...
Maybe<one::Tensor> ConsistentNormal(float mean, float std, const Shape& size, const Optional<one::Tensor>& out, const Symbol<ParallelDesc>& placement, const std::vector<Symbol<SbpParallel>>& sbp, const Optional<Symbol<DType>>& dtype, const Optional<one::Generator>& generator, bool requires_grad);

Maybe<one::Tensor> ConsistentNormal2(float mean, float std, int32_t size, const Optional<one::Tensor>& out, const Symbol<ParallelDesc>& placement, const std::vector<Symbol<SbpParallel>>& sbp, const Optional<Symbol<DType>>& dtype, const Optional<one::Generator>& generator, bool requires_grad);
...
Maybe<one::Tensor> ConsistentArange(const Scalar& start, const Scalar& end, const Scalar& step, const Optional<Symbol<DType>>& dtype, const Symbol<ParallelDesc>& placement, const std::vector<Symbol<SbpParallel>>& sbp);

Maybe<one::Tensor> ConsistentArange(const Scalar& end, const Optional<Symbol<DType>>& dtype, const Symbol<ParallelDesc>& placement, const std::vector<Symbol<SbpParallel>>& sbp);
...
Maybe<one::Tensor> ConsistentConstant(const Shape& shape, const Scalar& value, const Symbol<DType>& dtype, const Symbol<ParallelDesc>& placement, const std::vector<Symbol<SbpParallel>>& sbp);

Maybe<one::Tensor> Empty(const Shape& shape, const Symbol<DType>& dtype, const Optional<Symbol<Device>>& device, bool pin_memory);

Maybe<one::Tensor> ConsistentEmpty(const Shape& shape, const Symbol<DType>& dtype, const Symbol<ParallelDesc>& placement, const std::vector<Symbol<SbpParallel>>& sbp);

Maybe<one::Tensor> ZerosLike(const std::shared_ptr<one::Tensor>& x);

Maybe<one::Tensor> OnesLike(const std::shared_ptr<one::Tensor>& x);

Maybe<one::Tensor> Bernoulli(const std::shared_ptr<one::Tensor>& x, const Symbol<DType>& dtype, const Optional<one::Generator>& generator);
...
Maybe<one::Tensor> ExpandGrad(const std::shared_ptr<one::Tensor>& dy, const std::vector<int32_t>& out, const std::vector<int32_t>& expand);
...
Maybe<one::Tensor> Mv(const std::shared_ptr<one::Tensor>& input, const std::shared_ptr<one::Tensor>& vec);
...
Maybe<one::Tensor> CrossEntropy(const std::shared_ptr<one::Tensor>& input, const std::shared_ptr<one::Tensor>& target, const Optional<one::Tensor>& weight, int64_t ignore_index, const std::string& reduction);
...
Maybe<one::Tensor> CtcLoss(const std::shared_ptr<one::Tensor>& log_probs, const std::shared_ptr<one::Tensor>& targets, const std::shared_ptr<one::Tensor>& input_lengths, const std::shared_ptr<one::Tensor>& target_lengths, int64_t max_target_length, int32_t blank, bool zero_infinity, const std::string& reduction);
...
Maybe<one::Tensor> MaskedFill(const std::shared_ptr<one::Tensor>& x, const std::shared_ptr<one::Tensor>& mask, const Scalar& value);
...
Maybe<one::Tensor> NegativeGrad(const std::shared_ptr<one::Tensor>& x, const std::shared_ptr<one::Tensor>& dy);
...
Maybe<one::TensorTuple> LayerNormParamGrad(const std::shared_ptr<one::Tensor>& dy, const std::shared_ptr<one::Tensor>& x, const std::shared_ptr<one::Tensor>& mean, const std::shared_ptr<one::Tensor>& inv_variance, int64_t begin_params_axis, double epsilon);
...
Maybe<one::Tensor> Norm(const std::shared_ptr<one::Tensor>& input, const Optional<Scalar>& ord, const Optional<std::vector<int32_t>>& dim, bool keepdim, const Optional<Symbol<DType>>& dtype);
...
Maybe<one::Tensor> DimScatter(const std::shared_ptr<one::Tensor>& input, int32_t dim, const std::shared_ptr<one::Tensor>& index, const std::shared_ptr<one::Tensor>& src);

Maybe<one::Tensor> DimScatterUpdateScalar(const std::shared_ptr<one::Tensor>& input, int32_t dim, const std::shared_ptr<one::Tensor>& index, const Scalar& src);

Maybe<one::Tensor> DimScatterAdd(const std::shared_ptr<one::Tensor>& input, int32_t dim, const std::shared_ptr<one::Tensor>& index, const std::shared_ptr<one::Tensor>& src);

Maybe<one::Tensor> DimScatterAddScalar(const std::shared_ptr<one::Tensor>& input, int32_t dim, const std::shared_ptr<one::Tensor>& index, const Scalar& src);
...
Maybe<one::Tensor> LocalToConsistent(const std::shared_ptr<one::Tensor>& x, const Symbol<ParallelDesc>& placement, const std::vector<Symbol<SbpParallel>>& sbp, const Shape& shape, const Symbol<DType>& dtype);

Maybe<one::Tensor> ToConsistent(const std::shared_ptr<one::Tensor>& x, const Symbol<ParallelDesc>& placement, const std::vector<Symbol<SbpParallel>>& sbp, const std::vector<Symbol<SbpParallel>>& grad_sbp, bool check_meta);

Maybe<one::Tensor> ConsistentToLocal(const std::shared_ptr<one::Tensor>& x);

Maybe<void> StreamTouch(const TensorTuple& x);

Maybe<one::Tensor> Broadcast(const std::shared_ptr<one::Tensor>& x, int64_t src_rank, bool inplace);
...
Maybe<one::Tensor> ConsistentAllReduce(const std::shared_ptr<one::Tensor>& x);

Maybe<one::Tensor> ConsistentReduceScatter(const std::shared_ptr<one::Tensor>& x, const std::string& op_type);

Maybe<one::Tensor> ConsistentAllGather(const std::shared_ptr<one::Tensor>& x);

Maybe<one::Tensor> ConsistentS2S(const std::shared_ptr<one::Tensor>& x, const std::vector<Symbol<SbpParallel>>& out_sbp);
...
Maybe<one::Tensor> ConsistentRand(const Shape& size, const Symbol<ParallelDesc>& placement, const std::vector<Symbol<SbpParallel>>& sbp, const Optional<Symbol<DType>>& dtype, const Optional<one::Generator>& generator, bool requires_grad);
...
Maybe<one::Tensor> ConsistentRandN(const Shape& size, const Symbol<ParallelDesc>& placement, const std::vector<Symbol<SbpParallel>>& sbp, const Optional<Symbol<DType>>& dtype, const Optional<one::Generator>& generator, bool requires_grad);
...
Maybe<one::Tensor> ConsistentRandInt(int64_t low, int64_t high, const Shape& size, const Symbol<ParallelDesc>& placement, const std::vector<Symbol<SbpParallel>>& sbp, const Optional<Symbol<DType>>& dtype, const Optional<one::Generator>& generator, bool requires_grad);

Maybe<one::Tensor> ConsistentRandInt(int64_t high, const Shape& size, const Symbol<ParallelDesc>& placement, const std::vector<Symbol<SbpParallel>>& sbp, const Optional<Symbol<DType>>& dtype, const Optional<one::Generator>& generator, bool requires_grad);
...
Maybe<one::Tensor> ConsistentRandPerm(int32_t n, const Symbol<ParallelDesc>& placement, const std::vector<Symbol<SbpParallel>>& sbp, const Optional<one::Generator>& generator, const Symbol<DType>& dtype, bool requires_grad);
...
Maybe<one::Tensor> Unfold(const std::shared_ptr<one::Tensor>& x, const std::string& data_format, const std::vector<int32_t>& kernel_size, const std::vector<int32_t>& dilation_rate, const std::vector<int32_t>& padding, const std::vector<int32_t>& strides);

Maybe<one::Tensor> Fold(const std::shared_ptr<one::Tensor>& x, const std::string& data_format, const std::vector<int32_t>& output_size, const std::vector<int32_t>& kernel_size, const std::vector<int32_t>& dilation_rate, const std::vector<int32_t>& padding, const std::vector<int32_t>& strides);
...
Maybe<one::TensorTuple> FusedScaleTrilSoftmaxMaskScale(const std::shared_ptr<one::Tensor>& a, float p, int64_t diagonal, float tril_scale_value, const Optional<one::Generator>& generator);
...
Maybe<one::TensorTuple> OneEmbeddingIdShuffle(const std::shared_ptr<one::Tensor>& ids, const Optional<one::Tensor>& table_ids, int32_t num_tables);

Maybe<one::Tensor> OneEmbeddingEmbeddingShuffle(const std::shared_ptr<one::Tensor>& cur_rank_embeddings, const std::shared_ptr<one::Tensor>& num_unique_matrix, const std::shared_ptr<one::Tensor>& cur_rank_inverse_indices, const std::shared_ptr<one::Tensor>& inverse_unique_partition_indices);

Maybe<one::Tensor> OneEmbeddingEmbeddingGradientShuffle(const std::shared_ptr<one::Tensor>& embedding_grad, const std::shared_ptr<one::Tensor>& num_unique_matrix, const std::shared_ptr<one::Tensor>& cur_rank_inverse_indices, const std::shared_ptr<one::Tensor>& inverse_unique_partition_indices);

Maybe<one::Tensor> OneEmbeddingLookup(const std::shared_ptr<one::Tensor>& shadow, const std::shared_ptr<one::Tensor>& ids, const Optional<one::Tensor>& table_ids, const Symbol<DType>& dtype, int64_t embedding_size, int32_t num_tables, const std::string& embedding_tables, const std::string& embedding_store_options);

Maybe<one::TensorTuple> OneEmbeddingUniqueKeyValuePair(const std::shared_ptr<one::Tensor>& keys, const Optional<one::Tensor>& values, int32_t num_tables);

Maybe<one::Tensor> OneEmbeddingSgdUpdate(const std::shared_ptr<one::Tensor>& num_unique_ids, const std::shared_ptr<one::Tensor>& unique_embeddings, const std::shared_ptr<one::Tensor>& embedding_grad, const std::shared_ptr<one::Tensor>& learning_rate, const std::shared_ptr<one::Tensor>& down_scale_by_tensor, const std::shared_ptr<one::Tensor>& skip_if, double scale, float weight_decay, float momentum);

Maybe<one::Tensor> OneEmbeddingAdamUpdate(const std::shared_ptr<one::Tensor>& num_unique_ids, const std::shared_ptr<one::Tensor>& unique_embeddings, const std::shared_ptr<one::Tensor>& embedding_grad, const std::shared_ptr<one::Tensor>& learning_rate, const std::shared_ptr<one::Tensor>& down_scale_by_tensor, const std::shared_ptr<one::Tensor>& skip_if, const Optional<one::Tensor>& bias_correction1, const Optional<one::Tensor>& bias_correction2, double scale, float weight_decay, float beta1, float beta2, float epsilon, bool do_bias_correction);

Maybe<one::Tensor> OneEmbeddingAdagradUpdate(const std::shared_ptr<one::Tensor>& num_unique_ids, const std::shared_ptr<one::Tensor>& unique_embeddings, const std::shared_ptr<one::Tensor>& embedding_grad, const std::shared_ptr<one::Tensor>& learning_rate, const std::shared_ptr<one::Tensor>& down_scale_by_tensor, const std::shared_ptr<one::Tensor>& skip_if, const std::shared_ptr<one::Tensor>& train_step, double scale, float weight_decay, float lr_decay, float epsilon);

Maybe<one::Tensor> OneEmbeddingFtrlUpdate(const std::shared_ptr<one::Tensor>& num_unique_ids, const std::shared_ptr<one::Tensor>& unique_embeddings, const std::shared_ptr<one::Tensor>& embedding_grad, const std::shared_ptr<one::Tensor>& learning_rate, const std::shared_ptr<one::Tensor>& down_scale_by_tensor, const std::shared_ptr<one::Tensor>& skip_if, double scale, float weight_decay, float lr_power, float lambda1, float lambda2, float beta);
...
Maybe<void> MultiTensorSgdUpdate(const TensorTuple& model, const TensorTuple& model_diff, const std::shared_ptr<one::Tensor>& learning_rate, double scale, float weight_decay);

Maybe<void> MultiTensorAdamUpdate(const TensorTuple& model, const TensorTuple& model_diff, const TensorTuple& m, const TensorTuple& v, const std::shared_ptr<one::Tensor>& learning_rate, float beta1, float beta2, float bias_correction1_val, float bias_correction2_val, bool do_bias_correction, double scale, float weight_decay);
