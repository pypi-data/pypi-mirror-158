...
from oneflow.core.job import mirrored_parallel_pb2 as oneflow_dot_core_dot_job_dot_mirrored__parallel__pb2
...
_OPATTRIBUTE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='mirrored_signature', full_name='oneflow.OpAttribute.mirrored_signature', index=9,
...
_OPATTRIBUTE.fields_by_name['mirrored_signature'].message_type = oneflow_dot_core_dot_job_dot_mirrored__parallel__pb2._MIRROREDSIGNATURE
