...
class OpNodeSignature :
 ...
 public:
  ...
  enum : int {
    ...
    kMirroredSignatureFieldNumber = 2,
...
// optional .oneflow.MirroredSignature mirrored_signature = 2;
inline bool OpNodeSignature::has_mirrored_signature() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline const ::oneflow::MirroredSignature& OpNodeSignature::mirrored_signature() const {
  const ::oneflow::MirroredSignature* p = mirrored_signature_;
  // @@protoc_insertion_point(field_get:oneflow.OpNodeSignature.mirrored_signature)
  return p != nullptr ? *p : *reinterpret_cast<const ::oneflow::MirroredSignature*>(
      &::oneflow::_MirroredSignature_default_instance_);
}
inline ::oneflow::MirroredSignature* OpNodeSignature::release_mirrored_signature() {
  // @@protoc_insertion_point(field_release:oneflow.OpNodeSignature.mirrored_signature)
  _has_bits_[0] &= ~0x00000002u;
  ::oneflow::MirroredSignature* temp = mirrored_signature_;
  mirrored_signature_ = nullptr;
  return temp;
}
inline ::oneflow::MirroredSignature* OpNodeSignature::mutable_mirrored_signature() {
  _has_bits_[0] |= 0x00000002u;
  if (mirrored_signature_ == nullptr) {
    auto* p = CreateMaybeMessage<::oneflow::MirroredSignature>(GetArenaNoVirtual());
    mirrored_signature_ = p;
  }
  // @@protoc_insertion_point(field_mutable:oneflow.OpNodeSignature.mirrored_signature)
  return mirrored_signature_;
}
inline void OpNodeSignature::set_allocated_mirrored_signature(::oneflow::MirroredSignature* mirrored_signature) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
  ...
  // @@protoc_insertion_point(field_set_allocated:oneflow.OpNodeSignature.mirrored_signature)
}
