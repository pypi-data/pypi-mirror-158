...
class OpAttribute :
 ...
 public:
  ...
  enum : int {
    ...
    kMirroredSignatureFieldNumber = 105,
  ...
  // optional .oneflow.MirroredSignature mirrored_signature = 105;
  bool has_mirrored_signature() const;
  void clear_mirrored_signature();
  const ::oneflow::MirroredSignature& mirrored_signature() const;
  ::oneflow::MirroredSignature* release_mirrored_signature();
  ::oneflow::MirroredSignature* mutable_mirrored_signature();
  void set_allocated_mirrored_signature(::oneflow::MirroredSignature* mirrored_signature);
 ...
 private:
  ...
  ::oneflow::MirroredSignature* mirrored_signature_;
...
// optional .oneflow.MirroredSignature mirrored_signature = 105;
inline bool OpAttribute::has_mirrored_signature() const {
  return (_has_bits_[0] & 0x00000040u) != 0;
}
inline const ::oneflow::MirroredSignature& OpAttribute::mirrored_signature() const {
  const ::oneflow::MirroredSignature* p = mirrored_signature_;
  // @@protoc_insertion_point(field_get:oneflow.OpAttribute.mirrored_signature)
  return p != nullptr ? *p : *reinterpret_cast<const ::oneflow::MirroredSignature*>(
      &::oneflow::_MirroredSignature_default_instance_);
}
inline ::oneflow::MirroredSignature* OpAttribute::release_mirrored_signature() {
  // @@protoc_insertion_point(field_release:oneflow.OpAttribute.mirrored_signature)
  _has_bits_[0] &= ~0x00000040u;
  ::oneflow::MirroredSignature* temp = mirrored_signature_;
  mirrored_signature_ = nullptr;
  return temp;
}
inline ::oneflow::MirroredSignature* OpAttribute::mutable_mirrored_signature() {
  _has_bits_[0] |= 0x00000040u;
  if (mirrored_signature_ == nullptr) {
    auto* p = CreateMaybeMessage<::oneflow::MirroredSignature>(GetArenaNoVirtual());
    mirrored_signature_ = p;
  }
  // @@protoc_insertion_point(field_mutable:oneflow.OpAttribute.mirrored_signature)
  return mirrored_signature_;
}
inline void OpAttribute::set_allocated_mirrored_signature(::oneflow::MirroredSignature* mirrored_signature) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(mirrored_signature_);
  }
  if (mirrored_signature) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena = nullptr;
    if (message_arena != submessage_arena) {
      mirrored_signature = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, mirrored_signature, submessage_arena);
    }
    _has_bits_[0] |= 0x00000040u;
  } else {
    _has_bits_[0] &= ~0x00000040u;
  }
  mirrored_signature_ = mirrored_signature;
  // @@protoc_insertion_point(field_set_allocated:oneflow.OpAttribute.mirrored_signature)
}
