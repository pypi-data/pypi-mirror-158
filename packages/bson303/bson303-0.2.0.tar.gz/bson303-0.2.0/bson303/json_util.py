...
.. doctest::
   ...
   >>> from bson303 import Binary, Code
   >>> from bson303.json_util import dumps
   >>> dumps([{'foo': [1, 2]},
   ...        {'bar': {'hello': 'world'}},
...
.. doctest::
   ...
   >>> from bson303.json_util import loads
...
It won't handle :class:`~bson303.binary.Binary` and :class:`~bson303.code.Code`
instances (as they are extended strings you can't provide custom defaults),
but it will be faster as there is less recursion.

.. versionchanged:: 2.8
   The output format for :class:`~bson303.timestamp.Timestamp` has changed from
   '{"t": <int>, "i": <int>}' to '{"$timestamp": {"t": <int>, "i": <int>}}'.
   This new format will be decoded to an instance of
   :class:`~bson303.timestamp.Timestamp`. The old format will continue to be
...
.. versionchanged:: 2.3
   ...
   from json and supports :class:`~bson303.binary.Binary` and
   :class:`~bson303.code.Code`
"""
...
from bson303 import EPOCH_AWARE, RE_TYPE, SON
from bson303.binary import Binary
...
from bson303.py3compat import PY3, iteritems, string_type, text_type
...
def dumps(obj, *args, **kwargs):
    ...
    :class:`~bson303.binary.Binary` and :class:`~bson303.code.Code`.
