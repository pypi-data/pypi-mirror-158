...
from bson303.errors import InvalidId
from bson303.py3compat import PY3, bytes_from_hex, string_type, text_type
...
class ObjectId(object):
    ...
    def __init__(self, oid=None):
        ...
        Raises :class:`~bson303.errors.InvalidId` if `oid` is not 12 bytes nor
