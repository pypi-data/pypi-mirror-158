...
class Bybit(CcxtExchange):
    ...
    def post_market_order(self, ticker, side, open_close, amount, **kwargs):
        """
        :param ticker: <String>
        ...
        if self.market == 'USDT':
            ...
            extra_params = {} if open_close == 'open' else {'reduce_only': True}
            order_id = self.ccxt_inst.create_market_order(symbol, side, amount, extra_params)['id']
