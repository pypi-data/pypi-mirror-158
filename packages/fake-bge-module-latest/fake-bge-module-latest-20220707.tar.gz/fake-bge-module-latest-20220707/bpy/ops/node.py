...
def collapse_hide_unused_toggle():
    ''' Toggle collapsed nodes and hide unused sockets :file: startup/bl_operators/node.py\:266 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/node.py$266> _
...
def tree_path_parent():
    ''' Go to parent node tree :file: startup/bl_operators/node.py\:296 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/node.py$296> _
