...
class TimeSlot(ProviderProfile):
  ...
  slot_status: TimeSlotStatus = 'available'


class BookingDetail(TimeSlot):  # details of a booking, which is shown to the provider and consumer
  total_fee_aud: int
