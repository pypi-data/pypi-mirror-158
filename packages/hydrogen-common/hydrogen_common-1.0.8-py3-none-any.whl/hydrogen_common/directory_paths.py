        ...
        with open(lock_file_name, "w+") as lock_stream:
            ...
            with open(domain_state_filename, "w+") as write_stream:
                ...
                for attribute_name in domain_state.keys():
                    if not attribute_name in ["user_id", "domain_directory"]:
                ...
                # Put the actual directory name into the prev_domain_state
                prev_domain_state["directory_name"] = domain_directory
                prev_domain_state["domain_directory"] = domain_directory
