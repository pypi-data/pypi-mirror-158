...
class ActionParams(google___protobuf___message___Message):
    ...
    def WhichOneof(self, oneof_group: typing_extensions___Literal[u"params",b"params"]) -> typing_extensions___Literal["charge_refund_params","subscription_trial_update_params","coupon_apply_params","opportunity_create_params","task_create_params","cadence_add_person_params","sequence_add_prospect_params","ownership_update_params","custom_params","redirect_params","add_to_contact_list_params"]: ...
