(self["webpackChunkjupyter_pixano"] = self["webpackChunkjupyter_pixano"] || []).push([["lib_widget_js"],{

/***/ "./lib/attribute-picker.js":
/*!*********************************!*\
  !*** ./lib/attribute-picker.js ***!
  \*********************************/
...
exports.AttributePicker = void 0;
const lit_element_1 = __webpack_require__(/*! lit-element */ "webpack/sharing/consume/default/lit-element/lit-element?cee4");
__webpack_require__(/*! @material/mwc-dialog */ "webpack/sharing/consume/default/@material/mwc-dialog/@material/mwc-dialog");
__webpack_require__(/*! @material/mwc-checkbox */ "webpack/sharing/consume/default/@material/mwc-checkbox/@material/mwc-checkbox");
__webpack_require__(/*! @material/mwc-formfield */ "webpack/sharing/consume/default/@material/mwc-formfield/@material/mwc-formfield");
__webpack_require__(/*! @material/mwc-select */ "webpack/sharing/consume/default/@material/mwc-select/@material/mwc-select");
__webpack_require__(/*! @material/mwc-textfield */ "webpack/sharing/consume/default/@material/mwc-textfield/@material/mwc-textfield");
__webpack_require__(/*! @material/mwc-list/mwc-list-item */ "./node_modules/@material/mwc-list/mwc-list-item.js");
__webpack_require__(/*! @material/mwc-icon-button */ "webpack/sharing/consume/default/@material/mwc-icon-button/@material/mwc-icon-button");
const utils_1 = __webpack_require__(/*! ./utils */ "./lib/utils.js");
//position: absolute;
//right: 0px;
// TODO: move to pixano-elements
class AttributePicker extends lit_element_1.LitElement {
    static get styles() {
        return [
            lit_element_1.css `
        :host {
    ...
    setAttributes(entity) {
        if (entity) {
            ...
            console.log("scroll!!!", entity.category);
            this.shadowRoot.getElementById(entity.category).scrollIntoViewIfNeeded(); //({behavior: "smooth", block: "center", inline: "nearest"})
            ...
            const elem = [...childDivs].find((c) => c.label === this.value.category);
    ...
    firstUpdated() {
        ...
        const attr = this.shadowRoot.getElementById("attributes_picker");
        console.log("add event to", attr);
        attr.addEventListener('keydown', this.onKeyDown);
        attr.addEventListener('keyup', this.onKeyUp);
    }
    htmlProp(prop) {
        if (prop.type === 'dropdown') {
            ...
            <mwc-select label="${prop.name}" @selected=${(e) => {
              ...
              ${prop.enum.map((sub) => {
                return lit_element_1.html `<mwc-list-item value="${sub}" ?selected=${this.value.options[prop.name] === sub}>${sub}</mwc-list-item>`;
            })}
            </mwc-select>
            `;
        }
            ...
            <mwc-formfield label="${prop.name}">
              <mwc-checkbox ?checked=${checked} @change=${(evt) => {
            ...
            return lit_element_1.html `
                ...
                this.value.options[prop.name] = utils_1.getValue(evt);
                this.value = Object.assign({}, this.value);
                this._notifyUpdate();
            }}></mwc-textfield>
			`;
    ...
    get renderDetail() {
        console.log("renderDetail", !this.showDetail);
        return lit_element_1.html `
        <div id="updateEditor" style="width: 100%;" ?hidden=${!this.showDetail}>
            ...
            return lit_element_1.html `
                    ...
                    ${category.properties && category.name === this.value.category ? lit_element_1.html `
    ...
    get renderSimple() {
        console.log("renderSimple", this.showDetail);
        return lit_element_1.html `
...
exports.AttributePicker = AttributePicker;
...
*/
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.timeConverter = exports.format = exports.getValue = exports.setProperty = exports.getProperty = exports.isEqual = exports.colorToHex = exports.colorToRGBA = exports.commonJson = void 0;
function commonJson(entities) {
...
const isEqual = (value, other) => {
    ...
    var compare = function (item1, item2) {
        ...
        if (['[object Array]', '[object Object]'].indexOf(itemType) >= 0) {
            if (!exports.isEqual(item1, item2))
                return false;
        }
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.PixanoView = exports.PixanoModel = void 0;
const base_1 = __webpack_require__(/*! @jupyter-widgets/base */ "webpack/sharing/consume/default/@jupyter-widgets/base");
__webpack_require__(/*! @pixano/graphics-2d */ "webpack/sharing/consume/default/@pixano/graphics-2d/@pixano/graphics-2d");
//@ts-ignore
//import { commonJson, colorToRGBA } from '@pixano/core/lib/utils';
__webpack_require__(/*! ./attribute-picker.js */ "./lib/attribute-picker.js");
const utils_js_1 = __webpack_require__(/*! ./utils.js */ "./lib/utils.js");
...
class pixanoRightPanel extends lit_element_1.LitElement {
    constructor() {
        super();
    ...
    <main>
      <div class="right-panel">
        ...
        <div class="icons"> 
          <p  class="icon" title="Add polygon"  @click=${() => this.pencil_func()} >${style_1.createPencil}</p>
          <p  class="icon" title="Edit"         @click=${() => this.pointer_func()} >${style_1.pointer}</p>
          ${this.pixano_element_type === 'pxn-segmentation' || this.pixano_element_type === 'pxn-smart-segmentation'
            ? lit_element_1.html `
              <p class="icon" title="Brush"                @click=${() => this.brush_func()} >${style_1.brush}</p>
                ${this.pixano_element_type === 'pxn-smart-segmentation'
                ? lit_element_1.html `<p class="icon" title="Smart Segmentation"     @click=${() => this.smart_rect_func()} >${style_1.magicSelect}</p>`
                : ''} 
              <p class="icon" title="Remove from instance" @click=${() => this.sub_func()} >${style_1.subtract}</p>
              <p class="icon" title="Add to instance"      @click=${() => this.add_func()} >${style_1.union}</p>
              `
            : ''} 
          
         ${this.pixano_element_type === 'pxn-smart-rectangle'
            ? lit_element_1.html `
             <p class="icon" title="Smart Rectangle"     @click=${() => this.smart_rect_func()} >${style_1.magicSelect}</p>
             <p class="icon" title="ROI increase (+)" @click=${() => this.pxnElement.roiUp()}>${style_1.increase}</p>
             <p class="icon" title="ROI decrease (-)" @click=${() => this.pxnElement.roiDown()}>${style_1.decrease}</p>
             `
            : ''} 
    ...
    brush_func() {
        if (this.pxnElement !== null) {
            this.pxnElement.mode = 'create-brush';
    ...
    sub_func() {
        if (this.pxnElement !== null) {
            ...
            if (this.last_mode !== "")
                this.pxnElement.mode = this.last_mode;
            console.log('this.pxnElement.mode', this.pxnElement.mode);
            console.log('this.pxnElement.editionMode', this.pxnElement.editionMode);
        }
    }
    ...
    smart_rect_func() {
        if (this.pxnElement !== null) {
            this.pxnElement.mode = 'smart-create';
        }
    }
}
customElements.define('pixano-right-panel', pixanoRightPanel);
class PixanoModel extends base_1.DOMWidgetModel {
    defaults() {
        return Object.assign(Object.assign({}, super.defaults()), { _model_name: PixanoModel.model_name, _model_module: PixanoModel.model_module, _model_module_version: PixanoModel.model_module_version, _view_name: PixanoModel.view_name, _view_module: PixanoModel.view_module, _view_module_version: PixanoModel.view_module_version, element: 'pxn-rectangle', image_path: '', image_data: '', mode: 'none', counter: 0, shapes: [], selectedShapeIds: [], shapes_in: [], mask: '', current_category: '', categories_colors: {}, annotations: {}, annotations_input: {}, selectedIds: [], targetClass: 1, clsMap: {}, maskVisuMode: 'INSTANCE', label_schema: {}, image_src: '' });
    }
}
exports.PixanoModel = PixanoModel;
PixanoModel.serializers = Object.assign({}, base_1.DOMWidgetModel.serializers);
PixanoModel.model_name = 'PixanoModel';
PixanoModel.model_module = version_1.MODULE_NAME;
PixanoModel.model_module_version = version_1.MODULE_VERSION;
PixanoModel.view_name = 'PixanoView';
PixanoModel.view_module = version_1.MODULE_NAME;
PixanoModel.view_module_version = version_1.MODULE_VERSION;
class PixanoView extends base_1.DOMWidgetView {
    render() {
        console.log("pixanoooooo 22");
        this.selectedIds = [];
        ...
        this.pxnElement.mode = 'edit';
        this.pxnElement.addEventListener('create', (e) => { this.callback_create(e); });
        this.pxnElement.addEventListener('update', (e) => { this.callback_update(e); });
        this.pxnElement.addEventListener('delete', (e) => { this.callback_delete(e); });
        this.pxnElement.addEventListener('selection', (e) => { this.callback_select(e); });
        ...
        const properties_panel = document.createElement("div");
        ...
        if (label_schema_python.category && label_schema_python.category.length > 0) {
            ...
            if (pxn_element_type.search("segmentation") !== -1) {
                ...
                this.pxnElement.clsMap = new Map(label_schema_python.category.map((c) => {
                    const color = utils_js_1.colorToRGBA(c.color);
                    return [c.idx, [color[0], color[1], color[2], c.instance ? 1 : 0]];
                }));
                console.log("!!!!", this.pxnElement.clsMap);
                if (!label_schema_python.default)
                    label_schema_python.default = label_schema_python.category[0].name;
                this.schema = label_schema_python;
                this.pxnElement.targetClass = label_schema_python.category.find((c) => c.name === label_schema_python.default).idx;
            }
        }
        else {
    ...
    setSelectedIds(newIds) {
        ...
        if (this.attributePicker)
            this.attributePicker.showDetail = this.selectedIds.length > 0;
    }
    ...
    updateModelSelectedIds() {
        ...
        if (this.selectedIds.length = 0)
            this.model.set("selectedIds", JSON.parse(JSON.stringify([])));
        else
        ...
        switch (pxn_element_type) {
            ...
            case 'pxn-polygon':
                this.selectedIds.forEach((id) => {
                    ...
                    shape.color = this.attributePicker._colorFor(shape.category);
                    // concatenate and set
                    if (pxn_element_type === 'cuboid-editor')
                        shapes = [...this.pxnElement.editableCuboids].map((_a) => {
                            var { color } = _a, s = __rest(_a, ["color"]);
                            return s;
                        });
                    else
                        shapes = [...this.pxnElement.shapes].map((_a) => {
                            var { color } = _a, s = __rest(_a, ["color"]);
                            return s;
                        });
            ...
            case 'pxn-cuboid-editor':
                this.selectedIds.forEach((id) => {
                    ...
                    shape.color = this.attributePicker._colorFor(shape.category);
                    const shapes = [...this.pxnElement.editableCuboids].map((_a) => {
                        var { color } = _a, s = __rest(_a, ["color"]);
                        return s;
                    });
                    this.setAnnotations(shapes);
    ...
    _onImagedataChanged() {
        ...
        if (pxn_element_type === 'pxn-segmentation' || pxn_element_type === 'pxn-smart-segmentation') {
            this.pxnElement.clsMap = new Map(this.schema.category.map((c) => {
                const color = utils_js_1.colorToRGBA(c.color);
                return [c.idx, [color[0], color[1], color[2], c.instance ? 1 : 0]];
            }));
            if (!this.schema.default)
                this.schema.default = this.schema.category[0].name;
            this.pxnElement.targetClass = this.schema.category.find((c) => c.name === this.schema.default).idx;
        }
        this.updateModelAnnotations();
    }
    _onModeChanged() {
    ...
    _onAnnotationsInChanged() {
        console.log("_onAnnotationsInChanged");
        ...
        if (annotations_input[0] !== '-') {
            switch (pxn_element_type) {
                ...
                case 'pxn-segmentation':
                case 'pxn-smart-segmentation':
                    let mask = annotations_input.find((l) => l.id === 0);
                    //console.log(mask)
        ...
        switch (pxn_element_type) {
            ...
            case 'pxn-smart-segmentation':
                ...
                if (label) { //id exists in the database, update information
                    ...
                    label = Object.assign({}, this.attributePicker.defaultValue);
        ...
        switch (pxn_element_type) {
            ...
            case 'pxn-polygon':
                ...
                if (this.selectedIds && this.selectedIds.length) {
                    ...
                    const common = utils_js_1.commonJson(shapes);
            ...
            case 'pxn-smart-segmentation':
                ...
                if (this.selectedIds) { //only one id at a time for segmentation
                    ...
                    const common = utils_js_1.commonJson(annot);
                    this.attributePicker.setAttributes(common);
                }
                else {
...
"use strict";
module.exports = JSON.parse('{"name":"jupyter_pixano","version":"0.1.4","description":"Pixano Element in jupyter widget","keywords":["jupyter","jupyterlab","jupyterlab-extension","widgets"],"files":["lib/**/*.js","dist/*.js","css/*.css"],"homepage":"https://github.com//ipypixano","bugs":{"url":"https://github.com//ipypixano/issues"},"license":"BSD-3-Clause","author":{"name":"nicolas allezard","email":"nicolas.allezard@cea.fr"},"main":"lib/index.js","types":"./lib/index.d.ts","repository":{"type":"git","url":"https://github.com//ipypixano"},"scripts":{"build":"yarn run build:lib && yarn run build:nbextension && yarn run build:labextension:dev","build:prod":"yarn run build:lib && yarn run build:nbextension && yarn run build:labextension","build:labextension":"jupyter labextension build .","build:labextension:dev":"jupyter labextension build --development True .","build:lib":"tsc","build:nbextension":"webpack","clean":"yarn run clean:lib && yarn run clean:nbextension && yarn run clean:labextension","clean:lib":"rimraf lib","clean:labextension":"rimraf ipypixano/labextension","clean:nbextension":"rimraf ipypixano/nbextension/static/index.js","lint":"eslint . --ext .ts,.tsx --fix","lint:check":"eslint . --ext .ts,.tsx","prepack":"yarn run build:lib","test":"jest","watch":"npm-run-all -p watch:*","watch:lib":"tsc -w","watch:nbextension":"webpack --watch --mode=development","watch:labextension":"jupyter labextension watch .","installLocalElements":"rm -rf node_modules/@pixano ;rm -rf package-lock.json ; npm i ${npm_config_path}/packages/core ; npm i ${npm_config_path}/packages/ai ; npm i ${npm_config_path}/packages/graphics-2d; npm i ${npm_config_path}/packages/graphics-3d"},"dependencies":{"@jupyter-widgets/base":"^1.1.10 || ^2.0.0 || ^3.0.0 || ^4.0.0","@material/mwc-button":"0.19.1","@material/mwc-checkbox":"0.19.1","@material/mwc-circular-progress-four-color":"0.19.1","@material/mwc-dialog":"0.19.1","@material/mwc-fab":"0.19.1","@material/mwc-formfield":"0.19.1","@material/mwc-icon":"0.19.1","@material/mwc-icon-button":"0.19.1","@material/mwc-icon-button-toggle":"0.19.1","@material/mwc-linear-progress":"0.19.1","@material/mwc-list":"0.19.1","@material/mwc-menu":"0.19.1","@material/mwc-radio":"0.19.1","@material/mwc-select":"0.19.1","@material/mwc-slider":"0.19.1","@material/mwc-snackbar":"0.19.1","@material/mwc-switch":"0.19.1","@material/mwc-tab":"0.19.1","@material/mwc-tab-bar":"0.19.1","@material/mwc-textarea":"0.19.1","@material/mwc-textfield":"^0.19.1","@pixano/core":"0.6.1","@pixano/graphics-2d":"file:../../pixano-elements/packages/graphics-2d/pixano-graphics-2d-0.6.1.tgz","lit-element":"2.4.0","material-design-icons":"^3.0.1"},"devDependencies":{"@babel/core":"^7.5.0","@babel/preset-env":"^7.5.0","@jupyterlab/builder":"^3.0.0","@phosphor/application":"^1.6.0","@phosphor/widgets":"^1.6.0","@types/jest":"^26.0.0","@types/webpack-env":"^1.13.6","@typescript-eslint/eslint-plugin":"^3.6.0","@typescript-eslint/parser":"^3.6.0","acorn":"^7.2.0","css-loader":"^3.2.0","eslint":"^7.4.0","eslint-config-prettier":"^6.11.0","eslint-plugin-prettier":"^3.1.4","fs-extra":"^7.0.0","identity-obj-proxy":"^3.0.0","jest":"^26.0.0","mkdirp":"^0.5.1","npm-run-all":"^4.1.3","prettier":"^2.0.5","rimraf":"^2.6.2","source-map-loader":"^1.1.3","style-loader":"^1.0.0","ts-jest":"^26.0.0","ts-loader":"^8.0.0","typescript":"~4.1.3","webpack":"^5.0.0","webpack-cli":"^4.0.0"},"jupyterlab":{"extension":"lib/plugin","outputDir":"ipypixano/labextension/","sharedPackages":{"@jupyter-widgets/base":{"bundled":false,"singleton":true}}}}');

/***/ })

}]);
//# sourceMappingURL=lib_widget_js.5d4f3e8a81f8cb44d1d2.js.map