...
def resolve_ref(ref_str, project, account_ctx=None, ref=None, resolve_from_outputs=False):
    ...
    if ref.type == "resource":
        ...
        ref_value = get_resolve_ref_obj(project, project, ref, part_idx_start=0, resolve_from_outputs=resolve_from_outputs)
        ...
        ref_value = get_resolve_ref_obj(project, obj, ref, 4, resolve_from_outputs)
