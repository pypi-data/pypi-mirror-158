...
class TDKLambdaPSU:
    ...
    def device_output_switch(self):
        """
        This function turns off the PSU output setting - 0|1, OFF|ON - Output state of the PSU
        """
        if self.psu.query(f'OUTP:STAT?') == '0':
            self.psu.query(f'OUTP:STAT 1')
            logging.info(f": PSU Output turned : ON")
        else:
            self.psu.query(f'OUTP:STAT 0')
    ...
    def check_min_max_programmable_volt(self):
        """
    ...
    def check_min_max_programmable_current(self):
        """
    ...
    def set_program_output_voltage(self, volt_in):
        ...
        try:
            ...
            logging.info(f"FAIL: to set Voltage : {e}")
    ...
    def set_program_output_current(self, curr_in):
        ...
        try:
            ...
            logging.info(f"FAIL: to set Current : {e}")
