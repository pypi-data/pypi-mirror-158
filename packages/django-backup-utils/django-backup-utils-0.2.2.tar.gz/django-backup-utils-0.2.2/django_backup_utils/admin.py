...
class BackupAdmin(admin.ModelAdmin):
    ...
    list_display = (
        "pk", "backup", "size_mb", "created_at", "dump_version", "consistent_migrations", "restore_link",
        "system_migrations_migrated",
        "dump_migration_files",)
    readonly_fields = (
    "backup", 'size_bytes', "created_at", "dump_version", "consistent_migrations", "system_migrations_migrated",
    "dump_migration_files", "params",)
