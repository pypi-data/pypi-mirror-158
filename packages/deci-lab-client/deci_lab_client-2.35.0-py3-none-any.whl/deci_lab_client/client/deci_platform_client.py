...
class DeciPlatformClient(PlatformApi):
    ...
    @staticmethod
    async def upload_file_to_s3(from_path: str, s3_signed_url: S3SignedUrl) -> Response:
    ...
    def save_experiment_file(self, file_path: str) -> bool:
        """
        ...
        async def task() -> bool:
            ...
            try:
                ...
                upload_response = await self.upload_file_to_s3(from_path=file_path, s3_signed_url=s3_target)
