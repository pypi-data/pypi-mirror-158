...
setup(
  name = 'pyweatherlib',         # How you named your package folder (MyLib)
  packages = ['pyweatherlib'],   # Chose the same as "name"
  version = '0.2.2',      # Start with a small number and increase it with every change you make
  license='MIT',        # Chose a license from here: https://help.github.com/articles/licensing-a-repository
  description = 'Library for getting weather data from Open Weather Map Website and Google Weather',   # Give a short description about your library
  ...
  download_url = 'https://github.com/roshaan55/pyweatherlib/archive/refs/tags/v0.2.2.tar.gz',    # I explain this later on
