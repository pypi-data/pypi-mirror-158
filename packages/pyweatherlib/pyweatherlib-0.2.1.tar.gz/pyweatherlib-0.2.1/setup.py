...
setup(
  ...
  description = 'Library for getting weather data from Open Weather Map Website',   # Give a short description about your library
  ...
  download_url = 'https://github.com/roshaan55/pyweatherlib/archive/refs/tags/v0.1.tar.gz',    # I explain this later on
