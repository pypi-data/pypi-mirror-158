...
class ConcatOp(_ods_ir.OpView):
  ...
  def __init__(self, out, ins, axis, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class Conv2dOp(_ods_ir.OpView):
  ...
  def __init__(self, result, input, weight, bias, padding, strides, dilations, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class SumOp(_ods_ir.OpView):
  ...
  def __init__(self, out, tensor, axes, keep_dims, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
