...
class PackageDeps(Base):
    ...
    UNIQUE_FIELDS = ('package_id', 'dependency_version_expression', 'dependency_package_id', 'package_name',
                     'package_type', 'package_version')
    ...
    def package_deps(self, deps: PackageDeps):
        try:
            for result in deps.requirement:
                ...
                deps_info = PackageInfo(result['dependency_package_name'], result['dependency_type'])
