...
['mlcvzoo_base',
 ...
 'mlcvzoo_base.data_preparation.cvat_annotation_handler',
 'mlcvzoo_base.data_preparation.data_classes',
 'mlcvzoo_base.data_preparation.data_classes.object_detection',
 ...
 'mlcvzoo_base.tools',
 'mlcvzoo_base.tools.configuration',
 'mlcvzoo_base.tools.logger',
 'mlcvzoo_base.utils']
...
extras_require = \
{':python_version == "3.8" and (platform_machine != "arm64" or platform_system != "Darwin") and platform_machine != "aarch64" and platform_python_implementation != "PyPy"': ['numpy>=1.17.3'],
 ':python_version == "3.8" and platform_machine == "aarch64"': ['numpy>=1.19.2,!=1.19.5']}

entry_points = \
{'console_scripts': ['mlcvzoo-preannotator = '
