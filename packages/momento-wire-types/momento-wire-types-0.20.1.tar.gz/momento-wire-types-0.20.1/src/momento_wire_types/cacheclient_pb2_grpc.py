...
class ScsStub(object):
    ...
    def __init__(self, channel):
        ...
        self.DictionaryGetAll = channel.unary_unary(
                '/cache_client.Scs/DictionaryGetAll',
                request_serializer=cacheclient__pb2._DictionaryGetAllRequest.SerializeToString,
                response_deserializer=cacheclient__pb2._DictionaryGetAllResponse.FromString,
                )
...
class ScsServicer(object):
    ...
    def DictionaryGetAll(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_ScsServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'DictionaryGetAll': grpc.unary_unary_rpc_method_handler(
                    servicer.DictionaryGetAll,
                    request_deserializer=cacheclient__pb2._DictionaryGetAllRequest.FromString,
                    response_serializer=cacheclient__pb2._DictionaryGetAllResponse.SerializeToString,
            ),
...
class Scs(object):
    ...
    def DictionaryGetAll(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/cache_client.Scs/DictionaryGetAll',
            cacheclient__pb2._DictionaryGetAllRequest.SerializeToString,
            cacheclient__pb2._DictionaryGetAllResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
