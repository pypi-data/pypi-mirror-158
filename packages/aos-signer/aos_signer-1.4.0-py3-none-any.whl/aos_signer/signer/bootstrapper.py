...
#    runParameters:
#        startInterval: '10s'   # indicates maximum time required by service to start
#        startBurst: 3          # indicates number of attempt to start
#        restartInterval: '1s'  # indicates in which time the service will be restarted after exit
    # Service working dir
