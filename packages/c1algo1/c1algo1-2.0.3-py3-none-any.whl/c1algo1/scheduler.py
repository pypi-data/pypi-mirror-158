...
def generate_schedule(professors, schedule):
    ...
    print("Scheduling ", len(fall_course_list), "courses for the fall semester")
    ...
    print("Scheduling ", len(spring_course_list), "courses for the spring semester")
    ...
    print("Scheduling ", len(summer_course_list), "courses for the summer semester")
    ...
    print(f'Generated schedule in {stop - start}s')
