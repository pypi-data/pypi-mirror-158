    ...
    while node.tag != "Root":
        ...
        for course in course_set:
            ...
            if not already_scheduled:
                ...
                schedule.append({"name": course.name, "semester": course.semester, "days": days, "start time": timeslots[node.data.depth%27], "end time": timeslots[node.data.depth%27], "season": course.season})
