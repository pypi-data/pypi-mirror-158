...
class Asset:
    ...
    def __init__(self,Rally,id=None,name=None,copy=True):
        ...
        if not id and not name:
            ...
            Rally.apiCall("PATCH","/userMetadata/{}".format(self.id),body={"data":{"attributes":{"metadata":{"testMode":True}},"type":"userMetadata"}})
        elif not copy:
            if not id:
                self.name = name
                try:
            ...
            try:
                ...
                metadataPayload["data"]["attributes"]["metadata"]["testMode"] = True
