...
class tUsrOtp(mettle.io.ISerializable, mettle.db.IPrimaryKey):
    ...
    otp_method: str = dataclasses.field(default='', compare=False)
    otp: str = dataclasses.field(default='', compare=False)
    expire: typing.Optional[datetime.datetime] = dataclasses.field(default=None, compare=False)
    used: bool = dataclasses.field(default=False, compare=False)
    target: str = dataclasses.field(default='', compare=False)
