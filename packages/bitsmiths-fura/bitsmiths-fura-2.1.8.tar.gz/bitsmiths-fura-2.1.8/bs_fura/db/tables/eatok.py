...
class tEatok(mettle.io.ISerializable, mettle.db.IPrimaryKey):
    ...
    tok: str = dataclasses.field(default='', compare=False)
    ...
    grant_usr_id: str = dataclasses.field(default='', compare=False)
    created: typing.Optional[datetime.datetime] = dataclasses.field(default=None, compare=False)
    expires: typing.Optional[datetime.datetime] = dataclasses.field(default=None, compare=False)
    max_usages: int = dataclasses.field(default=0, compare=False)
    usages: int = dataclasses.field(default=0, compare=False)
