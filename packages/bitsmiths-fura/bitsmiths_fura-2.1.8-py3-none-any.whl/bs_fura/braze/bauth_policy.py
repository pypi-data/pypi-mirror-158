# This file was generated by mettle.genes.braze.GenPy3 [ver 2.1] on Thu Jul  7 10:29:16 2022
#
...
class bAuthPolicy(ISerializable):
    ...
    descr: str = dataclasses.field(default='')
    regex: str = dataclasses.field(default='')
