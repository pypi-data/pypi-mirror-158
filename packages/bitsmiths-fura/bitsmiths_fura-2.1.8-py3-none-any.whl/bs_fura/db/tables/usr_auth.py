...
class tUsrAuth(mettle.io.ISerializable, mettle.db.IPrimaryKey):
    ...
    auth_type: str = dataclasses.field(default='', compare=True, hash=True)
    auth_data: str = dataclasses.field(default='', compare=False)
    fail_cnt: int = dataclasses.field(default=0, compare=False)
    salt: str = dataclasses.field(default='', compare=False)
    last_ip: str = dataclasses.field(default='', compare=False)
    last_geo: str = dataclasses.field(default='', compare=False)
    last_succ: typing.Optional[datetime.datetime] = dataclasses.field(default=None, compare=False)
    last_fail: typing.Optional[datetime.datetime] = dataclasses.field(default=None, compare=False)
