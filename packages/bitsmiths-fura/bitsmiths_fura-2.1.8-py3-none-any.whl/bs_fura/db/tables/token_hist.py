...
class tTokenHist(mettle.io.ISerializable):
    ...
    date_created: typing.Optional[datetime.datetime] = dataclasses.field(default=None, compare=False)
    expires: typing.Optional[datetime.datetime] = dataclasses.field(default=None, compare=False)
    use_cnt: int = dataclasses.field(default=0, compare=False)
    aud_id: str = dataclasses.field(default='', compare=False)
