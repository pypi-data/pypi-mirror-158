...
def popf(obj: MutableMapping, key, fallback: Callable[[], Any]):
    """Deletes obj[key] and returns the value.
...
def biset(obj: MutableMapping, key, value) -> obj:
    """Sets obj[key] to value and also obj[value] to key, returns obj.
...
def delz(obj: MutableMapping, key, keyerror: bool = True) -> obj:
    """Removes the key from the obj, returns the obj. If keyerror is False,
    missing key is ignored, otherwise KeyError is raised.
...
def delsz(obj: MutableMapping,
    ...
    Example:
        ...
        ...
        KeyError: 'baz'
        >>> delsz(d, ['baz'], keyerror=False)
        {'bar': 2}
    """
    for key in keys:
        delz(obj, key, keyerror)
    return obj
