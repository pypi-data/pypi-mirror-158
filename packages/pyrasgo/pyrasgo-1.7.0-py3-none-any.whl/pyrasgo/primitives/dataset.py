...
class Dataset(Connection):
    ...
    def _get_offline_sql(self) -> str:
        """
        Render the sql this offline dataset would produce
        """
        from pyrasgo.api.create import Create
        ...
        return polling.poll_operation_set_offline_async_status(task)
