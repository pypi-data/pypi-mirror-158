...
class Job:
	...
	def default_callback_url(self, value: Optional[str]) -> None:
		'''
	...
	@property
	def print_add_record_calls(self) -> bool:
	...
	def print_add_record_calls(self, value: bool) -> None:
		'''
	...
	def add_record(self, key: str, message: str, callback_url: Union[Callable, Optional[str]]=None, callback_headers: Optional[dict]=None) -> None:
