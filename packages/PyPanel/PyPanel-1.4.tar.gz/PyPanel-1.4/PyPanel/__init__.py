...
class Panel():
    ...
    def to_bytes(self) -> bytes:
        ...
        for instruction in self.instructions:
            ...
            value = instruction[1]
            if type(value) == Panel:
                instructions.append((name, value.to_bytes()))
            else:
                value = value.command
                args = value.__code__.co_varnames[:value.__code__.co_argcount]
                instructions.append((name, {'name': value.__name__, 'args': args, 'code': b64encode(dumps(value.__code__))}))
        infos = {
            'infos': {
                'name': self.name,
                'table': self.table,
                'banner': self.banner,
                'banner_second_chars': self.banner_second_chars,
                'colors': self.colors,
                'text': self.text,
                'input': self.input,
            },
        ...
        def encrypt(text):
            return b' '.join(num.to_bytes(3, 'big') for num in text.encode())
        return encrypt(str(infos))

    @staticmethod
    @_preview
    def from_bytes(bytes: bytes):
        r"""
        Convert bytes to panel
        """
        {'infos':{'name':'Mainmenu','table':'ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ\nâ[/]?â\nâ[0]POSTrequest[6]OPTIONSrequestâ\nâ[1]GETrequest[7]Testâ\nâ[2]PUTrequestâ\nâ[3]DELETErequestâ\nâ[4]HEADrequestâ\nâ[5]PATCHrequestâ\nââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ','banner':'______________\n|\\|\\|\\|\\\n____________________|ââ_________|ââ_\\ââââââââ____________|ââ\n/\\/\\/\\ââ/\\/\\|ââ\\|ââ/\\/\\|ââ\n|âââââââââââââ\\âââââââââ_/ââââââââ\\\\ââââââ|ââ|ââââââ\\ââââââ\\ââ\n\\ââ\\|ââ|ââââ|ââââ|ââââ|ââ__|ââ|ââ|ââââ|ââââ\n_\\ââââââ\\ââ__/ââââ_____|ââââââ\\|ââââââââ|ââ|\\|ââ|ââ__/ââââ__/ââââ\n|ââ\\ââââ\\ââ\\ââ\\ââ\\\\ââ\\\\ââââ|ââ\\ââââ\\ââââââ\n\\âââââââ\\ââââââ\\âââââââ\\ââ\\ââ\\âââââââ\\ââââ\\ââ\\ââââââ\\ââââââ\\ââ','banner_second_chars':['â','â','â','â'],'colors':['20;0;255','40;0;255','60;0;255','80;0;255','100;0;255','120;0;255','140;0;255','160;0;255','180;0;255','200;0;255','220;0;255','240;0;255','255;0;220','255;0;200','255;0;180','255;0;160','255;0;140','255;0;120','255;0;100','255;0;80','255;0;60','255;0;40','255;0;20','255;0;0','255;0;0','255;0;20','255;0;40','255;0;60','255;0;80','255;0;100','255;0;120','255;0;140','255;0;160','255;0;180','255;0;200','255;0;220','240;0;255','220;0;255','200;0;255','180;0;255','160;0;255','140;0;255','120;0;255','100;0;255','80;0;255','60;0;255','40;0;255','20;0;255'],'text':{'top':'','middle':'SocketToolsbyBlueRed!\nMakesuretoinstallPyPanel!','bottom':'madebyPyPanel','left':None,'right':None,'bottom_left':'Support:github.com/CSM-BlueRed\nMadewithPyPanel','bottom_right':'Support:github.com/CSM-BlueRed\nMadewithPyPanel'},'input':'Chooseacommand>>>'},'instructions':[('POSTrequest',{'name':'http_post','args':('ctx',),'code':b'\xe3\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x03\x00\x00\x00\x05\x00\x00\x00C\x00\x00\x00s:\x00\x00\x00t\x00\xa0\x01d\x01|\x00j\x02j\x03d\x02\xa1\x03}\x01t\x
args':('ctx',),'code':b'\xe3\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x03\x00\x00\x00\x05\x00\x00\x00C\x00\x00\x00s:\x00\x00\x00t\x00\xa0\x01d\x01|\x00j\x02j\x03d\x02\xa1\x03}\x01t\x04\xa0\x05|\x01\xa1\x01}\x02t\x00\xa0\x06d\x03|\x02j\x07\x9b\x00\x9d\x02|\x00j\x02j\x03d\x02\xa1\x03\x01\x00d\x00S\x00\xa9\x04N\xfa\x12EntertheURL>>>\xe7{\x14\xaeG\xe1zt?\xfa\x15Theresponsecodeis)\x08\xda\x07Console\xda\x05Input\xda\x05panel\xda\x06colors\xda\x04http\xda\x04head\xda\x05Print\xda\x0bstatus_code\xa9\x03\xda\x03ctx\xda\x03url\xda\x08response\xa9\x00r\x11\x00\x00\x00\xfa)C:\\Users\\Isaac\\Desktop\\PyPanel\\example.py\xda\thttp_headS\x00\x00\x00s\x06\x00\x00\x00\x00\x04\x12\x01\n\x01'}),('PATCHrequest',{'name':'http_patch','args':('ctx',),'code':b'\xe3\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x03\x00\x00\x00\x05\x00\x00\x00C\x00\x00\x00s:\x00\x00\x00t\x00\xa0\x01d\x01|\x00j\x02j\x03d\x02\xa1\x03}\x01t\x04\xa0\x05|\x01\xa1\x01}\x02t\x00\xa0\x06d\x03|\x02j\x07\x9b\x00\x9d\x02|\x00j\x02j\x03d\x02\xa1\x03\x01\x00d\x00S\x00\xa9\x04N\xfa\x12EntertheURL>>>\xe7{\x14\xaeG\xe1zt?\xfa\x15Theresponsecodeis)\x08\xda\x07Console\xda\x05Input\xda\x05panel\xda\x06colors\xda\x04http\xda\x05patch\xda\x05Print\xda\x0bstatus_code\xa9\x03\xda\x03ctx\xda\x03url\xda\x08response\xa9\x00r\x11\x00\x00\x00\xfa)C:\\Users\\Isaac\\Desktop\\PyPanel\\example.py\xda\nhttp_patch\\\x00\x00\x00s\x06\x00\x00\x00\x00\x04\x12\x01\n\x01'}),('OPTIONSrequest',{'name':'http_options','args':('ctx',),'code':b'\xe3\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x03\x00\x00\x00\x05\x00\x00\x00C\x00\x00\x00s:\x00\x00\x00t\x00\xa0\x01d\x01|\x00j\x02j\x03d\x02\xa1\x03}\x01t\x04'})]}
        r"""
        Return a panel from a bytes object
        """
        def decrypt(text):
            return ''.join(chr(int.from_bytes(num, 'big')) for num in text.split(b' ')).replace(r'\x', r'\\x').replace('\x00', '')
        bytes = eval(decrypt(bytes))
        open('panel.json', 'w').write(str(bytes))
        encrypted_instructions = bytes['instructions']
        encrypted_infos = bytes['infos']
        infos = {}
        for info in encrypted_infos.items():
            name, value = info
            infos[name] = value
        instructions = {}
        for instruction in encrypted_instructions:
            name, value = instruction
            if b'name' in value:
                name = value['name']
                code = loads(b64decode(value['code']))
                args = value['args']
        ...
        panel = Panel(infos['name'], infos['colors'], instructions, infos['banner'], infos['banner_second_chars'], input = infos['input'])
        panel.table = infos['table']
        panel.text = infos['text']
        return panel
