...
class RESTClient(RESTAssertion):
    ...
    def __init__(self,
        ...
        self.logger = logger('RESTClient', enabled=logger_enabled, level=logger_level)
    ...
    def requested_url(self, url) -> str:
        ...
        try:
            ...
            err_msg = f'URL does not specified. Used: "{url}" only. Specify full URL or use constructor'
    ...
    def encode_to_base64(string: str) -> str:
        ...
        try:
            ...
            print(f'Cannot encode specific data ({string}, {type(string)})', file=sys.stderr)
            raise err
