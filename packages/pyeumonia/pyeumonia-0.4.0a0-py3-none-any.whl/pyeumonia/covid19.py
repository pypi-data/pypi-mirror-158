...
class Covid19:
    ...
    def danger_areas_data(self, include_cities=True, include_counts=True, include_danger_areas=True, auto=False):
        """
        ...
        :param auto: If you want to get danger areas from your city, please set the parameter to True.
