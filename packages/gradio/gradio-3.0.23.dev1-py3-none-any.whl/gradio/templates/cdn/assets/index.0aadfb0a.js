import { S as SvelteComponent, i as init, s as safe_not_equal, f as element, b as attr, t as toggle_class, c as insert, a2 as set_input_value, l as listen, e as detach, r as run_all, m as space, n as noop, F as bubble, D as binding_callbacks, h as text, j as set_data, k as empty, a4 as HtmlTag, d as append, J as bind, q as create_component, u as mount_component, G as add_flush_callback, v as transition_in, w as transition_out, x as destroy_component, A as createEventDispatcher, a5 as tick, a as svg_element, y as group_outros, a6 as update_keyed_each, a7 as outro_and_destroy_block, z as check_outros, L as assign, M as StatusTracker, N as get_spread_update, O as get_spread_object } from './index.50dc598e.js';
import { g as get_styles } from './styles.db46e346.js';
import { U as Upload } from './Upload.386b3a18.js';
...
// (412:6) {#each _headers as { value, id }
...
// (393:2) <Upload    flex={false}    center={false}    boundedheight={false}    click={false}    on:load={(e) => blob_to_string(data_uri_to_blob(e.detail.data))}    bind:dragging   >
...
function instance$1($$self, $$props, $$invalidate) {
	...
	function add_row(index) {
		...
		(($$invalidate(9, data), $$invalidate(27, values)), $$invalidate(31, old_val));
	}
	...
	async function add_col() {
		...
		(($$invalidate(9, data), $$invalidate(27, values)), $$invalidate(31, old_val));
		(($$invalidate(8, _headers), $$invalidate(28, headers)), $$invalidate(30, old_headers));
		await tick();
	...
	$$self.$$set = $$props => {
		...
		if ('headers' in $$props) $$invalidate(28, headers = $$props.headers);
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty[0] & /*headers, old_headers*/ 1342177280) {
			{
		...
		if ($$self.$$.dirty[0] & /*values*/ 134217728 | $$self.$$.dirty[1] & /*old_val*/ 1) {
...
function create_fragment(ctx) {
	...
	table.$on("change", /*handle_change*/ ctx[13]);
