...
from bson303.py3compat import b, string_type, _unicode, PY3
from bson303.son import SON
from pymongo303.errors import ConfigurationError, OperationFailure
...
def _authenticate_gssapi(credentials, sock_info):
    ...
    try:
        ...
        try:
            ...
            # have to use bson303.binary.Binary.
