...
from bson303.py3compat import u
from bson303.son import SON
from pymongo303.common import (validate_is_mapping,
                            validate_is_mutable_mapping,
                            validate_ok_for_replace,
                            validate_ok_for_update)
from pymongo303.errors import (BulkWriteError,
                            DocumentTooLarge,
                            InvalidOperation,
                            OperationFailure)
...
class BulkOperationBuilder(object):
    ...
    def __init__(self, collection, ordered=True):
        ...
        :Parameters:
          - `collection`: A :class:`~pymongo303.collection.Collection` instance.
