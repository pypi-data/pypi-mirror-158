...
from pymongo303.helpers import _gen_index_name, _index_document, _index_list
...
class DeleteOne(_WriteOp):
    ...
    def __init__(self, filter):
        ...
        For use with :meth:`~pymongo303.collection.Collection.bulk_write`.
...
class IndexModel(object):
    ...
    def __init__(self, keys, **kwargs):
        ...
        For use with :meth:`~pymongo303.collection.Collection.create_indexes`.
