...
"""Functions and classes common to multiple pymongo303 modules."""

import collections

from bson303.binary import (STANDARD, PYTHON_LEGACY,
                         JAVA_LEGACY, CSHARP_LEGACY)
from bson303.codec_options import CodecOptions
from bson303.py3compat import string_type, integer_types
from pymongo303.auth import MECHANISMS
from pymongo303.errors import ConfigurationError
from pymongo303.read_preferences import (read_pref_mode_from_name,
                                      _ServerMode)
from pymongo303.ssl_support import validate_cert_reqs
...
def validate_document_class(option, value):
    ...
    if not issubclass(value, collections.MutableMapping):
        raise TypeError("%s must be dict, bson303.son.SON, or another "
...
def validate_is_mapping(option, value):
    ...
    if not isinstance(value, collections.Mapping):
        raise TypeError("%s must be an instance of dict, bson303.son.SON, or "
...
class BaseObject(object):
    ...
    to multiple pymongo303 classes.
    ...
    def __init__(self, codec_options, read_preference, write_concern):
        ...
        if not isinstance(codec_options, CodecOptions):
            raise TypeError("codec_options must be an instance of "
                            "bson303.codec_options.CodecOptions")
    ...
    def codec_options(self):
        """Read only access to the :class:`~bson303.codec_options.CodecOptions`
        of this instance.
        """
    ...
    def write_concern(self):
        """Read only access to the :class:`~pymongo303.write_concern.WriteConcern`
        of this instance.
