...
from bson303 import RE_TYPE
from bson303.code import Code
from bson303.py3compat import (iteritems,
                            integer_types,
                            string_type)
from bson303.son import SON
from pymongo303 import helpers
from pymongo303.common import validate_boolean, validate_is_mapping
from pymongo303.errors import (AutoReconnect,
                            ConnectionFailure,
                            InvalidOperation,
                            NotMasterError,
                            OperationFailure)
from pymongo303.message import _GetMore, _Query
...
class Cursor(object):
    ...
    def __init__(self, collection, filter=None, projection=None, skip=0,
        ...
        :meth:`~pymongo303.collection.Collection.find` instead.
    ...
    @property
    def collection(self):
        """The :class:`~pymongo303.collection.Collection` that this
    ...
    def limit(self, limit):
        ...
        :exc:`~pymongo303.errors.InvalidOperation` if this :class:`Cursor`
    ...
    def batch_size(self, batch_size):
        ...
        Raises :exc:`~pymongo303.errors.InvalidOperation` if this
    ...
    def skip(self, skip):
        ...
        :exc:`~pymongo303.errors.InvalidOperation` if this :class:`Cursor` has
    ...
    def max_time_ms(self, max_time_ms):
        ...
        :exc:`~pymongo303.errors.ExecutionTimeout` is raised. If `max_time_ms`
        is ``None`` no limit is applied.

        Raises :exc:`TypeError` if `max_time_ms` is not an integer or ``None``.
        Raises :exc:`~pymongo303.errors.InvalidOperation` if this :class:`Cursor`
    ...
    def __getitem__(self, index):
        ...
        Raises :class:`~pymongo303.errors.InvalidOperation` if this
    ...
    def sort(self, key_or_list, direction=None):
        ...
        :data:`~pymongo303.ASCENDING` or :data:`~pymongo303.DESCENDING`::

            for doc in collection.find().sort('field', pymongo303.ASCENDING):
                print(doc)

        To sort by multiple fields, pass a list of (key, direction) pairs::

            for doc in collection.find().sort([
                    ('field1', pymongo303.ASCENDING),
                    ('field2', pymongo303.DESCENDING)]):
                print(doc)
        ...
        Raises :class:`~pymongo303.errors.InvalidOperation` if this cursor has
        ...
        :Parameters:
          ...
          - `direction` (optional): only used if `key_or_list` is a single
            key, if not given :data:`~pymongo303.ASCENDING` is assumed
        """
        self.__check_okay_to_chain()
    ...
    def count(self, with_limit_and_skip=False):
        ...
        Raises :class:`~pymongo303.errors.OperationFailure` on a database error.
        ...
        :attr:`~pymongo303.collection.Collection.read_preference` of the
        :class:`~pymongo303.collection.Collection` instance on which
        :meth:`~pymongo303.collection.Collection.find` was called.
    ...
    def distinct(self, key):
        ...
        .. seealso:: :meth:`pymongo303.collection.Collection.distinct`
        """
        options = {}
        if self.__spec:
    ...
    def hint(self, index):
        ...
        :class:`~pymongo303.errors.InvalidOperation` if this cursor has
        already been used.

        `index` should be an index as passed to
        :meth:`~pymongo303.collection.Collection.create_index`
    ...
    def where(self, code):
        ...
        (:class:`str` in python 3) or :class:`~bson303.code.Code`
        ...
        :class:`~pymongo303.errors.InvalidOperation` if this
    ...
    def cursor_id(self):
        ...
        :meth:`~pymongo303.mongo_client.MongoClient.kill_cursors`
