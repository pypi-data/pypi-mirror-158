...
from bson303.errors import *

try:
    from ssl import CertificateError
except ImportError:
    from pymongo303.ssl_match_hostname import CertificateError
...
class AutoReconnect(ConnectionFailure):
    ...
    Subclass of :exc:`~pymongo303.errors.ConnectionFailure`.
    """
...
class NetworkTimeout(AutoReconnect):
    ...
    Subclass of :exc:`~pymongo303.errors.AutoReconnect`.
    """
