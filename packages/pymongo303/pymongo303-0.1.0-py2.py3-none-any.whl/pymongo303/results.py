...
from pymongo303.errors import InvalidOperation
...
class _WriteResult(object):
    ...
    def acknowledged(self):
        ...
        .. note::
          ...
          :class:`~pymongo303.errors.InvalidOperation` when accessed. Values for
          other attributes cannot be determined if the write operation was
          unacknowledged.

        .. seealso::
          :class:`~pymongo303.write_concern.WriteConcern`
        """
        return self.__acknowledged


class InsertOneResult(_WriteResult):
    """The return type for :meth:`~pymongo303.collection.Collection.insert_one`.
    """
...
class InsertManyResult(_WriteResult):
    """The return type for :meth:`~pymongo303.collection.Collection.insert_many`.
    """
    ...
    def inserted_ids(self):
        ...
        .. note:: If ``False`` is passed for the `ordered` parameter to
          :meth:`~pymongo303.collection.Collection.insert_many` the server
...
class UpdateResult(_WriteResult):
    """The return type for :meth:`~pymongo303.collection.Collection.update_one`,
    :meth:`~pymongo303.collection.Collection.update_many`, and
    :meth:`~pymongo303.collection.Collection.replace_one`.
    """
...
class DeleteResult(_WriteResult):
    """The return type for :meth:`~pymongo303.collection.Collection.delete_one`
    and :meth:`~pymongo303.collection.Collection.delete_many`"""
    ...
    def __init__(self, bulk_api_result, acknowledged):
        ...
        :Parameters:
          ...
          - `acknowledged`: Was this write result acknowledged? If ``False``
            ...
            :exc:`~pymongo303.errors.InvalidOperation`.
        """
