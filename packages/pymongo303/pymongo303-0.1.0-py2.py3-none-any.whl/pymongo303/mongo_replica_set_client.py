...
from pymongo303 import mongo_client


class MongoReplicaSetClient(mongo_client.MongoClient):
    """Deprecated alias for :class:`~pymongo303.mongo_client.MongoClient`.

    :class:`~pymongo303.mongo_replica_set_client.MongoReplicaSetClient`
    ...
    .. versionchanged:: 3.0
       ...
       :class:`~pymongo303.mongo_replica_set_client.MongoReplicaSetClient`: it
