...
To get a :class:`~pymongo303.database.Database` instance from a
:class:`MongoClient` use either dictionary-style or attribute-style
access:

.. doctest::

  >>> from pymongo303 import MongoClient
  >>> c = MongoClient()
  >>> c.test_database
...
from bson303.py3compat import (integer_types,
                            string_type)
from pymongo303 import (common,
                     ...
                     periodic_executor,
                     uri_parser)
from pymongo303.client_options import ClientOptions
from pymongo303.cursor_manager import CursorManager
from pymongo303.errors import (AutoReconnect,
                            ConfigurationError,
                            ConnectionFailure,
                            InvalidOperation,
                            InvalidURI,
...
from pymongo303.server_selectors import (writable_preferred_server_selector,
                                      writable_server_selector)
from pymongo303.server_type import SERVER_TYPE
from pymongo303.topology import Topology
from pymongo303.topology_description import TOPOLOGY_TYPE
from pymongo303.settings import TopologySettings
...
class MongoClient(common.BaseObject):
    ...
    def __init__(
        ...
        :class:`~pymongo303.errors.ConnectionFailure` is raised and the client
        ...
        :Parameters:
          ...
          - `read_preference`: The read preference for this client. If
            ...
            *other* than PRIMARY is required - otherwise all queries will throw
            :class:`~pymongo303.errors.AutoReconnect` "not master".
            See :class:`~pymongo303.read_preferences.ReadPreference` for all
        ...
        .. versionchanged:: 3.0
           :class:`~pymongo303.mongo_client.MongoClient` is now the one and only
           client class for a standalone server, mongos, or replica set.
           It includes the functionality that had been split into
           :class:`~pymongo303.mongo_client.MongoReplicaSetClient`: it can connect
           to a replica set, discover all its members, and monitor the set for
           stepdowns, elections, and reconfigs.

           The :class:`~pymongo303.mongo_client.MongoClient` constructor no
           longer blocks while connecting to the server or servers, and it no
           longer raises :class:`~pymongo303.errors.ConnectionFailure` if they
           are unavailable, nor :class:`~pymongo303.errors.ConfigurationError`
           ...
           In PyMongo 2.x, :class:`~pymongo303.MongoClient` accepted a list of
           ...
           synonym for :meth:`~pymongo303.MongoClient.close`.

           :class:`~pymongo303.mongo_client.MongoClient` no longer returns an
           instance of :class:`~pymongo303.database.Database` for attribute names
    ...
    def max_pool_size(self):
        ...
        a blocked operation will raise :exc:`~pymongo303.errors.ConnectionFailure`
    ...
    def set_cursor_manager(self, manager_class):
        ...
        :class:`~pymongo303.cursor_manager.CursorManager`. A cursor manager
    ...
    def _get_topology(self):
        """Get the internal :class:`~pymongo303.topology.Topology` object.
    ...
    def __getattr__(self, name):
        ...
        Raises :class:`~pymongo303.errors.InvalidName` if an invalid
    ...
    def kill_cursors(self, cursor_ids, address=None):
        ...
        This method may be called from a :class:`~pymongo303.cursor.Cursor`
    ...
    def drop_database(self, name_or_database):
        ...
        :class:`~pymongo303.database.Database`.

        :Parameters:
          - `name_or_database`: the name of a database to drop, or a
            :class:`~pymongo303.database.Database` instance representing the
            database to drop
        """
    ...
    def get_database(self, name, codec_options=None,
        ...
        """Get a :class:`~pymongo303.database.Database` with the given name and
        options.

        Useful for creating a :class:`~pymongo303.database.Database` with
        ...
        :Parameters:
          ...
          - `read_preference` (optional): The read preference to use. If
            ...
            :class:`MongoClient` is used. See :mod:`~pymongo303.read_preferences`
            for options.
