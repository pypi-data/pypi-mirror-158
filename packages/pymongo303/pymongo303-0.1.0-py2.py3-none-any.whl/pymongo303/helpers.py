...
import collections
import struct
from pymongo303.message import _Query

import bson303
import pymongo303
from bson303.codec_options import CodecOptions
from bson303.py3compat import itervalues, string_type, iteritems, u
from bson303.son import SON
from pymongo303.errors import (CursorNotFound,
                            DuplicateKeyError,
                            ExecutionTimeout,
                            NotMasterError,
                            OperationFailure,
...
def _index_list(key_or_list, direction=None):
    ...
    if direction is not None:
        ...
        if isinstance(key_or_list, string_type):
            return [(key_or_list, pymongo303.ASCENDING)]
...
def _unpack_response(response, cursor_id=None, codec_options=CodecOptions()):
    ...
    if response_flag & 1:
        ...
        error_object = bson303.BSON(response[20:]).decode()
    ...
    result["data"] = bson303.decode_all(response[20:], codec_options)
