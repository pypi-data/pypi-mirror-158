...
from bson303.codec_options import _parse_codec_options
from bson303.py3compat import iteritems
from pymongo303.auth import _build_credentials_tuple
from pymongo303.common import validate, validate_boolean
from pymongo303 import common
from pymongo303.errors import ConfigurationError
from pymongo303.pool import PoolOptions
from pymongo303.read_preferences import make_read_preference
from pymongo303.ssl_support import get_ssl_context
...
class ClientOptions(object):
    ...
    def codec_options(self):
        """A :class:`~bson303.codec_options.CodecOptions` instance."""
        return self.__codec_options

    @property
    def credentials(self):
        """A :class:`~pymongo303.auth.MongoCredentials` instance or None."""
    ...
    def pool_options(self):
        """A :class:`~pymongo303.pool.PoolOptions` instance."""
    ...
    def write_concern(self):
        """A :class:`~pymongo303.write_concern.WriteConcern` instance."""
