...
from bson303.dbref import DBRef
from bson303.objectid import ObjectId
from bson303.py3compat import iteritems, string_type, _unicode
from bson303.son import SON
from pymongo303 import auth, common
from pymongo303.collection import Collection
from pymongo303.command_cursor import CommandCursor
from pymongo303.errors import (CollectionInvalid,
                            ConfigurationError,
                            InvalidName,
                            OperationFailure)
from pymongo303.helpers import _first_batch
from pymongo303.read_preferences import ReadPreference
from pymongo303.son_manipulator import SONManipulator
...
class Database(common.BaseObject):
    ...
    def __init__(self, client, name, codec_options=None,
        ...
        :Parameters:
          - `client`: A :class:`~pymongo303.mongo_client.MongoClient` instance.
        ...
        .. versionchanged:: 3.0
           ...
           :class:`~pymongo303.database.Database` no longer returns an instance
           of :class:`~pymongo303.collection.Collection` for attribute names
    ...
    def get_collection(self, name, codec_options=None,
                       read_preference=None, write_concern=None):
        """Get a :class:`~pymongo303.collection.Collection` with the given name
        and options.

        Useful for creating a :class:`~pymongo303.collection.Collection` with
        ...
        :Parameters:
          ...
          - `read_preference` (optional): The read preference to use. If
            ...
            :class:`Database` is used. See :mod:`~pymongo303.read_preferences`
            for options.
          - `write_concern` (optional): An instance of
            :class:`~pymongo303.write_concern.WriteConcern`. If ``None`` (the
    ...
    def create_collection(self, name, codec_options=None,
        ...
        """Create a new :class:`~pymongo303.collection.Collection` in this
        database.

        Normally collection creation is automatic. This method should
        only be used to specify options on
        creation. :class:`~pymongo303.errors.CollectionInvalid` will be
    ...
    def command(self, command, value=1, check=True,
        ...
        :Parameters:
          - `command`: document representing the command to be issued,
            ...
            .. note:: the order of keys in the `command` document is
               ...
               should use an instance of :class:`~bson303.son.SON` or
               a string and kwargs instead of a Python `dict`.

          - `value` (optional): value to use for the command verb when
            `command` is passed as a string
          - `check` (optional): check the response for errors, raising
            :class:`~pymongo303.errors.OperationFailure` if there are any
          - `allowable_errors`: if `check` is ``True``, error messages
            in this list will be ignored by error-checking
          - `read_preference`: The read preference for this operation.
            See :mod:`~pymongo303.read_preferences` for options.
          - `codec_options`: A :class:`~bson303.codec_options.CodecOptions`
            instance.
          - `**kwargs` (optional): additional keyword arguments will
        ...
        .. versionchanged:: 3.0
           ...
           regular expressions as :class:`~bson303.regex.Regex` objects. Use
           :meth:`~bson303.regex.Regex.try_compile` to attempt to convert from a
    ...
    def profiling_level(self):
        ...
        Returns one of (:data:`~pymongo303.OFF`,
        :data:`~pymongo303.SLOW_ONLY`, :data:`~pymongo303.ALL`).
    ...
    def set_profiling_level(self, level, slow_ms=None):
        ...
        | Level                      | Setting                            |
        +============================+====================================+
        | :data:`~pymongo303.OFF`       | Off. No profiling.                 |
        +----------------------------+------------------------------------+
        | :data:`~pymongo303.SLOW_ONLY` | On. Only includes slow operations. |
        +----------------------------+------------------------------------+
        | :data:`~pymongo303.ALL`       | On. Includes all operations.       |
        +----------------------------+------------------------------------+

        Raises :class:`ValueError` if level is not one of
        (:data:`~pymongo303.OFF`, :data:`~pymongo303.SLOW_ONLY`,
        :data:`~pymongo303.ALL`).
    ...
    def authenticate(self, name, password=None,
        ...
        :Parameters:
          ...
          - `mechanism` (optional): See
            :data:`~pymongo303.auth.MECHANISMS` for options.
        ...
        .. versionchanged:: 2.5
           ...
           now raises a subclass of :class:`~pymongo303.errors.PyMongoError` if
    ...
    def dereference(self, dbref, **kwargs):
        """Dereference a :class:`~bson303.dbref.DBRef`, getting the
        document it points to.

        Raises :class:`TypeError` if `dbref` is not an instance of
        :class:`~bson303.dbref.DBRef`. Returns a document, or ``None`` if
        ...
        :Parameters:
          ...
          - `**kwargs` (optional): any additional keyword arguments
            ...
            :meth:`~pymongo303.collection.Collection.find`.
        """
    ...
    def eval(self, code, *args):
        ...
        Raises :class:`~pymongo303.errors.OperationFailure` if the eval
