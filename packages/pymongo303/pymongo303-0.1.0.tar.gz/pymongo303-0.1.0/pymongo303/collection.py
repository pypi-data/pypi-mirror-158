...
from bson303.code import Code
from bson303.objectid import ObjectId
from bson303.py3compat import (_unicode,
                            integer_types,
                            string_type,
                            u)
from bson303.codec_options import CodecOptions
from bson303.son import SON
from pymongo303 import (common,
                     helpers,
                     message)
from pymongo303.bulk import BulkOperationBuilder, _Bulk
from pymongo303.command_cursor import CommandCursor
from pymongo303.cursor import Cursor
from pymongo303.errors import ConfigurationError, InvalidName, OperationFailure
from pymongo303.helpers import _check_write_command_response
from pymongo303.message import _INSERT, _UPDATE, _DELETE
from pymongo303.operations import _WriteOp, IndexModel
from pymongo303.read_preferences import ReadPreference
from pymongo303.results import (BulkWriteResult,
                             DeleteResult,
                             InsertOneResult,
                             InsertManyResult,
                             UpdateResult)
from pymongo303.write_concern import WriteConcern
...
class ReturnDocument(object):
    """An enum used with
    :meth:`~pymongo303.collection.Collection.find_one_and_replace` and
    :meth:`~pymongo303.collection.Collection.find_one_and_update`.
    """
    BEFORE = False
...
class Collection(common.BaseObject):
    ...
    def __init__(self, database, name, create=False, codec_options=None,
        ...
        :class:`~pymongo303.errors.InvalidName` if `name` is not a valid
        collection name. Any additional keyword arguments will be used
        as options passed to the create command. See
        :meth:`~pymongo303.database.Database.create_collection` for valid
        options.
        ...
        :Parameters:
          ...
          - `codec_options` (optional): An instance of
            :class:`~bson303.codec_options.CodecOptions`. If ``None`` (the
            default) database.codec_options is used.
          - `read_preference` (optional): The read preference to use. If
            ``None`` (the default) database.read_preference is used.
          - `write_concern` (optional): An instance of
            :class:`~pymongo303.write_concern.WriteConcern`. If ``None`` (the
        ...
        .. versionchanged:: 3.0
           ...
           :class:`~pymongo303.collection.Collection` no longer returns an
           instance of :class:`~pymongo303.collection.Collection` for attribute
    ...
    def _command(self, sock_info, command, slave_ok=False,
        ...
        :Parameters:
          ...
          - `codec_options` (optional) - An instance of
            :class:`~bson303.codec_options.CodecOptions`.
    ...
    @property
    def database(self):
        """The :class:`~pymongo303.database.Database` that this
    ...
    def with_options(
        ...
        """Get a clone of this collection changing the specified settings.
          ...
          Primary()
          >>> from pymongo303 import ReadPreference
        ...
        :Parameters:
          ...
          - `read_preference` (optional): The read preference to use. If
            ...
            :class:`Collection` is used. See :mod:`~pymongo303.read_preferences`
            for options.
          - `write_concern` (optional): An instance of
            :class:`~pymongo303.write_concern.WriteConcern`. If ``None`` (the
    ...
    def initialize_unordered_bulk_op(self):
        ...
        Returns a :class:`~pymongo303.bulk.BulkOperationBuilder` instance.
    ...
    def bulk_write(self, requests, ordered=True):
        ...
        :class:`~pymongo303.operations.InsertOne`,
        :class:`~pymongo303.operations.UpdateOne`,
        :class:`~pymongo303.operations.UpdateMany`,
        :class:`~pymongo303.operations.ReplaceOne`,
        :class:`~pymongo303.operations.DeleteOne`, or
        :class:`~pymongo303.operations.DeleteMany`).
          ...
          ...
          >>> from pymongo303 import InsertOne, DeleteOne, ReplaceOne
        ...
        :Returns:
          An instance of :class:`~pymongo303.results.BulkWriteResult`.
    ...
    def insert_one(self, document):
        ...
        :Returns:
          - An instance of :class:`~pymongo303.results.InsertOneResult`.
    ...
    def insert_many(self, documents, ordered=True):
        ...
        :Returns:
          An instance of :class:`~pymongo303.results.InsertManyResult`.
    ...
    def replace_one(self, filter, replacement, upsert=False):
        ...
        :Returns:
          - An instance of :class:`~pymongo303.results.UpdateResult`.
    ...
    def drop(self):
        """Alias for :meth:`~pymongo303.database.Database.drop_collection`.
    ...
    def delete_one(self, filter):
        ...
        :Returns:
          - An instance of :class:`~pymongo303.results.DeleteResult`.
    ...
    def find(self, *args, **kwargs):
        ...
        :class:`~pymongo303.cursor.Cursor` corresponding to this query.
        ...
        :Parameters:
          ...
          - `cursor_type` (optional): the type of cursor to return. The valid
            options are defined by :class:`~pymongo303.cursor.CursorType`:

            - :attr:`~pymongo303.cursor.CursorType.NON_TAILABLE` - the result of
              this find call will return a standard cursor over the result set.
            - :attr:`~pymongo303.cursor.CursorType.TAILABLE` - the result of this
            ...
            - :attr:`~pymongo303.cursor.CursorType.TAILABLE_AWAIT` - the result
            ...
            - :attr:`~pymongo303.cursor.CursorType.EXHAUST` - the result of this
          ...
          - `sort` (optional): a list of (key, direction) pairs
            ...
            :meth:`~pymongo303.cursor.Cursor.sort` for details.
        ...
        .. note:: There are a number of caveats to using
          :attr:`~pymongo303.cursor.CursorType.EXHAUST` as cursor_type:
          ...
          - A :class:`~pymongo303.cursor.Cursor` instance created with the
            :attr:`~pymongo303.cursor.CursorType.EXHAUST` cursor_type requires an
            exclusive :class:`~socket.socket` connection to MongoDB. If the
            :class:`~pymongo303.cursor.Cursor` is discarded without being
        ...
        .. versionchanged:: 3.0
           ...
           represents BSON regular expressions as :class:`~bson303.regex.Regex`
           objects. Use :meth:`~bson303.regex.Regex.try_compile` to attempt to
        ...
        .. versionchanged:: 2.7
           ...
           regular expressions as :class:`~bson303.regex.Regex` objects instead of
    ...
    def count(self, filter=None, **kwargs):
        ...
        to this method. Valid options include:
          ...
          - `hint` (string or list of tuples): The index to use. Specify either
            ...
            tuples (e.g. [('a', pymongo303.ASCENDING), ('b', pymongo303.ASCENDING)]).
    ...
    def create_indexes(self, indexes):
        """Create one or more indexes on this collection.
          ...
          >>> from pymongo303 import IndexModel, ASCENDING, DESCENDING
        ...
        :Parameters:
          - `indexes`: A list of :class:`~pymongo303.operations.IndexModel`
            instances.
    ...
    def create_index(self, keys, **kwargs):
        ...
        (:data:`~pymongo303.ASCENDING`, :data:`~pymongo303.DESCENDING`,
        :data:`~pymongo303.GEO2D`, :data:`~pymongo303.GEOHAYSTACK`,
        :data:`~pymongo303.GEOSPHERE`, :data:`~pymongo303.HASHED`,
        :data:`~pymongo303.TEXT`).
        ...
        ascending we need to use a list of tuples::
          ...
          >>> my_collection.create_index([("mike", pymongo303.DESCENDING),
          ...                             ("eliot", pymongo303.ASCENDING)])
        ...
        Valid options include, but are not limited to:
          ...
          - `min`: minimum value for keys in a :data:`~pymongo303.GEO2D`
            index.
          - `max`: maximum value for keys in a :data:`~pymongo303.GEO2D`
            index.
    ...
    def list_indexes(self):
        ...
        :Returns:
          An instance of :class:`~pymongo303.command_cursor.CommandCursor`.
    ...
    def options(self):
        ...
        :meth:`~pymongo303.database.Database.create_collection` for more
    ...
    def aggregate(self, pipeline, **kwargs):
        ...
        :attr:`~pymongo303.read_preferences.ReadPreference.PRIMARY` (the default).
        ...
        .. note:: This method does not support the 'explain' option. Please
           use :meth:`~pymongo303.database.Database.command` instead. An
        ...
        :Returns:
          A :class:`~pymongo303.command_cursor.CommandCursor` over the result
          set.
        ...
        .. versionchanged:: 2.7
           ...
           :class:`~pymongo303.command_cursor.CommandCursor` instead of
           :class:`~pymongo303.cursor.Cursor`.
        .. versionchanged:: 2.6
    ...
    def group(self, key, condition, initial, reduce, finalize=None, **kwargs):
        ...
        The `key` parameter can be:
          ...
          - A :class:`basestring` (:class:`str` in python 3), or
            :class:`~bson303.code.Code` instance containing a JavaScript
    ...
    def rename(self, new_name, **kwargs):
        ...
        (:class:`str` in python 3). Raises :class:`~pymongo303.errors.InvalidName`
    ...
    def map_reduce(self, map, reduce, out, full_response=False, **kwargs):
        ...
        :class:`~pymongo303.collection.Collection` instance containing
        ...
        :Parameters:
          ...
          - `out`: output collection name or `out object` (dict). See
            ...
            Note: `out` options are order sensitive. :class:`~bson303.son.SON`
    ...
    def find_one_and_delete(self, filter,
        ...
        If multiple documents match *filter*, a *sort* can be applied.
          ...
          ...     {'x': 1}, sort=[('_id', pymongo303.DESCENDING)])
          {u'x': 1, u'_id': 2}
    ...
    def find_one_and_update(self, filter, update,
        ...
        version of the document instead, use the *return_document* option.
          ...
          >>> from pymongo303 import ReturnDocument
        ...
        If multiple documents match *filter*, a *sort* can be applied.
          ...
          ...     {'done': True},
          ...     {'$set': {'final': True}},
          ...     sort=[('_id', pymongo303.DESCENDING)])
          {u'_id': 701, u'done': True, u'result': {u'count': 17}}
