...
from bson303 import DEFAULT_CODEC_OPTIONS
from bson303.py3compat import u, itervalues
from pymongo303 import auth, helpers, thread_util
from pymongo303.errors import (AutoReconnect,
                            ...
                            NotMasterError,
                            OperationFailure)
from pymongo303.ismaster import IsMaster
from pymongo303.monotonic import time as _time
from pymongo303.network import (command,
                             receive_message,
                             socket_closed)
...
try:
    ...
    from pymongo303.ssl_match_hostname import match_hostname, CertificateError
...
class Pool:
    ...
    def _check(self, sock_info):
        ...
        :class:`~pymongo303.errors.AutoReconnect` exceptions on server
