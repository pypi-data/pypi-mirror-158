...
class Model(InferenceModel):
    ...
    def log_batch_pyspark_prediction(
        ...
        Args:
            ...
            labels: Optional[Mapping[str,str]]
                key is a prediction name and the value is a column with the actual values of that predictions .
            spark_options: Optional configuration extension for spark elastic connector
    ...
    def log_pyspark_training_set(
        ...
        Args:
            dataframe: PySparkDataFrame all the data
            features: Optional[Mapping[str,str]]
