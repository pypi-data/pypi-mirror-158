    ...
    if 'vscs' in pydgrid_obj.data:
        for vsc in pydgrid_obj.data['vscs']:
            ...
            if vsc['type'] == 'ac3ph4wgfpidq': # AC 3 phase 4 wire open loop PI-VSG grid former
                ...
                pydgrid_obj.omega_coi_required = True
            if vsc['type'] == 'ac3ph4wgfpidq3': # AC 3 phase 4 wire open loop PI-VSG grid former v3
                ac3ph4wgfpidq3(pydgrid_obj,vsc)
                pydgrid_obj.omega_coi_required = True
            if vsc['type'] == 'ac3ph4wgfpidq4': # AC 3 phase 4 wire open loop PI-VSG grid former v3
                ac3ph4wgfpidq4(pydgrid_obj,vsc)
                pydgrid_obj.omega_coi_required = True            
