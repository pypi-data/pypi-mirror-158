...
all_data = binpan.handlers.redis_fetch.fetch_filter_query(redisClient=redis_client,
                                                          coin_filter='BUSD',
...
for ticker in tqdm(all_keys):
    ...
    df = binpan.handlers.redis_fetch.redis_parser(symbol_json_data=ticker_data,
                                                  symbol=symbol,
