...
setuptools.setup(
    ...
    version="0.0.5b",                        # The initial release version
    ...
    install_requires=['colorama', 'simple_wordlist'],                     # Install other dependencies if any
    include_package_data=True,
    package_dir={'dunglaierrors': 'dunglaierrors'},
