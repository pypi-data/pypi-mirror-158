...
setuptools.setup(
    ...
    version="0.0.5b2",                        # The initial release version
    ...
    packages=setuptools.find_packages('src/dunglaierrors'),    # List of all python modules to be installed
    classifiers=[
