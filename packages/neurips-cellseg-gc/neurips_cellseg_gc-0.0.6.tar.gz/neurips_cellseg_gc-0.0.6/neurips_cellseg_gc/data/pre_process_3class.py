...
def main():
    ...
    parser.add_argument('-i', '--input_path', default='neurips_cellseg_gc/data/Train_Labeled', type=str, help='training data path; subfolders: images, labels')
    parser.add_argument("-o", '--output_path', default='neurips_cellseg_gc/data/Train_Pre_3class', type=str, help='preprocessing data path')    
