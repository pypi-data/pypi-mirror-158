...
from neurips_cellseg_gc.unetr2d import UNETR2D
...
def main():
    ...
    # Dataset parameters
    parser.add_argument('--data_path', default='neurips_cellseg_gc/data/Train_Pre_3class/', type=str,
                        help='training data path; subfolders: images, labels')
    parser.add_argument('--work_dir', default='neurips_cellseg_gc/work_dir',
