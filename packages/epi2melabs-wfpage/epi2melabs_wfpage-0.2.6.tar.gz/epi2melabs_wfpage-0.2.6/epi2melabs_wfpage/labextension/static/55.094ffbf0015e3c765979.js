...
`;var _=o(2372),R=o(864);const $=m()((({text:e,className:t})=>d().createElement("div",{className:`${t} tooltip`},d().createElement(C.FontAwesomeIcon,{icon:S.faQuestionCircle}),d().createElement("p",null,e))))`
  && svg {
    width: 18px;
    height: 18px;
...
`,L=m()((({id:e,label:t,format:o,description:n,help_text:a,defaultValue:r,error:l,onChange:i,className:c})=>{const[m,p]=(0,s.useState)(r);return d().createElement("div",{className:`boolean-input ${c} ${m?"checked":"unchecked"}`},d().createElement("div",{className:"boolean-input-header"},d().createElement("div",null,d().createElement("h4",null,t),n?d().createElement("p",null,n):""),a?d().createElement("div",{className:"boolean-input-help"},d().createElement($,{text:a})):""),d().createElement("label",{htmlFor:e},d().createElement("input",{id:e,className:"boolInput",type:"checkbox",defaultChecked:r,onChange:t=>{p(!!t.target.checked),i(e,o,!!t.target.checked)}}),d().createElement("span",null,d().createElement(C.FontAwesomeIcon,{icon:m?S.faCheck:S.faTimes}))),l.length?d().createElement("div",{className:"error"},l.map((e=>d().createElement("p",null,"Error: ",e)))):"")}))`
  h4 {
    padding: 0 0 5px 0;
  }
...
`,F=m()((({id:e,label:t,format:o,description:n,help_text:a,defaultValue:r,minLength:l,maxLength:i,pattern:s,error:c,onChange:m,className:p})=>d().createElement("div",{className:`text-input ${p}`},d().createElement("div",{className:"text-input-header"},d().createElement("div",null,d().createElement("h4",null,t),n?d().createElement("p",null,n):""),a?d().createElement("div",{className:"text-input-help"},d().createElement($,{text:a})):""),d().createElement("label",{htmlFor:e},d().createElement("input",{id:e,type:"text",placeholder:"Enter a value",defaultValue:r,pattern:s,minLength:l,maxLength:i,onChange:t=>m(e,t.target.value)})),c.length?d().createElement("div",{className:"error"},c.map((e=>d().createElement("p",null,"Error: ",e)))):"")))`
  h4 {
    padding: 0 0 5px 0;
  }
...
`;var ee=o(7629),te=o.n(ee);const oe=m()((({className:e,body:t,icon:o})=>d().createElement("div",{className:e},d().createElement("div",{className:"empty"},d().createElement(C.FontAwesomeIcon,{icon:o}),d().createElement("h4",null,t)))))`
  && {
    margin: 0 auto;
    box-sizing: border-box;
  }
...
`,ne=m()((({className:e,docs:t})=>d().createElement("div",{className:`docs-panel ${e}`},t&&0!==Object.keys(t).length?d().createElement("div",{className:"docs-panel-contents markdown-body"},Object.values(t).map((e=>d().createElement(te(),{children:e})))):d().createElement(oe,{body:"No documentation available",icon:S.faFolderOpen}))))`
  && {
    max-width: 1024px;
    padding: 0 0 15px 0;
    margin: 0 auto;
...
`,xe=m()((({className:e})=>d().createElement("footer",{className:`footer ${e}`},d().createElement("p",null,"@2008 - ",se()().year()," Oxford Nanopore Technologies. All rights reserved"))))`
  width: 100%;
  padding: 25px;
  text-align: center;
  box-sizing: border-box;
`,ke=m().div``;class ye extends r.ReactWidget{constructor(e,t,o){super(),this.app=e,this.docTrack=t,this.settings=o,this.addClass("jp-ReactWidget"),this.addClass("epi2melabs-wfpage-widget")}render(){return d().createElement(b.MemoryRouter,null,d().createElement(ke,null,d().createElement("main",{style:{position:"relative"}},d().createElement(we,null),d().createElement("div",null,d().createElement(b.Routes,null,d().createElement(b.Route,{path:"/workflows/:name"},d().createElement(b.Route,{path:":instance_id",element:d().createElement(le,null)}),d().createElement(b.Route,{path:"",element:d().createElement(le,null)})),d().createElement(b.Route,{path:"/workflows",element:d().createElement(fe,null)}),d().createElement(b.Route,{path:"/instances/:id",element:d().createElement(O,{docTrack:this.docTrack,app:this.app})}),d().createElement(b.Route,{path:"/tutorials",element:d().createElement(pe,{docTrack:this.docTrack,templateDir:this.settings.get("template_dir").composite,workDir:this.settings.get("working_dir").composite})}),d().createElement(b.Route,{path:"/",element:d().createElement(fe,null)}))),d().createElement(xe,null))))}}const ve="@epi2melabs/epi2melabs-wfpage:plugin",Ee="create-epi2me-labs-launcher",Ne={id:ve,autoStart:!0,requires:[l.ILauncher,n.ISettingRegistry,a.IDocumentManager],activate:(e,t,o,n)=>{const{commands:a,shell:l}=e,s=(t,o,n)=>{const a=new ye(e,o,n),l=new r.MainAreaWidget({content:a});l.title.label="EPI2ME Labs",t.add(l,"main")};Promise.all([e.restored,o.load(ve)]).then((([,o])=>{a.addCommand(Ee,{caption:"Create an EPI2ME Labs launcher",label:"EPI2ME Labs",icon:i,execute:()=>s(l,n,o)}),s(l,n,o),t&&t.add({command:Ee,category:"EPI2ME Labs"}),e.commands.execute("filebrowser:hide-main")}))}}}}]);