...
com = {
    ...
    "status": r"Status:\s?(.+)",
    "emails": r"[\w.-]+@[\w.-]+\.[\w]{2,4}",
    "registrant_email": r"Registrant Email:\s?([\w.-]+@[\w.-]+\.[\w]{2,4})\s*",
    "registrant_address": r"Registrant Address:\s?(.+)\s*",
    "registrant_phone": r"Registrant Phone:\s?(.+)\s*",
    "registrant_state": r"Registrant State.*:\s?(.+)\s*",
    "registrant_city": r"Registrant City:\s?(.+)\s*",
}
...
娱乐 = {
    "extend": "com",
    "_server": "whois.nic.xn--fjq720a",
}

机构 = {
    "extend": "com",
    "_server": "whois.nic.xn--nqv7f",
}
...
公司 = 网络 = {
    "extend": "com",
    "_server": "whois.ngtld.cn",
}

网站 = {
    "extend": "com",
    "_server": "whois.nic.xn--5tzm5g",
}

公益 = 政务 = {
    "extend": "com",
    "_server": "whois.conac.cn",
}

政府 = {
    "extend": "cn",
    "_server": "whois.nic.xn--mxtq1m"
}
...
企业 = {
    "extend": "cn",
    "_server": "whois.nic.xn--vhquv"
}

手机 = {
    "extend": "cn",
    "_server": "whois.nic.xn--kput3i"
}

新闻 = {
    "extend": "cn",
    "_server": "whois.nic.xn--efvy88h"
}

移动 = {
    "extend": "cn",
    "_server": "whois.nic.xn--6frz82g"
}

联通 = {
    "extend": "cn",
    "_server": "whois.nic.xn--8y0a063a"
}

微博 = {
    "extend": "cn",
    "_server": "whois.nic.xn--9krt00a"
}
