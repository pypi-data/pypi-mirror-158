...
This package was generated from typeshed commit `0306754f5fbc8aad2ceed5c36e8a0be8e8c7ed70`.
'''.lstrip()
...
setup(name=name,
      ...
      package_data={'requests-stubs': ['__init__.pyi', 'adapters.pyi', 'api.pyi', 'auth.pyi', 'compat.pyi', 'cookies.pyi', 'exceptions.pyi', 'hooks.pyi', 'models.pyi', 'packages.pyi', 'sessions.pyi', 'status_codes.pyi', 'structures.pyi', 'utils.pyi', 'METADATA.toml']},
