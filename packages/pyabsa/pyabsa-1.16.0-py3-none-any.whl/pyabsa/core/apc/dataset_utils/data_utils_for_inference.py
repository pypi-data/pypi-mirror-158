        ...
        for i, text in enumerate(it):
            try:
                ...
                data = {
                    ...
                    'lcf_cdw_vec': lcf_cdw_vec if 'lcf_cdw_vec' in self.opt.inputs_cols else 0,
                    'lcf_cdm_vec': lcf_cdm_vec if 'lcf_cdm_vec' in self.opt.inputs_cols else 0,

                    'lcfs_vec': lcfs_vec if 'lcfs_vec' in self.opt.inputs_cols else 0,
                    'lcfs_cdw_vec': lcfs_cdw_vec if 'lcfs_cdw_vec' in self.opt.inputs_cols else 0,
                    'lcfs_cdm_vec': lcfs_cdm_vec if 'lcfs_cdm_vec' in self.opt.inputs_cols else 0,
