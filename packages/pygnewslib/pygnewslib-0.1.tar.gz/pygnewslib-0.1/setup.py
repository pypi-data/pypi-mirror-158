...
setup(
  name = 'pygnewslib',         # How you named your package folder (MyLib)
  packages = ['pygnewslib'],   # Chose the same as "name"
  ...
  download_url = 'https://github.com/roshaan55/pygnewslib/archive/refs/tags/v0.1.tar.gz',    # I explain this later on
