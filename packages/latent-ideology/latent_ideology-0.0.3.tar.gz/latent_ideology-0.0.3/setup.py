...
setuptools.setup(
    ...
    #download_url="https://github.com/fedemoss/latent_ideology/archive/refs/tags/0.0.2.tar.gz",
    download_url="https://github.com/fedemoss/latent-ideology/archive/refs/tags/0.0.3.tar.gz",
)
