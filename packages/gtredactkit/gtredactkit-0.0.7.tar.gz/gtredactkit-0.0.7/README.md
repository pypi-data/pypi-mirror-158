...
>This repository is an alternative of [python gtredactkit.py](<https://github.com/brootware/python> gtredactkit.py) an open source sensitive data redaction tool with support for redacting name.
<p align="center">
  <img src="./images/asciiRedact.png" alt="Python Redactor Kit!"/>
<br />
<i>A fork of python gtredactkit.py to redact and unredact sensitive information like ip addresses, emails and domains.</i>
...
```bash
python gtredactkit.py test.txt 
```
...
```bash
usage: gtredactkit [-h] [-u UNREDACT] [-t REDACTIONTYPE] [-d DIROUT] [-r] [-e EXTENSION] file [file ...]

Read in a file or set of files, and return the result.

positional arguments:
  file                  Path of a file or a directory of files. Usage: gtredactkit [file/filestoredact]

optional arguments:
  -h, --help            show this help message and exit
  -u UNREDACT, --unredact UNREDACT
                        Option to unredact masked data. Usage: gtredactkit [redacted_file] -u [.hashshadow.json] (default: None)
  -t REDACTIONTYPE, --redactiontype REDACTIONTYPE
                        Type of data to redact. names, nric, dns, emails, ipv4, ipv6, base64. Usage: gtredactkit [file/filestoredact] -t ip (default: None)
  -d DIROUT, --dirout DIROUT
                        Output directory of the file. Usage: gtredactkit [file/filestoredact] -d [redacted_dir] (default: None)
