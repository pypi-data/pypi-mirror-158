...
def setup_daemon(rds: RedisClient, metrics: GalileoFaasMetrics):
    ...
    replica_service = create_replica_service(node_service, rds, deployment_service, core_v1_api, pod_factory, metrics)
