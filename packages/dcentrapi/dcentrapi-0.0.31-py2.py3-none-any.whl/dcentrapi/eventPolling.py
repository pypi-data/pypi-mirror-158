...
class EventPolling(Base):
    ...
    def get_collection_sum_of_values_by_contract(self, collection_name, event_name, field_name, start_time, end_time):
        url = self.url + "event_polling/collection_sum_of_values_by_contract"
        data = {
            "collection_name": collection_name,
            "event_name": event_name,
            "field_name": field_name,
