...
class EventPolling(Base):
    ...
    def __init__(self, stage, key, collection_name):
        self.collection_name = collection_name
        self.authorize_collection(self.collection_name, self.key)
        super(EventPolling, self).__init__(stage, key)
    ...
    def authorize_collection(self, collection_name, key):
        pass
