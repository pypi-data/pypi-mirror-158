...
base_img_back_color = "#696969"#(125,125,125)#底图颜色
img_bcolor = '#828282'
title_fcolor = 'brown'
text_fcolor = 'black'
#
...
title_p['pos']=(0.05*title_p['fsize'],0.1*title_p['fsize'])
...
sub_title_p = {
    ...
    'color':text_fcolor,
    'pos':(title_p['pos'][0], sub_title_pos_prop*title_p['fsize'])
}

pie_p_pos_y = 1.2*(sub_title_p['fsize'] + title_p['fsize'])
x_step = 0.009*base_img_w#每个块之间的间隔
...
char_text_p = {
    ...
    'char_desc_fsize':int(0.17*indi_char_drawer_p['h']),
