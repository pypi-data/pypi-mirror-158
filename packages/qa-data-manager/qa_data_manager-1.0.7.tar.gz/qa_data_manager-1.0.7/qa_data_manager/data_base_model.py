# Code generated by:
# python -m pwiz -e mysql -H mariadb.ibolit.dev -p 3306 -u root -P stage-2 -i
# Date: June 09, 2022 05:27PM
# Database: stage-2
# Peewee version: 3.14.10

from peewee import *

database = MySQLDatabase('stage-2', **{'charset': 'utf8', 'sql_mode': 'PIPES_AS_CONCAT', 'use_unicode': True,
...
class Chats(BaseModel):
    ...
    chat_service_id = CharField(null=True)
    created_at = DateTimeField(null=True)
    deleted_at = DateTimeField(null=True)
    doctor = ForeignKeyField(column_name='doctor_id', field='id', model=Users)
...
class Toolbars(BaseModel):
    chats = IntegerField(constraints=[SQL("DEFAULT 0")])
    consultations = IntegerField(constraints=[SQL("DEFAULT 0")])
    patients = IntegerField(constraints=[SQL("DEFAULT 0")])
    user = ForeignKeyField(column_name='user_id', field='id', model=Users)
