...
class Info(QtWidgets.QDialog):
    ...
    def _init(self):
        ...
        self.setWindowTitle('Information: {}'.format(self._model.name))
...
class PortView(HighlightableElementViewInterface, QtWidgets.QGraphicsObject):
    ...
    def _init_actions(self):
        self._show_port_viewer_action = QtGui.QAction(
            'Open in Viewer', self)
        ...
        self._create_port_action = QtGui.QAction('Create', self)
        self._delete_port_action = QtGui.QAction('Remove', self)
    ...
    def _set_port_type(self, datatype):
        ...
        self._port_symbol = QtSvgWidgets.QGraphicsSvgItem(self)
    ...
    def _open_file_path(self):
        oss.open_directory(os.path.dirname(self._model.filename))
    ...
    def _update_tool_tip(self):
        self.setToolTip('<b>%s</b><br/><i>%s</i><br/>' % (
            html.escape(self._model.description), self._model.datatype.html))
