...
from utils.graphs_util import GraphFromSessionWindowCreator, \
    GraphFromTumblingWindowCreator, GraphFromSlidingWindowCreator, create_networkx_graph
...
class Dataset(ABC):
    ...
    def create_networkx_graphs(self, window_type, window_size, window_slide, test_id, include_last=True,
                               include_all_event_ids=False, include_positional_embeddings=False) -> List[
        networkx.Graph]:
        ...
        for graph in graphs:
            ...
            results.append(create_networkx_graph(graph_dict, positional_embeddings, self.anomalous_logs))
        return results
