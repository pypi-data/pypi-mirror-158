...
class Member(_message.Message):
    __slots__ = ["disabled", "ghost", "id", "name", "registered", "staffed", "status", "users", "values"]
    ...
    def __init__(self, id: _Optional[str] = ..., name: _Optional[str] = ..., disabled: bool = ..., registered: bool = ..., staffed: bool = ..., ghost: bool = ..., status: _Optional[_Union[Member.Status, str]] = ..., users: _Optional[_Iterable[_Union[Member.User, _Mapping]]] = ..., values: _Optional[_Iterable[_Union[Member.Value, _Mapping]]] = ...) -> None: ...
