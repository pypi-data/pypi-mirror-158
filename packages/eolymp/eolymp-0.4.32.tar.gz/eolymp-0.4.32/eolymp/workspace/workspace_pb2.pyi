...
class ListFilesInput(_message.Message):
    __slots__ = ["offset", "project_id", "size"]
    ...
    project_id: str
    size: int
    def __init__(self, project_id: _Optional[str] = ..., offset: _Optional[int] = ..., size: _Optional[int] = ...) -> None: ...
...
class ListProjectsInput(_message.Message):
    __slots__ = ["offset", "search_query", "size"]
    OFFSET_FIELD_NUMBER: _ClassVar[int]
    ...
    search_query: str
    size: int
    def __init__(self, search_query: _Optional[str] = ..., offset: _Optional[int] = ..., size: _Optional[int] = ...) -> None: ...
...
class UpdateProjectInput(_message.Message):
    __slots__ = ["project", "project_id"]
    PROJECT_FIELD_NUMBER: _ClassVar[int]
    PROJECT_ID_FIELD_NUMBER: _ClassVar[int]
    project: _project_pb2.Project
    project_id: str
    def __init__(self, project_id: _Optional[str] = ..., project: _Optional[_Union[_project_pb2.Project, _Mapping]] = ...) -> None: ...
...
class UploadFileInput(_message.Message):
    __slots__ = ["content", "name", "project_id"]
    ...
    name: str
    project_id: str
    def __init__(self, project_id: _Optional[str] = ..., name: _Optional[str] = ..., content: _Optional[bytes] = ...) -> None: ...
