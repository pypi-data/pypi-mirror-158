...
class ListDocumentsInput(_message.Message):
    __slots__ = ["filters", "offset", "search_query", "size"]
    class Filter(_message.Message):
        __slots__ = ["id", "locale", "path"]
        ...
        def __init__(self, id: _Optional[_Iterable[_Union[_expression_pb2.ExpressionID, _Mapping]]] = ..., path: _Optional[_Iterable[_Union[_expression_pb2.ExpressionString, _Mapping]]] = ..., locale: _Optional[_Iterable[_Union[_expression_pb2.ExpressionEnum, _Mapping]]] = ...) -> None: ...
    ...
    search_query: str
    size: int
    def __init__(self, search_query: _Optional[str] = ..., offset: _Optional[int] = ..., size: _Optional[int] = ..., filters: _Optional[_Union[ListDocumentsInput.Filter, _Mapping]] = ...) -> None: ...
