...
class Project(_message.Message):
    __slots__ = ["author_id", "created_on", "id", "labels", "name", "runtime", "target", "updated_on", "visibility"]
    ...
    def __init__(self, id: _Optional[str] = ..., name: _Optional[str] = ..., runtime: _Optional[str] = ..., visibility: _Optional[_Union[Project.Visibility, str]] = ..., author_id: _Optional[str] = ..., created_on: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., updated_on: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., target: _Optional[_Union[Project.Target, _Mapping]] = ..., labels: _Optional[_Iterable[str]] = ...) -> None: ...
