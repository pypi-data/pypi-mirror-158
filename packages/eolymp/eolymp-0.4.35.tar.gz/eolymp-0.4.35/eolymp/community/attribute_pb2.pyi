...
class Attribute(_message.Message):
    __slots__ = ["choices", "description", "hidden", "index", "key", "max", "min", "regexp", "required", "type"]
    ...
    required: bool
    type: Attribute.Type
    def __init__(self, key: _Optional[str] = ..., description: _Optional[_Iterable[_Union[Attribute.Description, _Mapping]]] = ..., type: _Optional[_Union[Attribute.Type, str]] = ..., index: _Optional[int] = ..., required: bool = ..., hidden: bool = ..., regexp: _Optional[str] = ..., min: _Optional[int] = ..., max: _Optional[int] = ..., choices: _Optional[_Iterable[str]] = ...) -> None: ...
