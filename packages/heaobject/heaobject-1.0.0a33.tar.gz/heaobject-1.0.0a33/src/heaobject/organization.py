...
class Organization(DataObject, SameMimeType):
    ...
    def aws_account_ids(self, value: list[str]) -> None:
        self.__aws_account_ids = [str(elem) for elem in value] if value is not None else []
    ...
    def manager_ids(self, manager_ids: list[str]) -> None:
        self.__manager_ids = [str(i) for i in manager_ids] if manager_ids is not None else []
    ...
    def member_ids(self, member_ids: list[str]) -> None:
        self.__member_ids = [str(i) for i in member_ids] if member_ids is not None else []
