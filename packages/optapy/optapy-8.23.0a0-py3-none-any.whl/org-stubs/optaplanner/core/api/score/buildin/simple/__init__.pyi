...
class SimpleScore(org.optaplanner.core.api.score.AbstractScore['SimpleScore']):
    """
    public final class SimpleScore extends :class:`~org.optaplanner.core.api.score.AbstractScore`<:class:`~org.optaplanner.core.api.score.buildin.simple.SimpleScore`>
    
        This :class:`~org.optaplanner.core.api.score.Score` is based on 1 level of int constraints.
    ...
    """
    public static final :class:`~org.optaplanner.core.api.score.buildin.simple.SimpleScore` ZERO
    
    
    """
    ONE: typing.ClassVar['SimpleScore'] = ...
    """
    public static final :class:`~org.optaplanner.core.api.score.buildin.simple.SimpleScore` ONE
    ...
    def add(self, simpleScore: 'SimpleScore') -> 'SimpleScore':
        """
            ...
            Parameters:
                addend (:class:`~org.optaplanner.core.api.score.buildin.simple.SimpleScore`): value to be added to this Score
    ...
    def divide(self, double: float) -> 'SimpleScore':
        """
            ...
            :meth:`~org.optaplanner.core.api.score.buildin.simple.https:.docs.oracle.com.javase.8.docs.api.java.lang.Math.html?is`).
    ...
    def equals(self, object: typing.Any) -> bool:
        """
            ...
            Overrides:
                ...
                meth:`~org.optaplanner.core.api.score.buildin.simple.https:.docs.oracle.com.javase.8.docs.api.java.lang.Object.html?is` in
                class :class:`~org.optaplanner.core.api.score.buildin.simple.https:.docs.oracle.com.javase.8.docs.api.java.lang.Object?is`
    ...
    def subtract(self, simpleScore: 'SimpleScore') -> 'SimpleScore':
        """
            ...
            Parameters:
                subtrahend (:class:`~org.optaplanner.core.api.score.buildin.simple.SimpleScore`): value to be subtracted from this Score
    ...
    def toShortString(self) -> str:
        """
            ...
            Like
            :meth:`~org.optaplanner.core.api.score.buildin.simple.https:.docs.oracle.com.javase.8.docs.api.java.lang.Object.html?is`,
...
class SimpleScoreHolder(org.optaplanner.core.api.score.holder.ScoreHolder[SimpleScore]):
    """
    :class:`~org.optaplanner.core.api.score.buildin.simple.https:.docs.oracle.com.javase.8.docs.api.java.lang.Deprecated?is`(:meth:`~org.optaplanner.core.api.score.buildin.simple.https:.docs.oracle.com.javase.8.docs.api.java.lang.Deprecated.html?is`=true) public interface SimpleScoreHolder extends :class:`~org.optaplanner.core.api.score.holder.ScoreHolder`<:class:`~org.optaplanner.core.api.score.buildin.simple.SimpleScore`>
    
        Deprecated, for removal: This API element is subject to removal in a future version.
        Score DRL is deprecated and will be removed in a future major version of OptaPlanner. See
        :class:`~org.optaplanner.core.api.score.buildin.simple.https:.www.optaplanner.org.learn.drl`.
