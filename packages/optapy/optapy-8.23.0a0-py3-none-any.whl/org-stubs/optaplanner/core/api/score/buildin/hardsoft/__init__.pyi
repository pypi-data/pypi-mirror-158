...
class HardSoftScore(org.optaplanner.core.api.score.AbstractScore['HardSoftScore']):
    """
    public final class HardSoftScore extends :class:`~org.optaplanner.core.api.score.AbstractScore`<:class:`~org.optaplanner.core.api.score.buildin.hardsoft.HardSoftScore`>
    
        This :class:`~org.optaplanner.core.api.score.Score` is based on 2 levels of int constraints: hard and soft. Hard
    ...
    """
    public static final :class:`~org.optaplanner.core.api.score.buildin.hardsoft.HardSoftScore` ZERO
    
    
    """
    ONE_HARD: typing.ClassVar['HardSoftScore'] = ...
    """
    public static final :class:`~org.optaplanner.core.api.score.buildin.hardsoft.HardSoftScore` ONE_HARD
    
    
    """
    ONE_SOFT: typing.ClassVar['HardSoftScore'] = ...
    """
    public static final :class:`~org.optaplanner.core.api.score.buildin.hardsoft.HardSoftScore` ONE_SOFT
    ...
    def add(self, hardSoftScore: 'HardSoftScore') -> 'HardSoftScore':
        """
            ...
            Parameters:
                addend (:class:`~org.optaplanner.core.api.score.buildin.hardsoft.HardSoftScore`): value to be added to this Score
    ...
    def divide(self, double: float) -> 'HardSoftScore':
        """
            ...
            :meth:`~org.optaplanner.core.api.score.buildin.hardsoft.https:.docs.oracle.com.javase.8.docs.api.java.lang.Math.html?is`).
    ...
    def equals(self, object: typing.Any) -> bool:
        """
            ...
            Overrides:
                ...
                meth:`~org.optaplanner.core.api.score.buildin.hardsoft.https:.docs.oracle.com.javase.8.docs.api.java.lang.Object.html?is` in
                class :class:`~org.optaplanner.core.api.score.buildin.hardsoft.https:.docs.oracle.com.javase.8.docs.api.java.lang.Object?is`
    ...
    def subtract(self, hardSoftScore: 'HardSoftScore') -> 'HardSoftScore':
        """
            ...
            Parameters:
                subtrahend (:class:`~org.optaplanner.core.api.score.buildin.hardsoft.HardSoftScore`): value to be subtracted from this Score
    ...
    def toShortString(self) -> str:
        """
            ...
            Like
            :meth:`~org.optaplanner.core.api.score.buildin.hardsoft.https:.docs.oracle.com.javase.8.docs.api.java.lang.Object.html?is`,
...
class HardSoftScoreHolder(org.optaplanner.core.api.score.holder.ScoreHolder[HardSoftScore]):
    """
    :class:`~org.optaplanner.core.api.score.buildin.hardsoft.https:.docs.oracle.com.javase.8.docs.api.java.lang.Deprecated?is`(:meth:`~org.optaplanner.core.api.score.buildin.hardsoft.https:.docs.oracle.com.javase.8.docs.api.java.lang.Deprecated.html?is`=true) public interface HardSoftScoreHolder extends :class:`~org.optaplanner.core.api.score.holder.ScoreHolder`<:class:`~org.optaplanner.core.api.score.buildin.hardsoft.HardSoftScore`>
    
        Deprecated, for removal: This API element is subject to removal in a future version.
        Score DRL is deprecated and will be removed in a future major version of OptaPlanner. See
        :class:`~org.optaplanner.core.api.score.buildin.hardsoft.https:.www.optaplanner.org.learn.drl`.
    ...
    def penalize(self, ruleContext: org.kie.api.runtime.rule.RuleContext, int: int) -> None:
        """
            ...
            :meth:`~org.optaplanner.core.api.score.buildin.hardsoft.HardSoftScoreHolder.penalize`.
    ...
    def reward(self, ruleContext: org.kie.api.runtime.rule.RuleContext, int: int) -> None:
        """
            ...
            :meth:`~org.optaplanner.core.api.score.buildin.hardsoft.HardSoftScoreHolder.reward`.
