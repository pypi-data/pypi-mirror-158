...
try:
    ...
    gdalOk = False
    sys.stdout.write('clidtwinp-> No se ha podido cargar gdal directamente, se intenta de la carpeta osgeo...\n')
if not gdalOk:
    try:
        ...
        gdalOk = False
        sys.stdout.write('clidtwinp-> Tampoco se ha podido cargar desde la carpeta osgeo.\n')
        sys.exit(0)
