"""Represents a behave config object in the Nexio Behave cli"""
...
class NexioBehaveConfig:
    """The Nexio Behave config object class"""
    ...
    def to_args(self) -> List[str]:
        ...
        """
        logger.debug("Generating behave args from config objects")
        args = []
        for arg in self:
            if type(arg) == List or type(arg) == tuple:
                ...
                args.append(arg)
        logger.debug(f"Behave args passed to behave: {args}")
        return args
