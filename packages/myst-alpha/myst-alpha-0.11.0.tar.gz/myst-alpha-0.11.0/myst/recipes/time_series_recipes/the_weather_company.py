...
class TheWeatherCompany(TimeSeriesRecipe):
    ...
    def create(self, project: Project, title: Optional[str] = None, description: Optional[str] = None) -> TimeSeries:
        ...
        if self._create_intermediate_time_series:
            ...
            Layer.create(
                downstream_node=co_time_series,
            ...
            Layer.create(
                downstream_node=hhc_time_series,
            ...
            Layer.create(
                downstream_node=ef_time_series,
        ...
        Layer.create(
            ...
            upstream_node=co_upstream_node,
            order=0,
            output_index=0,
        ...
        Layer.create(
            downstream_node=time_series,
            upstream_node=hhc_upstream_node,
            order=1,
            output_index=0,
        ...
        Layer.create(
            downstream_node=time_series,
            upstream_node=ef_upstream_node,
            order=2,
            output_index=0,
