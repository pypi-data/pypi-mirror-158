...
class RVector2D(rannotation.RAnnotation):
    ...
    def __init__(self, origin: object, components: object):
        """
        Creates a 2D vector.

        :param origin: list, tuple, ndarray, ... Internally, a numpy.ndarray.
        :param components: list, tuple, ndarray, ... Internally, a numpy.ndarray.
        """
        ...
        self.components = numpy.asarray(components)  # vector coordinates
        self._magnitude = -1
        self._orientation = -1
