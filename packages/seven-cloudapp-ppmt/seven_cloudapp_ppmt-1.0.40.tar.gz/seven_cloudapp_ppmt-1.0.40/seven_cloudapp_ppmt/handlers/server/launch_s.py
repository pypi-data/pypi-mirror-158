...
@LastEditTime: 2022-07-13 10:00:12
...
from seven_cloudapp_ppmt.db_models.launch.launch_plan_model import *
from seven_cloudapp_ppmt.db_models.launch.launch_goods_model import *
...
class InitLaunchGoodsHandler(SevenBaseHandler):
    ...
    def get_async(self):
        ...
        return self.reponse_json_success({"url": online_url, "act_name": "", "goods_list": []})
    ...
    def get_async(self):
        ...
        try:
            ...
            if close_goods_id != "":
                ...
                LaunchGoodsModel(context=self).update_table("is_launch=0,launch_date=%s", "act_id=%s and " + f"goods_id in ({close_goods_id_str_list})", params=[TimeHelper.get_now_format_time(), act_id])
...
class LaunchGoodsListHandler(TopBaseHandler):
    ...
    def get_async(self):
        ...
        launch_status = int(self.get_param("launch_status", 0))
    ...
    def get_launch_goods_list(self, app_id, act_id, page_size, page_index, access_token, goods_id, launch_status):
        ...
        if len(launch_goods_list) > 0:
            ...
            if "items_seller_list_get_response" in resq.keys():
                ...
                invoke_result_data["data"] = {"is_launch": act_info_dict['is_launch'], "page_info": {}}
                return invoke_result_data
        if len(goods_list) > 0:
...
class GetLaunchPlanStatusHandler(TopBaseHandler):
    ...
    def get_async(self):
        ...
        if tb_launch_status == 2 and act_info.is_launch == 0:
            tb_launch_status = 0
