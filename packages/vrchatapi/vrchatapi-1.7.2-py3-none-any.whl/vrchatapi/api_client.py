...
from vrchatapi.exceptions import ApiTypeError, ApiValueError, ApiException
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.check_user_exists  # this is an instance of the class Endpoint
        api_instance.check_user_exists()  # this invokes api_instance.check_user_exists.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.check_user_exists.callable or self.callable in this class
