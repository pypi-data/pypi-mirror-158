...
class GUID(TypeDecorator):  # type: ignore
    ...
    impl = CHAR
    # Enables SQL Alchemy to cache the custom type.
    # See https://docs.sqlalchemy.org/en/14/core/custom_types.html for more information.
    cache_ok = True  # True because we can cache our GUIDs
