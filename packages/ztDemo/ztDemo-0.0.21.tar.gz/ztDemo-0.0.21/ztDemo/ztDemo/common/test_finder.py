...
from ztDemo.ztDemo.common.data_processor import mk_test_name
...
class DiscoverTestCases:
    ...
    def find_test_module(self):
            ...
            def recursive_file_parser(file_path):
                ...
                for f in files:
                    ...
                    if os.path.isdir(f_p):
                        ...
                        if f_p.endswith('.py') and not f_p.endswith('__init__.py'):
        ...
        elif os.path.isfile(self.target_file_or_path) and not (self.target_file_or_path.endswith('__init__.py')):
