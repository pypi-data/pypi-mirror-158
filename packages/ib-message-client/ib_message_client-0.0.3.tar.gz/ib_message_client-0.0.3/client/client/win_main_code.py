...
class Ui_MainClientWindow(object):
    def setupUi(self, MainClientWindow):
        ...
        self.label_contacts.setGeometry(QtCore.QRect(10, 0, 161, 16))
        font = QtGui.QFont()
        ...
        self.label_history.setGeometry(QtCore.QRect(300, 0, 161, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.label_new_message.setGeometry(QtCore.QRect(300, 330, 400, 16))
        ...
        self.btn_send.setGeometry(QtCore.QRect(580, 450, 161, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.btn_send.setFont(font)
        self.btn_send.setObjectName("btn_send")
        self.btn_clear = QtWidgets.QPushButton(self.centralwidget)
        self.btn_clear.setGeometry(QtCore.QRect(440, 450, 131, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
