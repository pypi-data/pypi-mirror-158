...
def impTSP(
	...
	edges:		"1) String (default) 'Euclidean' or \
				 2) String 'SphereEuclidean' or \
				 3) Dictionary {(nodeID1, nodeID2): dist, ...}" = "Euclidean",
	seq:		"Sequence of visiting nodes, as the initial route, generated by constructive heuristic" = [],
	algo:		"1) String 'LKH' or \
				 2) String '2Opt' = '2Opt'" = '2Opt'
	...
	nodeIDs = list(nodes.keys())
	if (algo == '2Opt'):
		res = _impTSP2Opt(nodeIDs, edges, seq)
	if (res != None):
		return res

	return res

def _impTSPLKH(nodeIDs, edges, seq):

	return

# [Constructing]
def _impTSP2Opt(nodeIDs, edges, seq):
	# Initialize ==============================================================
	canImproveFlag = True
	impSeq = [i for i in seq]
