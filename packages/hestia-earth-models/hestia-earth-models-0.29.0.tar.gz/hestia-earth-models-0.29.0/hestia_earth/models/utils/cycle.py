...
def impact_lookup_value(
    model: str, term_id: str, blank_nodes: list, term_type: TermTermType, lookup_col: str, allow_missing: bool = True
) -> float:
    """
    ...
    factors = list(map(_factor_value(f"{term_type.value}.csv", lookup_col, model, term_id), nodes))
