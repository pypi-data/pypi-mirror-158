...
def viz(nlp_pipe: Union[Pipeline, LightPipeline, PipelineModel, List],data,viz_type:str,labels_to_viz=None, viz_colors={}, return_html=False,
        ):
    ...
    """
    return to_nlu_pipe(nlp_pipe,True).viz(data, text_to_viz=data,
                                          viz_type=viz_type,
