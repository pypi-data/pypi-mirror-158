...
class ComponentUniverse:
    ...
    components = {
        ...
        A.PARTIAL_RoBertaSentenceEmbeddings: partial(NluComponent,
                                                     name=A.PARTIAL_ChunkMergeApproach,
                                                     jsl_anno_class_id=A.PARTIAL_RoBertaSentenceEmbeddings,
                                                     jsl_anno_py_class=ACR.JSL_anno2_py_class[
                                                         A.PARTIAL_RoBertaSentenceEmbeddings],
                                                     node=NLP_FEATURE_NODES.nodes[A.PARTIALLY_IMPLEMENTED],
                                                     type=T.PARTIALLY_READY,
                                                     pdf_extractor_methods={'default': default_partial_implement_config,
                                                                            'default_full': default_full_config, },
        ...
        A.PARTIAL_SpanBertCorefModel: partial(NluComponent,
                                              name=A.PARTIAL_ChunkMergeApproach,
                                              jsl_anno_class_id=A.PARTIAL_SpanBertCorefModel,
                                              jsl_anno_py_class=ACR.JSL_anno2_py_class[A.PARTIAL_SpanBertCorefModel],
                                              node=NLP_FEATURE_NODES.nodes[A.PARTIALLY_IMPLEMENTED],
                                              type=T.PARTIALLY_READY,
                                              pdf_extractor_methods={'default': default_partial_implement_config,
                                                                     'default_full': default_full_config, },
        ...
        H_A.RELATION_EXTRACTION: partial(NluComponent,
                                         ...
                                         pdf_extractor_methods={'default': default_relation_extraction_positional_config,
