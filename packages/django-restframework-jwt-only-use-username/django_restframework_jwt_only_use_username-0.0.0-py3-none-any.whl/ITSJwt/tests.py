...
from .settings import api_settings, DEFAULTS
...
class ObtainJSONWebTokenTests(BaseTestCase):
    ...
    def test_jwt_login_json(self):
        ...
        response = client.post('token/obtain/', self.data, format='json')
    ...
    def test_jwt_login_json_missing_fields(self):
        ...
        response = client.post('token/obtain/',
    ...
    def test_jwt_login_using_zero(self):
        ...
        response = client.post('token/obtain/', data, format='json')
