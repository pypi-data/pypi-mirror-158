...
_yaml_text = resources.read_text("pystencil", "config.yaml")
yaml_config = yaml.safe_load(_yaml_text)

_json_text = resources.read_text("pystencil", "config.json")
json_config = json.loads(_json_text)

_ini_text = resources.read_text("pystencil", "config.ini")
...
_toml_text = resources.read_text("pystencil", "config.toml")
