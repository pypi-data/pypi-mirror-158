...
class XanderEngine:
    ...
    def run(self):
        ...
        for i, name in enumerate(self.pipelines):
            ...
            logging.info("Completed pipeline '{}' ({}/{})".format(pipeline.pipeline_slug, i + 1, len(self.pipelines)))
        ...
        logging.warning("Xander ML Engine has terminated successfully.")
    ...
    def add_pipeline(self, name):
        ...
        logging.info("Pipeline '{}' added to the engine".format(self.pipelines[name].pipeline_name))
