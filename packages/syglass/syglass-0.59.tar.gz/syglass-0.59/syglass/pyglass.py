...
class Project(object):
    ...
    def SetMeshReviewPath(self, dir: "std::string const &", path: "std::string const &") -> "void":
        return _pyglass.Project_SetMeshReviewPath(self, dir, path)

    def GetMeshReviewPath(self, dir: "std::string const &") -> "std::string":
        return _pyglass.Project_GetMeshReviewPath(self, dir)
