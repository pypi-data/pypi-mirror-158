...
Command to run at the prompt:
    python -m unittest -v tests/normalitycheck/AbdiMolin/test_to_xlsx.py
    or
    python -m unittest -b tests/normalitycheck/AbdiMolin/test_to_xlsx.py
...
class Test_to_xlsx(unittest.TestCase):
    ...
    def test_file_creating_xlsx(self):
        ...
        test.to_xlsx()
        result = _check_file_exists("abdimolin.xlsx")
        self.assertTrue(result, "File was not created")
        rem_file = Path("abdimolin.xlsx")
        rem_file.unlink()
