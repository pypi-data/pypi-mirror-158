...
Command to run at the prompt:
    python -m unittest -v tests/normalitycheck/AbdiMolin/test_to_csv.py

    or
    python -m unittest -b tests/normalitycheck/AbdiMolin/test_to_csv.py
...
class Test_to_csv(unittest.TestCase):
    ...
    def test_file_creating_1(self):
        ...
        test.to_csv()
        result = _check_file_exists("abdimolin.csv")
        self.assertTrue(result, "File was not created")
        rem_file = Path("abdimolin.csv")
        rem_file.unlink()
