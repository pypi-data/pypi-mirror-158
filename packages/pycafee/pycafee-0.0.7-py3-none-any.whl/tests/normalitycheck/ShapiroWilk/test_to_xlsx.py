...
Command to run at the prompt:
    python -m unittest -v tests/normalitycheck/ShapiroWilk/test_to_xlsx.py
    or
    python -m unittest -b tests/normalitycheck/ShapiroWilk/test_to_xlsx.py
