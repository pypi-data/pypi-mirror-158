...
Command to run at the prompt:
    python -m unittest -v tests/normalitycheck/Lilliefors/test_to_xlsx.py
    or
    python -m unittest -b tests/normalitycheck/Lilliefors/test_to_xlsx.py
...
class Test_to_xlsx(unittest.TestCase):
    ...
    def test_file_creating_xlsx(self):
        ...
        result = _check_file_exists("lilliefors.xlsx")
        self.assertTrue(result, "File was not created")
        rem_file = Path("lilliefors.xlsx")
        rem_file.unlink()
    ...
    def test_file_creating_2(self):
        ...
        lilliefors_test = Lilliefors()
        lilliefors_test.fit(self.my_data)
        lilliefors_test.to_xlsx("bawitdaba")
    ...
    def test_output(self):
        ...
        lilliefors_test = Lilliefors()
        lilliefors_test.fit(self.my_data)
        result = lilliefors_test.to_xlsx()
