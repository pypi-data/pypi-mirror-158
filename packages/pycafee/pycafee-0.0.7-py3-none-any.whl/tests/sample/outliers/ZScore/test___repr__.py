...
Command to run at the prompt:
    python -m unittest -v tests/sample/outliers/ZScore/test___repr__.py
    or
    python -m unittest -b tests/sample/outliers/ZScore/test___repr__.py
...
class Test_repr(unittest.TestCase):
    ...
    def test_without_fit(self):
        teste = ZScore()
        self.assertEqual(teste.__repr__(), "ZScore's test for outlier detection", msg="worng __repr__")

        teste = ZScore(language="pt-br")
        self.assertEqual(teste.__repr__(), "Teste Z para detecção de outliers", msg="worng __repr__")
