...
---> Class Test_ModifiedZScore checks if the results are correc for some datasets. It also checks for raises ValueError

--------------------------------------------------------------------------------
Command to run at the prompt:
    python -m unittest -v tests/sample/outliers/ModifiedZScore/test_fit.py
    or
    python -m unittest -b tests/sample/outliers/ModifiedZScore/test_fit.py
...
class Test_ModifiedZScore(unittest.TestCase):
    ...
    def test_raise_std_zero_output(self):
        ...
        expected = "The estimated median of the absolute deviations about the median for the dataset is equal to or very close to zero, which caused a division-by-zero error."
        result = False
    ...
    def test_details(self):
        ...
        self.assertAlmostEqual(result[0], 1.68625, places=7, msg="wrong statistic value")
        self.assertEqual(result[1], 3.5, msg="wrong critical value")
        ...
        self.assertIsInstance(result[2], float, msg="outlier not a float")
        self.assertIsInstance(conclusion, str, msg="conclusion not a str")
        self.assertAlmostEqual(result[0], 7.1497, places=7, msg="wrong statistic value")
        self.assertEqual(result[1], 3.5, msg="wrong critical value")
    ...
    def test_critical(self):
        ...
        self.assertIsInstance(result[2], float, msg="outlier not a float")
        self.assertIsInstance(conclusion, str, msg="conclusion not a str")
        self.assertAlmostEqual(result[0], 2.084818182, places=7, msg="wrong statistic value")
        self.assertEqual(result[1], 1, msg="wrong critical value")
    ...
    def test_which(self):
        ...
        self.assertIsInstance(result[2], float, msg="outlier not a float")
        self.assertIsInstance(conclusion, str, msg="conclusion not a str")
        self.assertAlmostEqual(result[0], 1.226363636, places=7, msg="wrong statistic value")
        self.assertEqual(result[1], 3.5, msg="wrong critical value")
    ...
    def test_outlier_lower(self):
        ...
        self.assertIsInstance(result[2], float, msg="outlier not a float")
        self.assertIsInstance(conclusion, str, msg="conclusion not a str")
        self.assertAlmostEqual(result[0], 3.854285714, places=7, msg="wrong statistic value")
        self.assertEqual(result[1], 3.5, msg="wrong critical value")
