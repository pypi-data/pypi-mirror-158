# Generated by Haxe 4.3.0-rc.1+a49b191
# coding: utf-8
import sys
...
class Lambda:
    ...
    _hx_is_interface = "False"
    __slots__ = ()
    _hx_statics = ["exists", "count", "empty", "find", "findIndex"]
...
class ConnectionDetails:
    ...
    def setServerAddress(self,serverAddress):
        ...
        def _hx_local_0():
            ...
            logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.actionLogger
            if logger.isInfoEnabled():
                logger.info(("serverAddress changed: " + Std.string(newValue)),None)
    ...
    def setAdapterSet(self,adapterSet):
        ...
        def _hx_local_0():
            logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.actionLogger
            if logger.isInfoEnabled():
                logger.info(("adapterSet changed: " + ("null" if adapterSet is None else adapterSet)),None)
    ...
    def setUser(self,user):
        ...
        def _hx_local_0():
            logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.actionLogger
            if logger.isInfoEnabled():
                logger.info(("user changed: " + ("null" if user is None else user)),None)
            _gthis.user = user
    ...
    def setPassword(self,password):
        ...
        def _hx_local_0():
            logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.actionLogger
            if logger.isInfoEnabled():
                logger.info("password changed",None)
...
class com_lightstreamer_client_ConnectionOptions:
...
class hx_concurrent_executor_Executor(hx_concurrent_ServiceBase):
    ...
    def __init__(self):
        def _hx_local_0(result):
            if (result.index == 1):
                haxe_Log.trace(result.params[0],_hx_AnonObject({'fileName': "hx/concurrent/executor/Executor.hx", 'lineNumber': 45, 'className': "hx.concurrent.executor.Executor", 'methodName': "onResult"}))
                ...
                while True:
                    ...
                    if (task is None):
                        ...
                        try:
                            ...
                            None
                            haxe_Log.trace(haxe_Exception.caught(_g).unwrap(),_hx_AnonObject({'fileName': "hx/concurrent/thread/ThreadPool.hx", 'lineNumber': 107, 'className': "hx.concurrent.thread.ThreadPool", 'methodName': "onStart"}))
...
class com_lightstreamer_internal_EventDispatcher:
    ...
    _hx_statics = ["createExecutor", "executor"]
    ...
    def dispatchToOne(self,listener,func):
        ...
        com_lightstreamer_internal_EventDispatcher.executor.submit(hx_concurrent_internal__Either2__Either2.a(_hx_local_0))
...
class com_lightstreamer_client_ClientEventDispatcher(com_lightstreamer_internal_EventDispatcher):
    ...
    def removeListenerAndFireOnListenEnd(self,listener,client):
    ...
    def addListenerAndFireOnListenStart(self,listener,client):
...
class com_lightstreamer_internal__Constants_Constants_Fields_:
    ...
    _hx_is_interface = "False"
    __slots__ = ()
    _hx_statics = ["TLCP_VERSION", "FULL_TLCP_VERSION", "LS_LIB_NAME", "LS_LIB_VERSION", "LS_CID"]
...
class LightstreamerClient:
    ...
    def __init__(self,serverAddress,adapterSet):
        ...
        self.connectionDetails = ConnectionDetails(self)
        self.connectionOptions = com_lightstreamer_client_ConnectionOptions(self)
    ...
    def addListener(self,listener):
        _gthis = self
        def _hx_local_0():
            _gthis.eventDispatcher.addListenerAndFireOnListenStart(listener,_gthis)
        com_lightstreamer_internal__RLock_RLock_Impl_.synchronized(self.lock,_hx_local_0)

    def removeListener(self,listener):
        _gthis = self
        def _hx_local_0():
            _gthis.eventDispatcher.removeListenerAndFireOnListenEnd(listener,_gthis)
        com_lightstreamer_internal__RLock_RLock_Impl_.synchronized(self.lock,_hx_local_0)
    ...
    def createReachabilityManager(self,host):
        return com_lightstreamer_internal_DummyReachabilityManager()
...
class Proxy:
    ...
    def equals(self,proxy2):
        if ((((self.type == proxy2.type) and ((self.host == proxy2.host))) and ((self.port == proxy2.port))) and ((self.user == proxy2.user))):
...
class com_lightstreamer_client__Subscription_SubscriptionEventDispatcher(com_lightstreamer_internal_EventDispatcher):
    ...
    def removeListenerAndFireOnListenEnd(self,listener,subscription):
        if self.removeListener(listener):
            def _hx_local_0(l):
                if (l.onListenEnd is not None):
                    l.onListenEnd(subscription)
            self.dispatchToOne(listener,_hx_local_0)

    def addListenerAndFireOnListenStart(self,listener,subscription):
        if self.addListener(listener):
            def _hx_local_0(l):
                if (l.onListenStart is not None):
                    l.onListenStart(subscription)
            self.dispatchToOne(listener,_hx_local_0)
...
class Subscription:
    ...
    def setRequestedMaxFrequency(self,freq):
        ...
        def _hx_local_0():
            ...
            if (_gthis.subId is not None):
                logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.subscriptionLogger
                line = ((("Subscription " + Std.string(_gthis.subId)) + " requested max frequency changed: ") + ("null" if freq is None else freq))
                if logger.isInfoEnabled():
    ...
    def setCommandSecondLevelDataAdapter(self,dataAdapter):
        ...
        def _hx_local_2():
            _gthis.checkActive()
            if (_gthis.mode != "COMMAND"):
                raise com_lightstreamer_internal_IllegalStateException("The operation is only available on COMMAND Subscriptions")
            def _hx_local_1():
                def _hx_local_0():
    ...
    def fireOnSubscription(self,subId):
        ...
        def _hx_local_0():
            logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.subscriptionLogger
            if logger.isInfoEnabled():
                logger.info((("Subscription " + Std.string(subId)) + " added"),None)
    ...
    def fireOnUnsubscription(self,subId):
        ...
        def _hx_local_0():
            logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.subscriptionLogger
            if logger.isInfoEnabled():
                logger.info((("Subscription " + Std.string(subId)) + " deleted"),None)
    ...
    def fireOnSubscriptionError(self,subId,code,msg):
        ...
        def _hx_local_0():
            ...
            if logger.isWarnEnabled():
                logger.warn(((((("Subscription " + Std.string(subId)) + " failed: ") + Std.string(code)) + " - ") + ("null" if msg is None else msg)),None)
    ...
    def fireOnEndOfSnapshot(self,itemIdx,subId):
        ...
        def _hx_local_0():
            logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.subscriptionLogger
            line = (((("Subscription " + Std.string(subId)) + ":") + HxOverrides.stringOrNull(_gthis.getItemNameOrPos(itemIdx))) + ": snapshot ended")
            if logger.isDebugEnabled():
                logger.debug(line,None)
    ...
    def fireOnClearSnapshot(self,itemIdx,subId):
        ...
        def _hx_local_0():
            logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.subscriptionLogger
            line = (((("Subscription " + Std.string(subId)) + ":") + HxOverrides.stringOrNull(_gthis.getItemNameOrPos(itemIdx))) + ": snapshot cleared")
            if logger.isDebugEnabled():
                logger.debug(line,None)
    ...
    def fireOnLostUpdates(self,itemIdx,lostUpdates,subId):
        ...
        def _hx_local_0():
            logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.subscriptionLogger
            line = (((((("Subscription " + Std.string(subId)) + ":") + HxOverrides.stringOrNull(_gthis.getItemNameOrPos(itemIdx))) + ": lost ") + Std.string(lostUpdates)) + " updates")
            if logger.isDebugEnabled():
                logger.debug(line,None)
    ...
    def fireOnItemUpdate(self,update,subId):
        ...
        def _hx_local_0():
            logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.subscriptionLogger
            line = ((((("Subscription " + Std.string(subId)) + ":") + HxOverrides.stringOrNull(_gthis.getItemNameOrPos(update.getItemPos()))) + " update: ") + Std.string(update))
            if logger.isDebugEnabled():
                logger.debug(line,None)
    ...
    def fireOnRealMaxFrequency(self,freq,subId):
        ...
        def _hx_local_0():
            logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.subscriptionLogger
            line = ((("Subscription " + Std.string(subId)) + " real max frequency changed: ") + Std.string(freq))
            if logger.isDebugEnabled():
                logger.debug(line,None)
    ...
    def fireOnSubscriptionError2Level(self,keyName,code,msg,subId,itemIdx):
        ...
        def _hx_local_0():
            logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.subscriptionLogger
            line = ((((((((("Subscription " + Std.string(subId)) + ":") + HxOverrides.stringOrNull(_gthis.getItemNameOrPos(itemIdx))) + ":") + ("null" if keyName is None else keyName)) + " failed: ") + Std.string(code)) + " - ") + ("null" if msg is None else msg))
            if logger.isWarnEnabled():
                logger.warn(line,None)
    ...
    def fireOnLostUpdates2Level(self,keyName,lostUpdates,subId,itemIdx):
        ...
        def _hx_local_0():
            logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.subscriptionLogger
            line = (((((((("Subscription " + Std.string(subId)) + ":") + HxOverrides.stringOrNull(_gthis.getItemNameOrPos(itemIdx))) + ":") + ("null" if keyName is None else keyName)) + ": lost ") + Std.string(lostUpdates)) + " updates")
            if logger.isDebugEnabled():
                logger.debug(line,None)
...
class com_lightstreamer_client_internal_ClientMachine:
    ...
    def evtNetworkNotReachable(self,host):
        logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.reachabilityLogger
        if logger.isInfoEnabled():
            logger.info((("null" if host is None else host) + " is NOT reachable"),None)
    ...
    def evtNetworkReachable(self,host):
        logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.reachabilityLogger
        if logger.isInfoEnabled():
            logger.info((("null" if host is None else host) + " is reachable"),None)
    ...
    def evtExtDisconnect(self):
        _gthis = self
        def _hx_local_0():
            _gthis.traceEvent("disconnect")
            terminationCause = com_lightstreamer_client_internal__ClientMachine_TerminationCause.TC_api
            _g = _gthis.state.s_m
            if (((((((_g == 116) or ((_g == 115))) or ((_g == 114))) or ((_g == 113))) or ((_g == 112))) or ((_g == 111))) or ((_g == 110))):
                ...
                if (_g is not None):
                    if (_g == 210):
                        ...
                        fh = _gthis.state
                        if (((fh.s_ws.m if ((fh.s_ws is not None)) else None)) == 500):
                            _gthis.disposeWS()
                            _gthis.notifyStatus("DISCONNECTED")
                            ...
                            tmp1 = None
                            fh = _gthis.state
                            if (((fh.s_ws.m if ((fh.s_ws is not None)) else None)) != 501):
                                fh = _gthis.state
                                tmp1 = (((fh.s_ws.m if ((fh.s_ws is not None)) else None)) == 502)
                            else:
                                tmp1 = True
                            if (not tmp1):
                                fh = _gthis.state
                                tmp = (((fh.s_ws.m if ((fh.s_ws is not None)) else None)) == 503)
                            else:
                                tmp = True
                            if tmp:
                                _gthis.sendDestroyWS()
                        ...
                        tmp = None
                        fh = _gthis.state
                        if (((fh.s_wp.m if ((fh.s_wp is not None)) else None)) != 600):
                            fh = _gthis.state
                            tmp = (((fh.s_wp.m if ((fh.s_wp is not None)) else None)) == 601)
                        else:
                            tmp = True
                        if tmp:
                            _gthis.disposeWS()
                            ...
                            fh = _gthis.state
                            if (((fh.s_wp.m if ((fh.s_wp is not None)) else None)) == 602):
                                _gthis.sendDestroyWS()
                                _gthis.closeWS()
                                _gthis.notifyStatus("DISCONNECTED")
                                _gthis.state.goto_m_from_wp(100)
    ...
    def evtMessage(self,line):
        ...
        if line.startswith("U,"):
            ...
            errorCode = com_lightstreamer_client_internal__ParseTools_ParseTools_Fields_.parseInt((args[3] if 3 < len(args) else None))
            errorMsg = python_lib_urllib_Parse.unquote((args[4] if 4 < len(args) else None))
            self.evtMSGFAIL(seq,prog,errorCode,errorMsg)
        elif line.startswith("REQERR"):
            args = line.split(",")
            reqId = com_lightstreamer_client_internal__ParseTools_ParseTools_Fields_.parseInt((args[1] if 1 < len(args) else None))
            code = com_lightstreamer_client_internal__ParseTools_ParseTools_Fields_.parseInt((args[2] if 2 < len(args) else None))
            msg = python_lib_urllib_Parse.unquote((args[3] if 3 < len(args) else None))
            self.evtREQERR(reqId,code,msg)
            ...
            args = line.split(",")
            code = com_lightstreamer_client_internal__ParseTools_ParseTools_Fields_.parseInt((args[1] if 1 < len(args) else None))
            msg = python_lib_urllib_Parse.unquote((args[2] if 2 < len(args) else None))
            self.evtCONERR(code,msg)
        elif line.startswith("END"):
            args = line.split(",")
            code = com_lightstreamer_client_internal__ParseTools_ParseTools_Fields_.parseInt((args[1] if 1 < len(args) else None))
            msg = python_lib_urllib_Parse.unquote((args[2] if 2 < len(args) else None))
            self.evtEND(code,msg)
        elif line.startswith("ERROR"):
            args = line.split(",")
            code = com_lightstreamer_client_internal__ParseTools_ParseTools_Fields_.parseInt((args[1] if 1 < len(args) else None))
            msg = python_lib_urllib_Parse.unquote((args[2] if 2 < len(args) else None))
            self.evtERROR(code,msg)
        ...
        if ((_g == 121) or ((_g == 120))):
            ...
            if (_g is not None):
                if (_g == 220):
                    ...
                    fh = self.state
                    _g = (fh.s_ws.m if ((fh.s_ws is not None)) else None)
                    if (_g is not None):
                        _g1 = _g
                        if (_g1 == 500):
                            self.disableWS()
                    ...
                    fh = self.state
                    _g = (fh.s_wp.m if ((fh.s_wp is not None)) else None)
                    if (_g is not None):
                        _g1 = _g
                    ...
                    if (_g is not None):
                        if (_g == 710):
                            fh = self.state
                            _g = (fh.s_hs.m if ((fh.s_hs is not None)) else None)
                            if (_g is not None):
                                _g1 = _g
                                if (_g1 == 800):
    ...
    def evtIdleTimeout(self):
        ...
        tmp = None
        fh = self.state
        _g = (fh.s_wp.p if ((fh.s_wp is not None)) else None)
        if (_g is None):
            tmp = False
        else:
            _g1 = _g
        ...
        if tmp:
            ...
            tmp = None
            fh = self.state
            _g = (fh.s_hp.m if ((fh.s_hp is not None)) else None)
            if (_g is None):
                tmp = False
            else:
                _g1 = _g
    ...
    def evtPollingTimeout(self):
        ...
        fh = self.state
        if (((fh.s_wp.p if ((fh.s_wp is not None)) else None)) == 612):
            ...
            fh = self.state
            if (((fh.s_hp.m if ((fh.s_hp is not None)) else None)) == 902):
    ...
    def evtKeepaliveTimeout(self):
        ...
        fh = self.state
        if (((fh.s_w.k if ((fh.s_w is not None)) else None)) == 310):
            ...
            fh = self.state
            if (((fh.s_ws.k if ((fh.s_ws is not None)) else None)) == 520):
                ...
                fh = self.state
                if (((fh.s_hs.k if ((fh.s_hs is not None)) else None)) == 820):
    ...
    def evtStalledTimeout(self):
        ...
        fh = self.state
        if (((fh.s_w.k if ((fh.s_w is not None)) else None)) == 311):
            ...
            fh = self.state
            if (((fh.s_ws.k if ((fh.s_ws is not None)) else None)) == 521):
                ...
                fh = self.state
                if (((fh.s_hs.k if ((fh.s_hs is not None)) else None)) == 821):
    ...
    def evtReconnectTimeout(self):
        ...
        fh = self.state
        if (((fh.s_w.k if ((fh.s_w is not None)) else None)) == 312):
            if (self.options.sessionRecoveryTimeout == 0):
                self.disposeWS()
                self.notifyStatus("DISCONNECTED:WILL-RETRY")
            ...
            fh = self.state
            if (((fh.s_ws.k if ((fh.s_ws is not None)) else None)) == 522):
                if (self.options.sessionRecoveryTimeout == 0):
                    self.disposeWS()
                    self.notifyStatus("DISCONNECTED:WILL-RETRY")
                    self.cause = "ws.stalled"
                ...
                fh = self.state
                if (((fh.s_hs.k if ((fh.s_hs is not None)) else None)) == 822):
                    if (self.options.sessionRecoveryTimeout == 0):
                        self.disposeHTTP()
                        self.notifyStatus("DISCONNECTED:WILL-RETRY")
    ...
    def evtRestartKeepalive(self):
        ...
        fh = self.state
        if (((fh.s_w.k if ((fh.s_w is not None)) else None)) is not None):
            ...
            fh = self.state
            if (((fh.s_ws.k if ((fh.s_ws is not None)) else None)) is not None):
                ...
                fh = self.state
                if (((fh.s_hs.k if ((fh.s_hs is not None)) else None)) is not None):
    ...
    def evtWSOK(self):
        ...
        logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.protocolLogger
        if logger.isDebugEnabled():
            logger.debug("WSOK",None)
        _g = self.state.s_m
        if (_g == 121):
            self.state.s_m = 122
            self.state.traceState()
    ...
    def evtCONERR(self,code,msg):
        ...
        logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.protocolLogger
        if logger.isDebugEnabled():
            logger.debug(((("CONERR " + Std.string(code)) + " ") + ("null" if msg is None else msg)),None)
        ...
        if (self.state.s_m == 122):
            ...
            fh = self.state
            if (((fh.s_ws.m if ((fh.s_ws is not None)) else None)) == 502):
                ...
                tmp = None
                fh = self.state
                if (((fh.s_wp.p if ((fh.s_wp is not None)) else None)) != 610):
                    fh = self.state
                    tmp = (((fh.s_wp.p if ((fh.s_wp is not None)) else None)) == 613)
                else:
                    tmp = True
                if tmp:
                    if ((((((code == 48) or ((code == 41))) or ((code == 40))) or ((code == 20))) or ((code == 6))) or ((code == 4))):
                    ...
                    tmp = None
                    fh = self.state
                    if (((fh.s_hs.m if ((fh.s_hs is not None)) else None)) != 800):
                        fh = self.state
                        tmp = (((fh.s_hs.m if ((fh.s_hs is not None)) else None)) == 801)
                    else:
                        tmp = True
                    if tmp:
                        if ((((((code == 48) or ((code == 41))) or ((code == 40))) or ((code == 20))) or ((code == 6))) or ((code == 4))):
                        ...
                        tmp = None
                        fh = self.state
                        if (((fh.s_hp.m if ((fh.s_hp is not None)) else None)) != 900):
                            fh = self.state
                            tmp = (((fh.s_hp.m if ((fh.s_hp is not None)) else None)) == 903)
                        else:
                            tmp = True
                        if tmp:
                            if ((((((code == 48) or ((code == 41))) or ((code == 40))) or ((code == 20))) or ((code == 6))) or ((code == 4))):
    ...
    def evtEND(self,code,msg):
        ...
        logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.protocolLogger
        if logger.isDebugEnabled():
            logger.debug(((("END " + Std.string(code)) + " ") + ("null" if msg is None else msg)),None)
        retryCause = com_lightstreamer_client_internal__ClientMachine_RetryCause.standardError(code,msg)
        terminationCause = com_lightstreamer_client_internal__ClientMachine_TerminationCause.TC_standardError(code,msg)
        fh = self.state
        if (((fh.s_w.p if ((fh.s_w is not None)) else None)) == 300):
            ...
            if (((fh.s_ws.m if ((fh.s_ws is not None)) else None)) == 502):
                ...
                fh = self.state
                if (((fh.s_ws.p if ((fh.s_ws is not None)) else None)) == 510):
                    if ((code == 48) or ((code == 41))):
                        self.disposeWS()
                        self.notifyStatus("DISCONNECTED:WILL-RETRY")
                        self.cause = ("ws.end." + Std.string(code))
                    ...
                    if tmp:
                        ...
                        fh = self.state
                        if (((fh.s_wp.p if ((fh.s_wp is not None)) else None)) == 611):
                            if ((code == 48) or ((code == 41))):
                                self.disposeWS()
                                self.notifyStatus("DISCONNECTED:WILL-RETRY")
                                self.cause = ("ws.end." + Std.string(code))
                            ...
                            if tmp:
                                ...
                                fh = self.state
                                if (((fh.s_hs.p if ((fh.s_hs is not None)) else None)) == 810):
                                    if ((code == 48) or ((code == 41))):
                                        self.disposeHTTP()
                                        self.notifyStatus("DISCONNECTED:WILL-RETRY")
                                        self.cause = ("http.end." + Std.string(code))
                                    ...
                                    if tmp:
                                        ...
                                        fh = self.state
                                        if (((fh.s_hp.m if ((fh.s_hp is not None)) else None)) == 901):
                                            if ((code == 48) or ((code == 41))):
                                                self.disposeHTTP()
                                                self.notifyStatus("DISCONNECTED:WILL-RETRY")
                                                self.cause = ("http.end." + Std.string(code))
    ...
    def evtERROR(self,code,msg):
        ...
        logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.protocolLogger
        if logger.isDebugEnabled():
            logger.debug(((("ERROR " + Std.string(code)) + " ") + ("null" if msg is None else msg)),None)
        terminationCause = com_lightstreamer_client_internal__ClientMachine_TerminationCause.TC_standardError(code,msg)
        fh = self.state
        if (((fh.s_w.p if ((fh.s_w is not None)) else None)) == 300):
            self.disposeWS()
            ...
            if (((fh.s_ws.p if ((fh.s_ws is not None)) else None)) == 510):
                ...
                fh = self.state
                if (((fh.s_wp.c if ((fh.s_wp is not None)) else None)) == 620):
                    self.disposeWS()
                    self.notifyStatus("DISCONNECTED")
                    self.notifyServerError_ERROR(code,msg)
                    self.state.goto_m_from_wp(100)
    ...
    def evtREQOK(self,reqId):
        ...
        logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.protocolLogger
        if logger.isDebugEnabled():
            logger.debug(("REQOK " + Std.string(reqId)),None)
        forward = True
    ...
    def evtREQERR(self,reqId,code,msg):
        ...
        logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.protocolLogger
        if logger.isDebugEnabled():
            logger.debug(((((("REQERR " + Std.string(reqId)) + " ") + Std.string(code)) + " ") + ("null" if msg is None else msg)),None)
        forward = True
        if ((self.state.s_swt == 1302) and ((reqId == self.swt_lastReqId))):
    ...
    def evtPROG(self,prog):
        ...
        logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.protocolLogger
        if logger.isDebugEnabled():
            logger.debug(("PROG " + Std.string(prog)),None)
        fh = self.state
        if (((fh.s_w.p if ((fh.s_w is not None)) else None)) == 300):
    ...
    def evtLOOP(self,pollingMs):
        ...
        logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.protocolLogger
        if logger.isDebugEnabled():
            logger.debug(("LOOP " + Std.string(pollingMs)),None)
        fh = self.state
        if (((fh.s_w.p if ((fh.s_w is not None)) else None)) == 300):
            self.closeWS()
            self.cause = "ws.loop"
    ...
    def evtCONOK(self,sessionId,reqLimit,keepalive,clink):
        ...
        logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.protocolLogger
        if logger.isDebugEnabled():
            logger.debug(((((((("CONOK " + ("null" if sessionId is None else sessionId)) + " ") + Std.string(reqLimit)) + " ") + Std.string(keepalive)) + " ") + ("null" if clink is None else clink)),None)
        if (self.state.s_m == 122):
            ...
            if (((fh.s_ws.m if ((fh.s_ws is not None)) else None)) == 502):
                ...
                if (((fh.s_wp.p if ((fh.s_wp is not None)) else None)) == 610):
                    ...
                    fh = self.state
                    if (((fh.s_wp.p if ((fh.s_wp is not None)) else None)) == 613):
                        self.doCONOK_BindWS_Polling(sessionId,reqLimit,keepalive,clink)
                        self.state.s_wp.p = 611
                        self.state.traceState()
                    else:
                        ...
                        if (((fh.s_hs.m if ((fh.s_hs is not None)) else None)) == 800):
                            ...
                            fh = self.state
                            if (((fh.s_hs.m if ((fh.s_hs is not None)) else None)) == 801):
                                self.doCONOK_BindHTTP_Streaming(sessionId,reqLimit,keepalive,clink)
                                self.notifyStatus("CONNECTED:HTTP-STREAMING")
                                self.state.s_hs.m = 802
                                self.state.s_hs.p = 810
                                ...
                                if (((fh.s_hp.m if ((fh.s_hp is not None)) else None)) == 900):
                                    ...
                                    fh = self.state
                                    if (((fh.s_hp.m if ((fh.s_hp is not None)) else None)) == 903):
                                        self.doCONOK_BindHTTP_Polling(sessionId,reqLimit,keepalive,clink)
                                        self.state.s_hp.m = 901
                                        self.state.traceState()
    ...
    def evtSERVNAME(self,serverName):
        ...
        logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.protocolLogger
        if logger.isDebugEnabled():
            logger.debug(("SERVNAME " + ("null" if serverName is None else serverName)),None)
    ...
    def evtCLIENTIP(self,clientIp):
        ...
        logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.protocolLogger
        if logger.isDebugEnabled():
            logger.debug(("CLIENTIP " + ("null" if clientIp is None else clientIp)),None)
        if self.state.inPushing():
    ...
    def evtCONS(self,bandwidth):
        ...
        logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.protocolLogger
        line = ("CONS " + Std.string(bandwidth))
        if logger.isDebugEnabled():
            logger.debug(line,None)
        if self.state.inPushing():
    ...
    def evtSYNC(self,seconds):
        ...
        logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.protocolLogger
        if logger.isDebugEnabled():
            logger.debug(("SYNC " + Std.string(seconds)),None)
        forward = True
        tmp = None
        tmp1 = None
        fh = self.state
        if (((fh.s_w.p if ((fh.s_w is not None)) else None)) != 300):
            fh = self.state
            tmp1 = (((fh.s_ws.p if ((fh.s_ws is not None)) else None)) == 510)
        else:
            tmp1 = True
        if (not tmp1):
            fh = self.state
            tmp = (((fh.s_hs.p if ((fh.s_hs is not None)) else None)) == 810)
        else:
            tmp = True
        if tmp:
            ...
            if (not (((self.state.s_tr == 220) or ((self.state.s_tr == 230))))):
                fh = self.state
                tmp1 = (((fh.s_wp.p if ((fh.s_wp is not None)) else None)) == 611)
            else:
                tmp1 = True
            if (not tmp1):
                fh = self.state
                tmp = (((fh.s_hp.m if ((fh.s_hp is not None)) else None)) == 901)
            else:
                tmp = True
    ...
    def evtMSGDONE(self,sequence,prog):
        ...
        logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.protocolLogger
        if logger.isDebugEnabled():
            logger.debug(((("MSGDONE " + ("null" if sequence is None else sequence)) + " ") + Std.string(prog)),None)
        if self.state.inPushing():
            if self.isFreshData():
    ...
    def evtMSGFAIL(self,sequence,prog,errorCode,errorMsg):
        ...
        logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.protocolLogger
        if logger.isDebugEnabled():
            logger.debug(((((((("MSGFAIL " + ("null" if sequence is None else sequence)) + " ") + Std.string(prog)) + " ") + Std.string(errorCode)) + " ") + ("null" if errorMsg is None else errorMsg)),None)
        if self.state.inPushing():
            if self.isFreshData():
    ...
    def evtSUBOK(self,subId,nItems,nFields):
        ...
        logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.protocolLogger
        if logger.isDebugEnabled():
            logger.debug(((((("SUBOK " + Std.string(subId)) + " ") + Std.string(nItems)) + " ") + Std.string(nFields)),None)
        if self.state.inPushing():
            if self.isFreshData():
    ...
    def evtSUBCMD(self,subId,nItems,nFields,keyIdx,cmdIdx):
        ...
        logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.protocolLogger
        if logger.isDebugEnabled():
            logger.debug(((((((((("SUBCMD " + Std.string(subId)) + " ") + Std.string(nItems)) + " ") + Std.string(nFields)) + " ") + Std.string(keyIdx)) + " ") + Std.string(cmdIdx)),None)
        if self.state.inPushing():
            if self.isFreshData():
    ...
    def evtUNSUB(self,subId):
        ...
        logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.protocolLogger
        if logger.isDebugEnabled():
            logger.debug(("UNSUB " + Std.string(subId)),None)
        if self.state.inPushing():
            if self.isFreshData():
                self.doUNSUB(subId)
                if self.state.inStreaming():
    ...
    def evtEOS(self,subId,itemIdx):
        ...
        logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.protocolLogger
        if logger.isDebugEnabled():
            logger.debug(((("EOS " + Std.string(subId)) + " ") + Std.string(itemIdx)),None)
        if self.state.inPushing():
            if self.isFreshData():
    ...
    def evtCS(self,subId,itemIdx):
        ...
        logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.protocolLogger
        if logger.isDebugEnabled():
            logger.debug(((("CS " + Std.string(subId)) + " ") + Std.string(itemIdx)),None)
        if self.state.inPushing():
            if self.isFreshData():
    ...
    def evtOV(self,subId,itemIdx,lostUpdates):
        ...
        logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.protocolLogger
        if logger.isDebugEnabled():
            logger.debug(((((("OV " + Std.string(subId)) + " ") + Std.string(itemIdx)) + " ") + Std.string(lostUpdates)),None)
        if self.state.inPushing():
            if self.isFreshData():
    ...
    def evtCONF(self,subId,freq):
        ...
        logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.protocolLogger
        line = ((("CONF " + Std.string(subId)) + " ") + Std.string(freq))
        if logger.isDebugEnabled():
            logger.debug(line,None)
        if self.state.inPushing():
            if self.isFreshData():
    ...
    def evtSendPendingControls(self):
        ...
        fh = self.state
        if ((((fh.s_w.s if ((fh.s_w is not None)) else None)) == 340) and (not Lambda.empty(controls))):
            ...
            fh = self.state
            if ((((fh.s_ws.s if ((fh.s_ws is not None)) else None)) == 550) and (not Lambda.empty(controls))):
                self.sendPengingControlsWS(controls)
                self.state.s_ws.s = 550
                self.state.traceState()
                self.evtRestartHeartbeat()
                ...
                fh = self.state
                if ((((fh.s_wp.s if ((fh.s_wp is not None)) else None)) == 630) and (not Lambda.empty(controls))):
                    self.sendPengingControlsWS(controls)
                    self.state.s_wp.s = 630
                    self.state.traceState()
    ...
    def evtSendPendingMessages(self):
        ...
        if ((((fh.s_w.s if ((fh.s_w is not None)) else None)) == 340) and Lambda.exists(self.messageManagers,_hx_local_0)):
            ...
            def _hx_local_1(msg):
                return msg.isPending()
            if ((((fh.s_ws.s if ((fh.s_ws is not None)) else None)) == 550) and Lambda.exists(self.messageManagers,_hx_local_1)):
                self.sendPendingMessagesWS()
                self.state.s_ws.s = 550
                self.state.traceState()
                self.genAckMessagesWS()
                ...
                def _hx_local_2(msg):
                    return msg.isPending()
                if ((((fh.s_wp.s if ((fh.s_wp is not None)) else None)) == 630) and Lambda.exists(self.messageManagers,_hx_local_2)):
                    self.sendPendingMessagesWS()
                    self.state.s_wp.s = 630
                    self.state.traceState()
                    self.genAckMessagesWS()
    ...
    def evtSendControl(self,request):
        ...
        def _hx_local_0():
            ...
            fh = _gthis.state
            if (((fh.s_w.s if ((fh.s_w is not None)) else None)) == 340):
                ...
                fh = _gthis.state
                if (((fh.s_ws.s if ((fh.s_ws is not None)) else None)) == 550):
                    _gthis.sendControlWS(request)
                    ...
                    fh = _gthis.state
                    if (((fh.s_wp.s if ((fh.s_wp is not None)) else None)) == 630):
                        _gthis.sendControlWS(request)
    ...
    def evtStartSession(self):
        ...
        logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.sessionLogger
        line = ("Starting new session: " + HxOverrides.stringOrNull(self.sessionId))
        if logger.isInfoEnabled():
            logger.info(line,None)
    ...
    def evtEndSession(self):
        logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.sessionLogger
        line = ("Destroying session: " + HxOverrides.stringOrNull(self.sessionId))
        if logger.isInfoEnabled():
            logger.info(line,None)
    ...
    def evtSwitchTransport_forwardToTransportRegion(self):
        ...
        if (self.state.s_tr == 200):
            ...
            fh = self.state
            if (((fh.s_hs.p if ((fh.s_hs is not None)) else None)) == 811):
                tmp = self.getBestForBinding().index
                if (tmp == 0):
                    self.notifyStatus("DISCONNECTED")
                    self.state.goto_m_from_hs(100)
                ...
                fh = self.state
                if (((fh.s_hp.m if ((fh.s_hp is not None)) else None)) == 904):
                    tmp = self.getBestForBinding().index
                    if (tmp == 0):
                        self.notifyStatus("DISCONNECTED")
                        self.state.goto_m_from_hp(100)
    ...
    def openWS(self,url,headers):
        ...
        tmp2 = _hx_local_5
        return self.wsFactory(url,headers,tmp,tmp1,tmp2)
    ...
    def sendCreateWS(self):
        ...
        if (self.cause is not None):
            ...
            self.cause = None
        logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.protocolLogger
        line = ("Sending session create: " + Std.string(req))
        if logger.isInfoEnabled():
            logger.info(line,None)
    ...
    def sendBindWS_Streaming(self):
        ...
        if (self.cause is not None):
            ...
            self.cause = None
        logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.protocolLogger
        line = ("Sending session bind: " + Std.string(req))
        if logger.isInfoEnabled():
            logger.info(line,None)
        com_lightstreamer_internal_NullTools.sure(self.ws).send("wsok")
    ...
    def sendDestroyWS(self):
        ...
        req.LS_cause("api")
        logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.protocolLogger
        line = ("Sending session destroy: " + Std.string(req))
        if logger.isInfoEnabled():
            logger.info(line,None)
    ...
    def sendHttpRequest(self,url,req,headers):
        ...
        tmp1 = _hx_local_3
        def _hx_local_5():
            def _hx_local_4(client):
                pass
            return self.httpFactory(url,req.getEncodedString(),headers,tmp,tmp1,_hx_local_4)
        return _hx_local_5()
    ...
    def sendCreateHTTP(self):
        ...
        self.connectTs = python_lib_Timeit.default_timer()
        self.serverInstanceAddress = self.getServerAddress()
        self.http = self.sendHttpRequest(com_lightstreamer_internal_Url.build(self.serverInstanceAddress,("/lightstreamer/create_session.txt?LS_protocol=" + HxOverrides.stringOrNull(com_lightstreamer_internal__Constants_Constants_Fields_.TLCP_VERSION))),req,self.options.httpExtraHeaders)
    ...
    def sendRecovery(self):
        ...
        if (self.cause is not None):
            ...
            self.cause = None
        logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.protocolLogger
        line = ("Sending session recovery: " + Std.string(req))
        if logger.isInfoEnabled():
            logger.info(line,None)
        self.connectTs = python_lib_Timeit.default_timer()
        self.http = self.sendHttpRequest(com_lightstreamer_internal_Url.build(com_lightstreamer_internal_NullTools.sure(self.serverInstanceAddress),("/lightstreamer/bind_session.txt?LS_protocol=" + HxOverrides.stringOrNull(com_lightstreamer_internal__Constants_Constants_Fields_.TLCP_VERSION))),req,self.getHeadersForRequestOtherThanCreate())
    ...
    def notifyStatus(self,newStatus):
        ...
        if (oldStatus != newStatus):
            logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.sessionLogger
            if logger.isInfoEnabled():
                logger.info(("Status: " + Std.string(newStatus)),None)
            self.clientEventDispatcher.onStatusChange(newStatus)

    def getBestForCreating(self):
        ft = self.options.forcedTransport
        if ((not self.suspendedTransports.union(self.disabledTransports.toArray()).contains("WS-STREAMING")) and ((((ft is None) or ((ft == "WS"))) or ((ft == "WS-STREAMING"))))):
    ...
    def getBestForBinding(self):
        ft = self.options.forcedTransport
        if ((not self.disabledTransports.contains("WS-STREAMING")) and ((((ft is None) or ((ft == "WS"))) or ((ft == "WS-STREAMING"))))):
            return com_lightstreamer_client_internal__ClientMachine_BestForBindingEnum.BFB_ws_streaming
        elif ((not self.disabledTransports.contains("HTTP-STREAMING")) and ((((ft is None) or ((ft == "HTTP"))) or ((ft == "HTTP-STREAMING"))))):
            return com_lightstreamer_client_internal__ClientMachine_BestForBindingEnum.BFB_http_streaming
        elif ((not self.disabledTransports.contains("WS-POLLING")) and ((((ft is None) or ((ft == "WS"))) or ((ft == "WS-POLLING"))))):
            return com_lightstreamer_client_internal__ClientMachine_BestForBindingEnum.BFB_ws_polling
        elif (((ft is None) or ((ft == "HTTP"))) or ((ft == "HTTP-POLLING"))):
    ...
    def doCLIENTIP(self,clientIp):
        ...
        if ((lastIp is not None) and ((lastIp != clientIp))):
            logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.sessionLogger
            if logger.isInfoEnabled():
                logger.info(((("Client IP changed: " + ("null" if lastIp is None else lastIp)) + " -> ") + ("null" if clientIp is None else clientIp)),None)
            self.enableAllTransports()
    ...
    def doMSGDONE(self,sequence,prog):
        ...
        def _hx_local_0(msg):
            if (msg.sequence == sequence):
                ...
                return False
        messages = list(filter(_hx_local_0,self.messageManagers))
        if (len(messages) > 1):
            raise com_lightstreamer_internal_IllegalStateException(("Assertion failure: " + "messages.length <= 1"))
        _g = 0
        while (_g < len(messages)):
            def _hx_local_2():
                nonlocal _g
                _hx_local_1 = _g
                _g = (_g + 1)
                return _hx_local_1
            msg = python_internal_ArrayImpl._get(messages, _hx_local_2())
            msg.evtMSGDONE()
        ...
        if (errorCode == 39):
                ...
                def _hx_local_1(p):
                    def _hx_local_0(msg):
                        if (msg.sequence == sequence):
                            ...
                            return False
                    return _hx_local_0
                messages = list(filter(_hx_local_1([p]),_this))
                if (len(messages) > 1):
                    raise com_lightstreamer_internal_IllegalStateException(("Assertion failure: " + "messages.length <= 1"))
                _g2 = 0
                while (_g2 < len(messages)):
                    def _hx_local_3():
                        nonlocal _g2
                        _hx_local_2 = _g2
                        _g2 = (_g2 + 1)
                        return _hx_local_2
                    msg = python_internal_ArrayImpl._get(messages, _hx_local_3())
            ...
            def _hx_local_4(msg):
                if (msg.sequence == sequence):
                    ...
                    return False
            messages = list(filter(_hx_local_4,self.messageManagers))
            if (len(messages) > 1):
                raise com_lightstreamer_internal_IllegalStateException(("Assertion failure: " + "messages.length <= 1"))
            _g = 0
            while (_g < len(messages)):
                def _hx_local_6():
                    ...
                    _g = (_g + 1)
                    return _hx_local_5
                msg = python_internal_ArrayImpl._get(messages, _hx_local_6())
                msg.evtMSGFAIL(errorCode,errorMsg)
    ...
    def doREQOK(self,reqId):
        ...
        while (_g.current < len(_g.array)):
            def _hx_local_1():
                ...
                return _hx_local_0
            _g1 = python_internal_ArrayImpl._get(_g.array, _hx_local_1())
            _g1.value.evtREQOK(reqId)
        _g = 0
        _g1 = self.messageManagers
        while (_g < len(_g1)):
            def _hx_local_3():
                nonlocal _g
                _hx_local_2 = _g
                _g = (_g + 1)
                return _hx_local_2
            msg = python_internal_ArrayImpl._get(_g1, _hx_local_3())
            msg.evtREQOK(reqId)
    ...
    def doREQERR(self,reqId,errorCode,errorMsg):
        ...
        while (_g.current < len(_g.array)):
            def _hx_local_1():
                ...
                return _hx_local_0
            _g1 = python_internal_ArrayImpl._get(_g.array, _hx_local_1())
            _g1.value.evtREQERR(reqId,errorCode,errorMsg)
        _g = 0
        _g1 = self.messageManagers
        while (_g < len(_g1)):
            def _hx_local_3():
    ...
    def entry_rec(self,pause,retryCause):
        logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.sessionLogger
        line = ((("Recovering connection in " + Std.string(pause)) + " ms. Cause: ") + HxOverrides.stringOrNull(com_lightstreamer_client_internal__ClientMachine_ClientMachine_Fields_.asErrorMsg(retryCause)))
        if logger.isErrorEnabled():
            logger.error(line,None)
    ...
    def genAbortMessages(self):
        ...
        while (_g < len(_g1)):
            def _hx_local_1():
                ...
                _g = (_g + 1)
                return _hx_local_0
            msg = python_internal_ArrayImpl._get(_g1, _hx_local_1())
            msg.evtAbort()
        ...
        def _hx_local_1():
            def _hx_local_0():
                ...
                if (_gthis.cause is not None):
                    ...
                    _gthis.cause = None
                logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.protocolLogger
                line = ("Sending transport switch: " + Std.string(req))
                if logger.isInfoEnabled():
                    logger.info(line,None)
        ...
        def _hx_local_1():
            def _hx_local_0():
                ...
                if (tmp == 0):
                    ...
                    pass
                logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.protocolLogger
                line = ("Sending bandwidth constrain: " + Std.string(req))
                if logger.isInfoEnabled():
                    logger.info(line,None)
                return req.getEncodedString()
            return com_lightstreamer_internal__RLock_RLock_Impl_.synchronized(self.lock,_hx_local_0)
    ...
    def sendPendingMessagesWS(self):
        _g = []
        _g1 = 0
        _g2 = self.messageManagers
        while (_g1 < len(_g2)):
            msg = (_g2[_g1] if _g1 >= 0 and _g1 < len(_g2) else None)
            _g1 = (_g1 + 1)
            if msg.isPending():
                _g.append(msg)
    ...
    def sendHeartbeatWS(self):
        logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.protocolLogger
        if logger.isInfoEnabled():
            logger.info("Heartbeat request",None)
    ...
    def relateMsgManager(self,msgManager):
        _gthis = self
        def _hx_local_0():
            _this = _gthis.messageManagers
            _this.append(msgManager)
            return len(_this)
        com_lightstreamer_internal__RLock_RLock_Impl_.synchronized(self.lock,_hx_local_0)
    ...
    def unrelateMsgManager(self,msgManager):
        _gthis = self
        def _hx_local_0():
            return python_internal_ArrayImpl.remove(_gthis.messageManagers,msgManager)
        com_lightstreamer_internal__RLock_RLock_Impl_.synchronized(self.lock,_hx_local_0)
    ...
    def traceEvent(self,event):
        logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.internalLogger
        line = ((("event: " + ("null" if event is None else event)) + " ") + HxOverrides.stringOrNull(self.state.toString()))
        if logger.isTraceEnabled():
            logger.trace(line,None)
    ...
    def connect(self):
        ...
        def _hx_local_0():
            ...
            logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.actionLogger
            line = ((("Connection requested: details: " + Std.string(_gthis.details)) + " options: ") + Std.string(_gthis.options))
            if logger.isInfoEnabled():
                logger.info(line,None)
    ...
    def disconnect(self):
        ...
        def _hx_local_0():
            logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.actionLogger
            if logger.isInfoEnabled():
                logger.info("Disconnection requested",None)
            _gthis.evtExtDisconnect()
        com_lightstreamer_internal__RLock_RLock_Impl_.synchronized(self.lock,_hx_local_0)
    ...
    def sendMessage(self,message,sequence,delayTimeout,listener,enqueueWhileDisconnected):
        ...
        def _hx_local_0():
            if ((not enqueueWhileDisconnected) and ((_gthis.state.inDisconnected() or _gthis.state.inRetryUnit()))):
                ...
                logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.messageLogger
                if logger.isWarnEnabled():
                    logger.warn((((("Message " + HxOverrides.stringOrNull(((sequence if ((sequence is not None)) else "UNORDERED_MESSAGES")))) + " ") + ("null" if message is None else message)) + " aborted"),None)
                if (listener is not None):
                    dispatcher = com_lightstreamer_client_internal__ClientMachine_ClientMessageDispatcher()
            ...
            if (sequence is not None):
                ...
                logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.actionLogger
                line = ("Message sending requested: " + Std.string(msg))
                if logger.isInfoEnabled():
                    logger.info(line,None)
    ...
    def subscribeExt(self,subscription,isInternal = None):
        ...
        def _hx_local_0():
            ...
            logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.actionLogger
            line = ((((("" + HxOverrides.stringOrNull((("Internal subscription" if isInternal else "Subscription")))) + " requested: subId: ") + Std.string(sm.subId)) + " ") + Std.string(subscription))
            if logger.isInfoEnabled():
                logger.info(line,None)
            sm.evtExtSubscribe()
        com_lightstreamer_internal__RLock_RLock_Impl_.synchronized(self.lock,_hx_local_0)
    ...
    def unsubscribe(self,subscription):
        ...
        def _hx_local_0():
            ...
            if (sm is not None):
                ...
                logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.actionLogger
                line = ((("Unsubscription requested: subId: " + Std.string(sm.subId)) + " ") + Std.string(subscription))
                if logger.isInfoEnabled():
                    logger.info(line,None)
            ...
            def _hx_local_2():
                ...
                while (_g.current < len(_g.array)):
                    def _hx_local_1():
                        ...
                        return _hx_local_0
                    _g1 = python_internal_ArrayImpl._get(_g.array, _hx_local_1())
                    sml = Std.downcast(_g1.value,com_lightstreamer_client_internal_SubscriptionManagerLiving)
                    if (sml is not None):
                        sub = sml.m_subscription
                        if (sub.isActive() and (not sub.isInternal())):
                            ls.append(sub)
                return ls
            return com_lightstreamer_internal__RLock_RLock_Impl_.synchronized(self.lock,_hx_local_2)
        return _hx_local_3()
...
class com_lightstreamer_client_internal__ClientMachine_BestForCreatingEnum(Enum):
    ...
    _hx_constructs = ["BFC_ws", "BFC_http"]
...
class com_lightstreamer_client_internal__ClientMachine_ClientMessageDispatcher(com_lightstreamer_internal_EventDispatcher):
    _hx_class_name = "com.lightstreamer.client.internal._ClientMachine.ClientMessageDispatcher"
    _hx_is_interface = "False"
    __slots__ = ()
    _hx_fields = []
...
com_lightstreamer_client_internal__ClientMachine_ClientMessageDispatcher._hx_class = com_lightstreamer_client_internal__ClientMachine_ClientMessageDispatcher
...
class com_lightstreamer_client_internal_State:
    ...
    def inStreaming(self):
        if (not (((((self.s_w.p if ((self.s_w is not None)) else None)) == 300) or ((((self.s_ws.p if ((self.s_ws is not None)) else None)) == 510))))):
            return (((self.s_hs.p if ((self.s_hs is not None)) else None)) == 810)
        else:
            return True

    def inPolling(self):
        if (not (((((self.s_tr == 220) or ((self.s_tr == 230))) or ((((self.s_wp.p if ((self.s_wp is not None)) else None)) == 611))) or ((((self.s_hp.m if ((self.s_hp is not None)) else None)) == 901))))):
    ...
    def traceState(self):
        logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.internalLogger
        line = ("goto: " + HxOverrides.stringOrNull(self.toString()))
        if logger.isTraceEnabled():
            logger.trace(line,None)
...
class com_lightstreamer_client_internal__MessageManager_MessageEventDispatcher(com_lightstreamer_internal_EventDispatcher):
    _hx_class_name = "com.lightstreamer.client.internal._MessageManager.MessageEventDispatcher"
    _hx_is_interface = "False"
    __slots__ = ()
    _hx_fields = []
    _hx_methods = ["onAbort", "onDeny", "onDiscarded", "onError", "onProcessed"]
...
com_lightstreamer_client_internal__MessageManager_MessageEventDispatcher._hx_class = com_lightstreamer_client_internal__MessageManager_MessageEventDispatcher
...
class com_lightstreamer_client_internal_MessageManager:
    ...
    def __init__(self,txt,sequence,maxWait,delegate,enqueueWhileDisconnected,client):
        ...
        self.lastReqId = None
        self.prog = None
        self.eventDispatcher = com_lightstreamer_client_internal__MessageManager_MessageEventDispatcher()
        self.txt = txt
    ...
    def evtAbort(self):
        ...
        if (_g == 11):
            ...
            logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.messageLogger
            line = (((("Message " + HxOverrides.stringOrNull(self.sequence)) + ":") + Std.string(self.prog)) + " aborted")
            if logger.isWarnEnabled():
                logger.warn(line,None)
            self.finalize()
            self.goto(24)
    ...
    def encodeMsg(self,isWS):
        ...
        if (isOrdered and hasListener):
            ...
            if isWS:
                req.LS_ack(False)
        logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.protocolLogger
        line = ("Sending message: " + Std.string(req))
        if logger.isInfoEnabled():
            logger.info(line,None)
        return req.getEncodedString()
    ...
    def fireOnProcessed(self):
        logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.messageLogger
        line = (((("Message " + HxOverrides.stringOrNull(self.sequence)) + ":") + Std.string(self.prog)) + " processed")
        if logger.isInfoEnabled():
            logger.info(line,None)
    ...
    def fireOnDiscarded(self):
        logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.messageLogger
        line = (((("Message " + HxOverrides.stringOrNull(self.sequence)) + ":") + Std.string(self.prog)) + " discarded")
        if logger.isWarnEnabled():
            logger.warn(line,None)
    ...
    def fireOnDeny(self,code,msg):
        logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.messageLogger
        line = ((((((("Message " + HxOverrides.stringOrNull(self.sequence)) + ":") + Std.string(self.prog)) + " denied: ") + Std.string(code)) + " - ") + ("null" if msg is None else msg))
        if logger.isWarnEnabled():
            logger.warn(line,None)
    ...
    def fireOnError(self):
        logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.messageLogger
        line = (((("Message " + HxOverrides.stringOrNull(self.sequence)) + ":") + Std.string(self.prog)) + " failed")
        if logger.isWarnEnabled():
            logger.warn(line,None)
    ...
    def traceEvent(self,evt):
        logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.internalLogger
        line = ((((((("msg#" + ("null" if evt is None else evt)) + "(") + HxOverrides.stringOrNull(self.sequence)) + ":") + Std.string(self.prog)) + ") in ") + Std.string(self.s_m))
        if logger.isTraceEnabled():
            logger.trace(line,None)
    ...
    def goto(self,target):
        self.s_m = target
        logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.internalLogger
        line = ((((("msg#goto(" + HxOverrides.stringOrNull(self.sequence)) + ":") + Std.string(self.prog)) + ") ") + Std.string(self.s_m))
        if logger.isTraceEnabled():
            logger.trace(line,None)
...
class com_lightstreamer_client_internal_ModeStrategy:
    ...
    def traceEvent(self,evt):
        logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.internalLogger
        line = ((((("sub#mod#" + ("null" if evt is None else evt)) + "(") + Std.string(self.m_subId)) + ") in ") + Std.string(self.s_m))
        if logger.isTraceEnabled():
            logger.trace(line,None)
    ...
    def goto(self,to):
        self.s_m = to
        logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.internalLogger
        line = ((("sub#mod#goto(" + Std.string(self.m_subId)) + ") ") + Std.string(self.s_m))
        if logger.isTraceEnabled():
            logger.trace(line,None)
...
class com_lightstreamer_client_internal__ParseTools_ParseTools_Fields_:
    ...
    _hx_is_interface = "False"
    __slots__ = ()
    _hx_statics = ["parseInt", "parseFloat", "parseUpdate", "checkedIndexOf"]
    ...
    def parseUpdate(message):
        ...
        while (fieldStart < len(message)):
            ...
            if (value == ""):
                ...
                v = com_lightstreamer_internal_FieldValue.changed(python_lib_urllib_Parse.unquote(value))
...
class com_lightstreamer_client_internal__SubscriptionManager_State:
    ...
    def traceState(self):
        logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.internalLogger
        line = ((("sub#goto(" + Std.string(self.subId)) + ") ") + HxOverrides.stringOrNull(self.toString()))
        if logger.isTraceEnabled():
            logger.trace(line,None)
...
class com_lightstreamer_client_internal_SubscriptionManagerLiving:
    ...
    def encodeAdd(self,isWS):
        ...
        if isWS:
            req.LS_ack(False)
        logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.protocolLogger
        line = ("Sending Subscription add: " + Std.string(req))
        if logger.isInfoEnabled():
            logger.info(line,None)
        return req.getEncodedString()
    ...
    def encodeDelete(self,isWS):
        ...
        if isWS:
            req.LS_ack(False)
        logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.protocolLogger
        line = ("Sending Subscription delete: " + Std.string(req))
        if logger.isInfoEnabled():
            logger.info(line,None)
        return req.getEncodedString()
    ...
    def encodeReconf(self,isWS):
        ...
        if (freq is not None):
            ...
            if (tmp == 0):
                ...
                pass
        logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.protocolLogger
        line = ("Sending Subscription configuration: " + Std.string(req))
        if logger.isInfoEnabled():
            logger.info(line,None)
        return req.getEncodedString()
    ...
    def traceEvent(self,evt):
        logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.internalLogger
        line = ((((("sub#" + ("null" if evt is None else evt)) + "(") + Std.string(self.subId)) + ") in ") + Std.string(self.state))
        if logger.isTraceEnabled():
            logger.trace(line,None)
...
class com_lightstreamer_client_internal_SubscriptionManagerZombie:
    ...
    def traceEvent(self,evt):
        logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.internalLogger
        line = ((((("zsub#" + ("null" if evt is None else evt)) + "(") + Std.string(self.subId)) + ") in ") + Std.string(self.s_m))
        if logger.isTraceEnabled():
            logger.trace(line,None)
    ...
    def goto(self,target):
        self.s_m = target
        logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.internalLogger
        line = ((("zsub#goto(" + Std.string(self.subId)) + ") ") + Std.string(self.s_m))
        if logger.isTraceEnabled():
            logger.trace(line,None)
...
class com_lightstreamer_client_internal_update_ItemBase:
        ...
        def _hx_local_1():
            def _hx_local_0():
                if (_gthis.currValues is not None):
                    return _gthis.currValues.h.get(fieldIdx,None)
                else:
                    return None
            return com_lightstreamer_internal__RLock_RLock_Impl_.synchronized(self.lock,_hx_local_0)
        return _hx_local_1()
    ...
    def doUpdate(self,values,snapshot):
        ...
        self.currValues = com_lightstreamer_client_internal_update__UpdateUtils_UpdateUtils_Fields_.mapUpdateValues(prevValues,values)
        ...
        update = com_lightstreamer_client_internal_update_ItemUpdateBase(self.itemIdx,self.subscription,self.currValues,changedFields,snapshot)
...
class com_lightstreamer_client_internal_update_ItemCommand(com_lightstreamer_client_internal_update_ItemBase):
    ...
    def doUpdate(self,values,snapshot):
        self.currValues = com_lightstreamer_client_internal_update__UpdateUtils_UpdateUtils_Fields_.mapUpdateValues(self.currValues,values)
    ...
    def goto(self,to):
        self.s_m = to
        logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.internalLogger
        line = ((((("sub#itm#goto(" + Std.string(self.m_subId)) + ":") + Std.string(self.itemIdx)) + ") in ") + Std.string(self.s_m))
        if logger.isTraceEnabled():
            logger.trace(line,None)

    def traceEvent(self,evt):
        logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.internalLogger
        line = ((((((("sub#itm#" + ("null" if evt is None else evt)) + "(") + Std.string(self.m_subId)) + ":") + Std.string(self.itemIdx)) + ") in ") + Std.string(self.s_m))
        if logger.isTraceEnabled():
            logger.trace(line,None)
...
class com_lightstreamer_client_internal_update_ItemDistinct(com_lightstreamer_client_internal_update_ItemBase):
    ...
    def goto(self,to):
        self.s_m = to
        logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.internalLogger
        line = ((((("sub#itm#goto(" + Std.string(self.m_subId)) + ":") + Std.string(self.itemIdx)) + ") ") + Std.string(self.s_m))
        if logger.isTraceEnabled():
            logger.trace(line,None)
...
class com_lightstreamer_client_internal_update_ItemUpdate2Level:
    _hx_class_name = "com.lightstreamer.client.internal.update.ItemUpdate2Level"
    _hx_is_interface = "False"
    __slots__ = ("m_itemIdx", "m_items", "m_nFields", "m_fields", "m_fields2", "m_newValues", "m_changedFields", "m_isSnapshot")
    _hx_fields = ["m_itemIdx", "m_items", "m_nFields", "m_fields", "m_fields2", "m_newValues", "m_changedFields", "m_isSnapshot"]
    _hx_methods = ["getItemName", "getItemPos", "isSnapshot", "getValue", "isValueChanged", "getChangedFields", "getChangedFieldsByPosition", "getFields", "getFieldsByPosition", "getValuePos", "getValueName", "isValueChangedPos", "isValueChangedName", "getFieldNameFromIdx", "getFieldNameOrNullFromIdx", "getFieldIdxFromName", "toString"]
    _hx_interfaces = [ItemUpdate]

    def __init__(self,itemIdx,sub,newValues,changedFields,isSnapshot):
        items = sub.getItems()
    ...
    def getChangedFields(self):
        ...
        while (_g.current < len(_g.array)):
            ...
            v = self.m_newValues.h.get(fieldPos,None)
            res.h[k] = v
    ...
    def getFieldsByPosition(self):
        return com_lightstreamer_internal__NativeTypes_NativeIntMap_Impl_._new(self.m_newValues)

    def getValuePos(self,fieldPos):
        return self.m_newValues.h.get(fieldPos,None)
...
class com_lightstreamer_client_internal_update_ItemUpdateBase:
    _hx_class_name = "com.lightstreamer.client.internal.update.ItemUpdateBase"
    _hx_is_interface = "False"
    __slots__ = ("m_itemIdx", "m_items", "m_nFields", "m_fields", "m_newValues", "m_changedFields", "m_isSnapshot")
    _hx_fields = ["m_itemIdx", "m_items", "m_nFields", "m_fields", "m_newValues", "m_changedFields", "m_isSnapshot"]
    _hx_methods = ["getItemName", "getItemPos", "isSnapshot", "getValue", "isValueChanged", "getChangedFields", "getChangedFieldsByPosition", "getFields", "getFieldsByPosition", "getValuePos", "getValueName", "isValueChangedPos", "isValueChangedName", "getFieldNameOrNullFromIdx", "toString"]
    _hx_interfaces = [ItemUpdate]
    ...
    def getFields(self):
        ...
        while _g_keys.hasNext():
            key = _g_keys.next()
            _g_value = this1.get(key)
            v = self.m_newValues.h.get(key,None)
            res.h[_g_value] = v
        return com_lightstreamer_internal__NativeTypes_NativeStringMap_Impl_._new(res)
...
class com_lightstreamer_client_internal_update_Key1Level:
        ...
        def _hx_local_1():
            def _hx_local_0():
                if (_gthis.currKeyValues is not None):
                    return _gthis.currKeyValues.h.get(fieldIdx,None)
                else:
                    return None
            return com_lightstreamer_internal__RLock_RLock_Impl_.synchronized(self.lock,_hx_local_0)
        return _hx_local_1()
    ...
    def doFirstUpdate(self,keyValues,snapshot):
        ...
        cmdIdx = com_lightstreamer_internal_NullTools.sure(self.item.subscription.getCommandPosition())
        self.currKeyValues = keyValues
        self.currKeyValues.set(cmdIdx,"ADD")
        changedFields = com_lightstreamer_internal_Set(IntIterator(1,(nFields + 1)))
        self.fireOnItemUpdate(com_lightstreamer_client_internal_update_ItemUpdateBase(self.item.itemIdx,self.item.subscription,self.currKeyValues,changedFields,snapshot))

    def doUpdate(self,keyValues,snapshot):
        cmdIdx = com_lightstreamer_internal_NullTools.sure(self.item.subscription.getCommandPosition())
        prevKeyValues = self.currKeyValues
        self.currKeyValues = keyValues
        self.currKeyValues.set(cmdIdx,"UPDATE")
    ...
    def doLightDelete(self,keyValues,snapshot):
        ...
        update = com_lightstreamer_client_internal_update_ItemUpdateBase(self.item.itemIdx,self.item.subscription,self.nullify(keyValues),changedFields,snapshot)
        self.item.unrelate(self.keyName)
        self.fireOnItemUpdate(update)

    def doDelete(self,keyValues,snapshot):
        self.currKeyValues = None
        changedFields = com_lightstreamer_internal_Set(keyValues.keys()).subtracting([com_lightstreamer_internal_NullTools.sure(self.item.subscription.getKeyPosition())])
        update = com_lightstreamer_client_internal_update_ItemUpdateBase(self.item.itemIdx,self.item.subscription,self.nullify(keyValues),changedFields,snapshot)
        self.item.unrelate(self.keyName)
        self.fireOnItemUpdate(update)
    ...
    def isDelete(self,keyValues):
        key = com_lightstreamer_internal_NullTools.sure(self.item.subscription.getCommandPosition())
        return (keyValues.h.get(key,None) == "DELETE")
    ...
    def traceEvent(self,evt):
        if com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.internalLogger.isTraceEnabled():
            com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.internalLogger.trace(((((((((("sub#key#" + ("null" if evt is None else evt)) + "(") + Std.string(self.item.m_subId)) + ":") + Std.string(self.item.itemIdx)) + ":") + HxOverrides.stringOrNull(self.keyName)) + ") in ") + Std.string(self.s_m)))
...
class com_lightstreamer_client_internal_update_Key2Level:
        ...
        def _hx_local_1():
            def _hx_local_0():
                ...
                if ((values is not None) and ((values.h.get(fieldIdx,None) is not None))):
                    return values.h.get(fieldIdx,None)
                else:
    ...
    def doFirstUpdate(self,keyValues,snapshot):
        ...
        self.fireOnItemUpdate(com_lightstreamer_client_internal_update_ItemUpdate2Level(self.item.itemIdx,self.item.subscription,self.currKeyValues,changedFields,snapshot))
    ...
    def doUpdate2Level(self,update):
        ...
        while _g_keys.hasNext():
            key = _g_keys.next()
            extKeyValues.set((key + nFields),this1.get(key))
        changedFields = com_lightstreamer_internal_Set()
        if (prevKeyValues.h.get(cmdIdx,None) != self.currKeyValues.h.get(cmdIdx,None)):
        ...
        self.fireOnItemUpdate(com_lightstreamer_client_internal_update_ItemUpdate2Level(self.item.itemIdx,self.item.subscription,extKeyValues,changedFields,snapshot))
    ...
    def doUpdate1Level(self,keyValues,snapshot):
        ...
        while (_g < _g1):
            f = _g
            _g = (_g + 1)
            if (prevKeyValues.h.get(f,None) != extKeyValues.h.get(f,None)):
                changedFields.insert(f)
        self.fireOnItemUpdate(com_lightstreamer_client_internal_update_ItemUpdate2Level(self.item.itemIdx,self.item.subscription,extKeyValues,changedFields,snapshot))

    def doDelete(self,keyValues,snapshot):
        n = com_lightstreamer_internal_NullTools.sure(self.item.subscription.fetch_nFields())
        keyIdx = com_lightstreamer_internal_NullTools.sure(self.item.subscription.getKeyPosition())
        cmdIdx = com_lightstreamer_internal_NullTools.sure(self.item.subscription.getCommandPosition())
        self.currKeyValues = None
        ...
        extKeyValues.set(keyIdx,self.keyName)
        extKeyValues.set(cmdIdx,"DELETE")
        update = com_lightstreamer_client_internal_update_ItemUpdate2Level(self.item.itemIdx,self.item.subscription,extKeyValues,changedFields,snapshot)
        self.item.unrelate(self.keyName)
    ...
    def doLightDelete(self,keyValues,snapshot):
        ...
        values.set(cmdIdx,v)
        self.fireOnItemUpdate(com_lightstreamer_client_internal_update_ItemUpdate2Level(self.item.itemIdx,self.item.subscription,values,changedFields,snapshot))
    ...
    def create2LevelSubscription(self):
        ...
        sub2 = Subscription("MERGE",None,None)
        items = [self.keyName]
...
class com_lightstreamer_client_internal_update__Key2Level_Sub2LevelDelegate:
    ...
    _hx_interfaces = [SubscriptionListener]
...
class com_lightstreamer_client_internal_update__UpdateUtils_UpdateUtils_Fields_:
    ...
    _hx_is_interface = "False"
    __slots__ = ()
    _hx_statics = ["mapUpdateValues", "findChangedFields", "toMap", "findFirstIndex", "getFieldsByPosition", "getChangedFieldsByPosition"]

    @staticmethod
    def mapUpdateValues(oldValues,values):
        if (oldValues is not None):
            ...
            while _g_keys.hasNext():
                ...
                tmp = _g_value.index
                if (tmp == 0):
                    v = oldValues.h.get(key,None)
                    newValues.set(key,v)
                elif (tmp == 1):
                    newValues.set(key,_g_value.params[0])
                else:
                    pass
            return newValues
        else:
            ...
            while _g_keys.hasNext():
                ...
                if (_g_value.index == 1):
                    ...
                    raise com_lightstreamer_internal_IllegalStateException("Unexpected value")
            return newValues
    ...
    def findChangedFields(prev,curr):
        if (prev is not None):
            ...
            while _g_keys.hasNext():
                key = _g_keys.next()
                _hx_map.get(key)
                if (prev.h.get(key,None) != curr.h.get(key,None)):
...
class com_lightstreamer_internal__AssocArray_AssocArray_Impl_:
    ...
    def arrayWrite(this1,key,value):
        x = com_lightstreamer_internal__AssocArray_AssocPair(key,value)
        this1.append(x)
        return value
    ...
    def remove(this1,key):
        def _hx_local_0(p):
            return (p.key == key)
        i = Lambda.findIndex(this1,_hx_local_0)
        if (i != -1):
            pos = i
            if (i < 0):
                pos = (len(this1) + i)
    ...
    def keyValueIterator(this1):
        return haxe_iterators_ArrayIterator(this1)

    @staticmethod
    def containsValue(this1,val):
        _g = com_lightstreamer_internal__AssocArray_AssocArray_Impl_.keyValueIterator(this1)
        while (_g.current < len(_g.array)):
            def _hx_local_1():
                _hx_local_0 = _g.current
                _g.current = (_g.current + 1)
                return _hx_local_0
            _g1 = python_internal_ArrayImpl._get(_g.array, _hx_local_1())
            if HxOverrides.eq(_g1.value,val):
                return True
        return False
...
class com_lightstreamer_internal_DummyReachabilityManager:
    _hx_class_name = "com.lightstreamer.internal.DummyReachabilityManager"
    _hx_is_interface = "False"
    __slots__ = ()
    _hx_methods = ["startListening", "stopListening"]
...
com_lightstreamer_internal_DummyReachabilityManager._hx_class = com_lightstreamer_internal_DummyReachabilityManager
...
class com_lightstreamer_internal_HttpClient(com_lightstreamer_internal_HttpClientPy):
    ...
    def __init__(self,url,body,headers,proxy,sslContext,onText,onError,onDone):
        ...
        self.onText = None
        super().__init__()
        logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.streamLogger
        line = ("null" if ((headers is None)) else headers.toString())
        if logger.isDebugEnabled():
            logger.debug((((((("HTTP sending: " + ("null" if url is None else url)) + " ") + ("null" if body is None else body)) + " headers(") + ("null" if line is None else line)) + ")"),None)
        self.onText = onText
    ...
    def dispose(self):
        logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.streamLogger
        if logger.isDebugEnabled():
            logger.debug("HTTP disposing",None)
        super().dispose()

    def on_text(self,client,line):
        logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.streamLogger
        if logger.isDebugEnabled():
            logger.debug((("HTTP event: text(" + ("null" if line is None else line)) + ")"),None)
    ...
    def on_error(self,client,error):
        ...
        logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.streamLogger
        if logger.isDebugEnabled():
            logger.debug((("HTTP event: error(" + ("null" if msg is None else msg)) + ")"),error)
        self.onError(self,msg)

    def on_done(self,client):
        logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.streamLogger
        if logger.isDebugEnabled():
            logger.debug("HTTP event: complete",None)
        self.onDone(self)
...
class com_lightstreamer_internal_Timer:
    ...
    def __init__(self,id,delay,callback):
        ...
        def _hx_local_0():
            callback(_gthis)
        self.task = com_lightstreamer_internal_Timer.executor.submit(hx_concurrent_internal__Either2__Either2.a(_hx_local_0),hx_concurrent_executor_Schedule.ONCE(delay))
...
class com_lightstreamer_internal_FieldValue(Enum):
    ...
    _hx_constructs = ["unchanged", "changed"]
...
class com_lightstreamer_internal_WsClient(com_lightstreamer_internal_WsClientPy):
    ...
    def __init__(self,url,headers,proxy,sslContext,onOpen,onText,onError):
        ...
        line = ("null" if ((headers is None)) else headers.toString())
        if logger.isDebugEnabled():
            logger.debug((((("WS connecting: " + ("null" if url is None else url)) + " headers(") + ("null" if line is None else line)) + ")"),None)
        self.onOpen = onOpen
        self.onText = onText
        self.onError = onError
    ...
    def send(self,txt):
        logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.streamLogger
        if logger.isDebugEnabled():
            logger.debug(("WS sending: " + ("null" if txt is None else txt)),None)
        self.sendAsync(txt)

    def dispose(self):
        logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.streamLogger
        if logger.isDebugEnabled():
            logger.debug("WS disposing",None)
        super().dispose()

    def on_open(self,client):
        logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.streamLogger
        if logger.isDebugEnabled():
            logger.debug("WS event: open",None)
        self.onOpen(self)

    def on_text(self,client,line):
        logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.streamLogger
        if logger.isDebugEnabled():
            logger.debug((("WS event: text(" + ("null" if line is None else line)) + ")"),None)
        self.onText(self,line)
    ...
    def on_error(self,client,error):
        ...
        logger = com_lightstreamer_log__LoggerTools_LoggerTools_Fields_.streamLogger
        if logger.isDebugEnabled():
            logger.debug((("WS event: error(" + ("null" if msg is None else msg)) + ")"),error)
        self.onError(self,msg)
...
class com_lightstreamer_log_LoggerProvider:
    pass
...
class com_lightstreamer_log_Logger:
    pass


class com_lightstreamer_log__ConsoleLoggerProvider_ConsoleLogger:

    def __init__(self,level,category):
        self.level = level
        self.category = category
        self.traceEnabled = (level <= ConsoleLogLevel.TRACE)
        self.debugEnabled = (level <= ConsoleLogLevel.DEBUG)
        self.infoEnabled = (level <= ConsoleLogLevel.INFO)
        self.warnEnabled = (level <= ConsoleLogLevel.WARN)
        self.errorEnabled = (level <= ConsoleLogLevel.ERROR)
        self.fatalEnabled = (level <= ConsoleLogLevel.FATAL)

    def printLog(self,msg):
        python_Lib.printString((("" + Std.string(msg)) + HxOverrides.stringOrNull(python_Lib.lineEnd)))

    def log(self,level,line,exception = None):
        Date.now().toString()
        pyTime = str(python_lib_datetime_Datetime.now())
        pyThread = python_lib_Threading.current_thread().name
        python_Lib.printString((("" + Std.string(((((((((("" + ("null" if pyTime is None else pyTime)) + "|") + ("null" if level is None else level)) + "|") + HxOverrides.stringOrNull(self.category)) + "|") + ("null" if pyThread is None else pyThread)) + "|") + ("null" if line is None else line)))) + HxOverrides.stringOrNull(python_Lib.lineEnd)))
        if (exception is not None):
            python_Lib.printString((("" + Std.string(haxe_Exception.caught(exception).details())) + HxOverrides.stringOrNull(python_Lib.lineEnd)))

    def fatal(self,line,exception = None):
        if self.fatalEnabled:
            self.log("FATAL",line,exception)

    def error(self,line,exception = None):
        if self.errorEnabled:
            self.log("ERROR",line,exception)

    def warn(self,line,exception = None):
        if self.warnEnabled:
            self.log("WARN ",line,exception)

    def info(self,line,exception = None):
        if self.infoEnabled:
            self.log("INFO ",line,exception)

    def debug(self,line,exception = None):
        if self.debugEnabled:
            self.log("DEBUG",line,exception)

    def trace(self,line,exception = None):
        if self.traceEnabled:
            self.log("TRACE",line,exception)
...
class com_lightstreamer_log__LogManager_EmptyLogger:
...
class com_lightstreamer_log__LogManager_LoggerProxy:
...
class com_lightstreamer_log__LoggerTools_LoggerTools_Fields_:
    ...
    _hx_is_interface = "False"
    __slots__ = ()
    _hx_statics = ["streamLogger", "protocolLogger", "internalLogger", "sessionLogger", "actionLogger", "reachabilityLogger", "subscriptionLogger", "messageLogger", "cookieLogger", "logFatal", "logError", "logErrorEx", "logWarn", "logInfo", "logDebug", "logDebugEx", "logTrace"]

    @staticmethod
    def logFatal(logger,line,exception = None):
        if logger.isFatalEnabled():
            logger.fatal(line,exception)

    @staticmethod
    def logError(logger,line,exception = None):
        if logger.isErrorEnabled():
            logger.error(line,exception)

    @staticmethod
    def logErrorEx(logger,line,exception):
        if logger.isErrorEnabled():
            logger.error(((("null" if line is None else line) + "\n") + HxOverrides.stringOrNull(exception.details())))

    @staticmethod
    def logWarn(logger,line,exception = None):
        if logger.isWarnEnabled():
            logger.warn(line,exception)

    @staticmethod
    def logInfo(logger,line,exception = None):
        if logger.isInfoEnabled():
            logger.info(line,exception)

    @staticmethod
    def logDebug(logger,line,exception = None):
        if logger.isDebugEnabled():
            logger.debug(line,exception)

    @staticmethod
    def logDebugEx(logger,line,exception):
        if logger.isDebugEnabled():
            logger.debug(((("null" if line is None else line) + "\n") + HxOverrides.stringOrNull(exception.details())))

    @staticmethod
    def logTrace(logger,line,exception = None):
        if logger.isTraceEnabled():
    ...
    def run(self):
        ...
        if (fn is not None):
            try:
                ...
                None
                haxe_Log.trace(haxe_Exception.caught(_g).unwrap(),_hx_AnonObject({'fileName': "hx/concurrent/executor/ThreadPoolExecutor.hx", 'lineNumber': 217, 'className': "hx.concurrent.executor._ThreadPoolExecutor.TaskFutureImpl", 'methodName': "run"}))
        ...
        if (fn is not None):
            try:
                ...
                None
                haxe_Log.trace(haxe_Exception.caught(_g).unwrap(),_hx_AnonObject({'fileName': "hx/concurrent/executor/ThreadPoolExecutor.hx", 'lineNumber': 219, 'className': "hx.concurrent.executor._ThreadPoolExecutor.TaskFutureImpl", 'methodName': "run"}))
    ...
    def run(self):
        ...
        if (fn is not None):
            try:
                ...
                None
                haxe_Log.trace(haxe_Exception.caught(_g).unwrap(),_hx_AnonObject({'fileName': "hx/concurrent/executor/TimerExecutor.hx", 'lineNumber': 114, 'className': "hx.concurrent.executor._TimerExecutor.TaskFutureImpl", 'methodName': "run"}))
        fn = self._executor.onResult
        if (fn is not None):
            try:
                fn(result)
                ...
                None
                haxe_Log.trace(haxe_Exception.caught(_g).unwrap(),_hx_AnonObject({'fileName': "hx/concurrent/executor/TimerExecutor.hx", 'lineNumber': 116, 'className': "hx.concurrent.executor._TimerExecutor.TaskFutureImpl", 'methodName': "run"}))
...
com_lightstreamer_internal__Constants_Constants_Fields_.TLCP_VERSION = "TLCP-2.3.0"
...
com_lightstreamer_internal__Constants_Constants_Fields_.LS_LIB_VERSION = "1.0.0-beta.1 build 20220624"
com_lightstreamer_internal__Constants_Constants_Fields_.LS_CID = "v Wntytg4pkpW36AK3M5hgWg4CHfDprfc85DM4S9Ax"
LightstreamerClient.LIB_NAME = com_lightstreamer_internal__Constants_Constants_Fields_.LS_LIB_NAME
LightstreamerClient.LIB_VERSION = com_lightstreamer_internal__Constants_Constants_Fields_.LS_LIB_VERSION
...
com_lightstreamer_internal_Timer.executor = hx_concurrent_executor_Executor.create()
...
ConsoleLogLevel.DEBUG = 10
ConsoleLogLevel.INFO = 20
ConsoleLogLevel.WARN = 30
ConsoleLogLevel.ERROR = 40
ConsoleLogLevel.FATAL = 50
