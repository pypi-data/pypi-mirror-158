...
setup(
    ...
    version='0.1.1',
    description='SageMaker Spider',
    long_description=readme,
    long_description_content_type='text/markdown',
    author='SuperCowPowers LLC',
    author_email='support@supercowpowers.com',
    url='https://github.com/SuperCowPowers/sagemaker_spider',
    ...
    keywords='SageMaker, Machine Learning, AWS, Python, Spider',
    classifiers=[
