...
class Binomial(Distribution):
    ...
    def plot_bar(self):
        ...
        plt.bar(x = ['1', '0'], y = [(1 - self.p) * self.n, self.p * self.n], color = 'green' )
    ...
    def pdf(self, k):
        ...
        permutation = math.factorial(self.n)/(math.factorial(k) * math.factorial(self.n - k))
        trials = math.pow(self.p, k) * math.pow((1 - self.p), (self.n - k))

        pdf  = permutation * trials
    ...
    def plot_bar_pdf(self):
        ...
        plt.title('pdf of Data outcomes')
    ...
    def __repr__(self):
        ...
        return "mean {}, standard deviateion {}, p{}, n{}".\
