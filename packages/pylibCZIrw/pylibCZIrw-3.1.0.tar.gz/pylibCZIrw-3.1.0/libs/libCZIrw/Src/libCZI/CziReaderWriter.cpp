...
/*virtual*/void CCziReaderWriter::EnumerateSubBlocks(std::function<bool(int index, const libCZI::SubBlockInfo& info)> funcEnum)
{
    this->ThrowIfNotOperational();
    this->sbBlkDirectory.EnumEntries(
...
/*virtual*/void CCziReaderWriter::EnumSubset(const libCZI::IDimCoordinate* planeCoordinate, const libCZI::IntRect* roi, bool onlyLayer0, std::function<bool(int index, const libCZI::SubBlockInfo& info)> funcEnum)
{
    this->ThrowIfNotOperational();
...
/*virtual*/void CCziReaderWriter::EnumerateAttachments(std::function<bool(int index, const libCZI::AttachmentInfo& info)> funcEnum)
{
    this->ThrowIfNotOperational();
    this->attachmentDirectory.EnumEntries(
...
/*virtual*/void CCziReaderWriter::EnumerateSubset(const char* contentFileType, const char* name, std::function<bool(int index, const libCZI::AttachmentInfo& infi)> funcEnum)
{
    this->ThrowIfNotOperational();
    throw std::runtime_error("Not Implemented");
}
