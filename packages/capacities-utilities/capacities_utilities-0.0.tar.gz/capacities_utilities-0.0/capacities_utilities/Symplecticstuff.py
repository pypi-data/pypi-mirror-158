...
class Symplectic:
	...
	J0 = Quaternion.rotation(Quaternion.e2, Quaternion.e1)
	
	#K_0 definition (left multiplication by j)
	K0 = Quaternion.rotation(Quaternion.e3, Quaternion.e1)
	
	#L_0 definition (left multiplication by k)
	L0 = Quaternion.rotation(Quaternion.e4, Quaternion.e1)
