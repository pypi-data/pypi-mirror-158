...
setup(
    ...
    name="scresonators_fit",  # Required
    ...
    install_requires=["attr==0.3.*", "inflect==2.1.*", "lmfit==0.9.*", "matplotlib>=3.0.*", "numpy==1.16.*", "pandas==0.24.*", "pylabrad==0.97.*" ,"pytest==7.1.*", "scipy==1.3.*", "sympy==1.4.*", "scikit-rf==0.19.*"],  # Optional
