...
@LastEditTime: 2022-07-07 18:51:35
...
class TaskBaseModel(FrameBaseModel):
    ...
    def process_invite_user(self,app_id,act_id,module_id,user_id,login_token,from_user_id,handler_name,check_user_nick=True,check_new_user=True,continue_request_expire=5,close_invite_limit=False,is_stat=True):
        """
        ...
        try:
            ...
            if invoke_result_data.success == True:
                ...
                if is_stat == True:
                    key_list_dict = {}
                    key_list_dict["BeInvitedUserCount"] = 1  #邀请进入人数
                    key_list_dict["BeInvitedCount"] = 1  #邀请进入次数
                    if user_info_dict["is_new"] == 1:
                        key_list_dict["AddBeInvitedUserCount"] = 1  #邀请进入新增用户数
                    stat_base_model.add_stat_list(app_id, act_id, module_id, user_id,  user_info_dict["open_id"], key_list_dict)
