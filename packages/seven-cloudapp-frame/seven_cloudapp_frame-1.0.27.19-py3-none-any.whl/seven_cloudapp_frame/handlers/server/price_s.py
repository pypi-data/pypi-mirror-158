...
@LastEditTime: 2022-06-30 10:40:59
...
class PriceGearListHandler(ClientBaseHandler):
    ...
    def get_async(self):
        ...
        page_list, total = PriceBaseModel(context=self).get_price_gear_list(app_id, act_id, page_size, page_index, is_del=is_del, is_cache=False)
