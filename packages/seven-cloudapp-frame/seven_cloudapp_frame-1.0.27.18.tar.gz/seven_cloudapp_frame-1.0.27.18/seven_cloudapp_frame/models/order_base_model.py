...
@LastEditTime: 2022-07-06 10:59:53
...
class OrderBaseModel(FrameBaseModel):
    ...
    def update_prize_order_receive_address(self, app_id, act_id, prize_order_id, province, city, county, street, address, real_name, telephone):
        """
        ...
        if prize_order.app_id != app_id:
            ...
            invoke_result_data.error_message ="奖品订单信息不存在-2"
            return invoke_result_data
        prize_order_model.update_table("province=%s,city=%s,county=%s,street=%s,address=%s,real_name=%s,telephone=%s,modify_date=%s", "id=%s", [province, city, county, street, address, real_name, telephone, now_datetime, prize_order_id])
        return invoke_result_data
