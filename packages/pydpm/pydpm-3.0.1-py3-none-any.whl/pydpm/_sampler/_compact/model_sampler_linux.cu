...
extern "C" void _crt_multi_aug(int* Params, float* X_Values, float* X_Rows, float* X_Cols, float* Phi, float* Theta, float* XVK, float* XKJ, curandStateXORWOW_t* status){
...
extern "C" void _multi_aug(int* Params, float* X_Values, float* X_Rows, float* X_Cols, float* Phi, float* Theta, float* XVK, float* XKJ, curandStateXORWOW_t* status){
...
extern "C" void _conv_multi_aug(int* Params, float* X_Rows, float* X_Cols, float* X_Pages, float* X_Values, float* D1_k1, float* W1_nk1, float* D1_k1_Aug, float* W1_nk1_Aug, curandStateXORWOW_t* status){
