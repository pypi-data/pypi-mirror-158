...
Report bugs at [https://github.com/boromir674/pytest-requests-futures/issues](https://github.com/boromir674/pytest-requests-futures/issues).
W
Stambling upon a Bug means encountering different behaviour than the expected/advertised one. When you are reporting a bug, please include the following infromation by filling in [the template](https://github.com/boromir674/pytest-requests-futures/.github/blob/master/.github/ISSUE_TEMPLATE/bug_report.md).
...
Mocking Requests Futures could always use more documentation, whether as part of the official Mocking Requests Futures docs, in docstrings, etc.
...
The best way to send feedback is to file an issue at [https://github.com/boromir674/pytest-requests-futures/issues](https://github.com/boromir674/pytest-requests-futures/issues).
...
Here's how to set up `pytest-requests-futures` for local development.

1. Fork the `pytest-requests-futures` repo on GitHub.
2. Clone your fork locally:

```bash
git clone git@github.com:boromir674/pytest-requests-futures.git
```

3. Install your local copy into a virtualenv. Assuming you have virtualenv installed, this is how you set up your fork for local development:

```bash
cd pytest-requests-futures
...
Mocking Requests Futures is designed to do one thing, and do that one thing very well.
...
The roadmap located [here](https://github.com/boromir674/pytest-requests-futures/milestones?direction=desc&sort=due_date&state=open)
