...
class FLNetwork(QtCore.QObject):
    ...
    def __init__(self, url: str) -> None:
        ...
        cast(QtCore.pyqtSignal, self.manager.finished).connect(  # type: ignore [attr-defined]
    ...
    def get(self, location: str) -> None:
        ...
        cast(QtCore.pyqtSignal, self.reply.downloadProgress).connect(  # type: ignore [attr-defined]
            self._slotNetworkProgress
        )
    ...
    def put(self, data: Any, location: str) -> None:
        ...
        try:
            ...
            pass
        cast(QtCore.pyqtSignal, self.reply.uploadProgress).connect(  # type: ignore [attr-defined]
            self._slotNetworkProgress
        )
