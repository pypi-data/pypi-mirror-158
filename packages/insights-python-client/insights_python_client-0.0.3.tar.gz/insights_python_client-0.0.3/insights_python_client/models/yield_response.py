...
class YieldResponse(object):
    ...
    def __init__(self, id=None, created_date_time=None, modified_date_time=None, status=None, properties=None, tenant_type=None, boundary_id=None, external_id=None, model_type=None, org_id=None, crop=None, crop_variety=None, potential_yield=None, prediction_date=None, data=None):  # noqa: E501
