...
class tSnapMsgReq(mettle.io.ISerializable, mettle.db.IPrimaryKey):
    ...
    notype_id: str = dataclasses.field(default='', compare=True, hash=True)
    tot_req: int = dataclasses.field(default=0, compare=False)
    tot_proc: int = dataclasses.field(default=0, compare=False)
    tot_cancelled: int = dataclasses.field(default=0, compare=False)
    tot_part_canc: int = dataclasses.field(default=0, compare=False)
    tot_msgs: int = dataclasses.field(default=0, compare=False)
    tot_msgs_sent: int = dataclasses.field(default=0, compare=False)
    tot_msgs_failed: int = dataclasses.field(default=0, compare=False)
    tot_msgs_retrys: int = dataclasses.field(default=0, compare=False)
