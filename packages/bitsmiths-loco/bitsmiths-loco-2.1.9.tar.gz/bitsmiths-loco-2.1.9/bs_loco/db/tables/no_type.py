...
class tNoType(mettle.io.ISerializable, mettle.db.IPrimaryKey):
    ...
    grp: str = dataclasses.field(default='', compare=False)
    priority: int = dataclasses.field(default=0, compare=False)
    pref_corr: typing.Optional[dict] = dataclasses.field(default=None, compare=False)
    corr_cnt: int = dataclasses.field(default=0, compare=False)
    max_life: int = dataclasses.field(default=0, compare=False)
