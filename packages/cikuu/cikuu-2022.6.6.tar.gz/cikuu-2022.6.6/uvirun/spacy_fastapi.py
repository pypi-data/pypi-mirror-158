...
def doc_desc(dic:dict = {"Person=1":"第一人称","Person=3":"第三人称","Number=Sing":"单数", "AUX":"助动词", "VERB":"动词", "NOUN":"名词", "ADJ":"形容词", "ADV":"副词", "PRON":"代词","dobj":"宾语", 'nsubj':'主语','ROOT':"谓语", "acomp":"表语", "Tense=Pres":"现在时", "Tense=Past":"过去时"}
	...
	[ lat[t.i].append( dic[t.dep_] if t.dep_ == 'ROOT' else f"单词<span class='{t.head.pos_} {t.head.tag_}'>{t.head.text}</span>的{dic[t.dep_]}" )  for t in doc if t.dep_ in dic and t.head.i == predi ] # only show the first level, the direct child of pred 
