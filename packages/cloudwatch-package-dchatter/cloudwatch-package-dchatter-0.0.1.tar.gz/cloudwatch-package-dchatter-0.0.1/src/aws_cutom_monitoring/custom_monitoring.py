...
email: dibyanshu.chatterjee@phoenix.edu
referred from: AWS's official website

The purpose of this api is to get metrics from aws cloudwatch.
It uses setting of alarms to notify any data losses
"""
...
def main():
    """
    Description - makes a call for the api to run

     Variables like minutes, period and eval_periods could be customized as needed.
    """
    ...
    alarm_name = 'anomaly in metric name'
    period = 60
    eval_periods = 2
