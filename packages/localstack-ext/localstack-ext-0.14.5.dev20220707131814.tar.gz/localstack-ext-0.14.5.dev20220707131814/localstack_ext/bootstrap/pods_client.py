...
class CloudPodsVersionManager(CloudPodsManager):
	...
	def _add_state_to_cloud_pods_store(A,extract_assets=_A,services=_B):
		...
		B=B or A.pods_api.config_context.get_services_from_config();G=get_state_zip_from_instance(get_content=_C,services=B);D=ServiceStateMarshaller.unmarshall(G)
