...
@pro_aws_provider()
def apigatewayv2():from localstack_ext.services.apigateway.provider_v2 import ApiGatewayV2Provider as B;A=B();C=AwsApiListener(_A,A);return Service(_A,listener=C,lifecycle_hook=A,backend_state_lifecycle=A)
@pro_aws_provider(api=_A,name=_O)
def apigatewayv2_asf():from localstack_ext.services.apigateway.provider_v2_asf import AsfApiGatewayV2Provider as B;A=B();C=AwsApiListener(_A,A);return Service(_A,listener=C,lifecycle_hook=A)
@pro_aws_provider()
...
def application_autoscaling():from localstack_ext.services.applicationautoscaling.provider import ApplicationAutoscalingProvider as B;A=B();return Service(_E,listener=AwsApiListener(_E,MotoFallbackDispatcher(A)),lifecycle_hook=A,backend_state_lifecycle=A)
@pro_aws_provider()
...
@pro_aws_provider()
def autoscaling():B='autoscaling';from localstack_ext.services.autoscaling.provider import AutoscalingProvider as C;A=C();return Service(B,listener=AwsApiListener(B,MotoFallbackDispatcher(A)),backend_state_lifecycle=A)
@pro_aws_provider()
...
def cognito_identity():from localstack_ext.services.cognito_identity.provider import CognitoIdentityAWSApiListener as B;A=B();return Service(_P,listener=A,lifecycle_hook=A.provider,backend_state_lifecycle=A.provider)
@pro_aws_provider(api=_F)
def cognito_idp():from localstack_ext.services.cognito_idp.provider import CognitoIdpProvider as B;A=B();return Service(_F,listener=AwsApiListener(_F,A),lifecycle_hook=A,backend_state_lifecycle=A)
@pro_aws_provider()
...
def iot_data():from localstack_ext.services.iot_data.provider import IotDataProvider as B;A=B();C=AwsApiListener(_G,MotoFallbackDispatcher(A));return Service(_G,listener=C,lifecycle_hook=A,backend_state_lifecycle=A)
@pro_aws_provider()
...
def mediastore_data():from localstack_ext.services.mediastore.provider import MediaStoreDataProvider as B;A=B();return Service(_H,listener=AwsApiListener(_H,A),lifecycle_hook=A,backend_state_lifecycle=A)
@pro_aws_provider()
...
def qldb_session():from localstack_ext.services.qldb.provider import QldbSessionProvider as B;A=B();return Service(_I,listener=AwsApiListener(_I,A),lifecycle_hook=A,backend_state_lifecycle=A)
@pro_aws_provider()
...
def rds_data():from localstack_ext.services.rds_data.provider import RdsDataProvider as A;B=A();return Service(_J,listener=AwsApiListener(_J,B))
@pro_aws_provider()
...
def redshift_data():from localstack_ext.services.redshift.provider import RedshiftDataProvider as A;B=A();C=AwsApiListener(_K,B);return Service(_K,listener=C)
@pro_aws_provider()
...
def timestream_write():from localstack_ext.services.timestream.provider import TimestreamWriteProvider as B;A=B();return Service(_L,listener=AwsApiListener(_L,A),backend_state_lifecycle=A)
@pro_aws_provider(api=_M)
def timestream_query():from localstack_ext.services.timestream.provider import TimestreamQueryProvider as B;A=B();return Service(_M,listener=AwsApiListener(_M,A),backend_state_lifecycle=A)
@pro_aws_provider()
...
@pro_aws_provider()
def apigateway():from localstack_ext.services.apigateway.apigateway_extended import ApigatewayExtApiListener as B,ApigatewayExtProvider as C;A=C();D=B(_C,MotoFallbackDispatcher(A));return Service(_C,listener=D,lifecycle_hook=A,backend_state_lifecycle=A)
@pro_aws_provider(api=_C,name=_O)
def apigateway_asf():from localstack_ext.services.apigateway.apigateway_extended_asf import AsfApigatewayExtProvider as B;A=B();C=AwsApiListener(_C,MotoFallbackDispatcher(A));return Service(_C,listener=C,lifecycle_hook=A,backend_state_lifecycle=A)
@pro_aws_provider(api=_N)
def awslambda():from localstack.services.awslambda import lambda_starter as A;from localstack_ext.services.awslambda.lambda_extended import patch_lambda as B;from localstack_ext.services.awslambda.persistence import LambdaPersistenceLifeCycle as C;B();return Service(_N,start=A.start_lambda,stop=A.stop_lambda,check=A.check_lambda,backend_state_lifecycle=C(_N))
@pro_aws_provider()
def cloudformation():A='cloudformation';from localstack.services.cloudformation.provider import CloudformationProvider as B;from localstack_ext.bootstrap.persistence_lifecycle import DummyProvider as C;from localstack_ext.services.cloudformation import cloudformation_extended as D;D.patch_cloudformation();E=B();return Service(A,listener=AwsApiListener(A,E),backend_state_lifecycle=C(A))
@pro_aws_provider()
