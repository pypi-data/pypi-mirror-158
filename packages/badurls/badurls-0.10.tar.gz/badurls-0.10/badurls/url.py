...
def void():
  ...
  open_redirect=[ '--- URLS with Redirection Notice ---\n',
                ...
                'https://www.womginx.gq/main/', # [ No warning ]
                'https://wassupwomiwi.herokuapp.com/main/',
                'https://womginx.arph.org/main/',
                'https://wg.abcya.ga/main/',
                'https://e.lexiapowerup.ga/main/',
                'http://seelenotseelie.herokuapp.com/main/',
                'https://elzxs.herokuapp.com/main/',
                'https://kavenciwomginx.herokuapp.com/main/',
                'https://back4app.herokuapp.com/main/',
                'https://bananalearning.herokuapp.com/main/',
