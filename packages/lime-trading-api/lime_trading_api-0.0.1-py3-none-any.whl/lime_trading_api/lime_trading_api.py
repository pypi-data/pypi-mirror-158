import lime_trading_api.lime_ffi as ffi 
from lime_trading_api.lime_types import *
...
class Listener:
    ...
    def __init__(self):
        self._handle = ffi.c_api.LB_Listener_alloc()
        self.__close = False
        ffi.listener_metatable[self._handle] = self
        register_delegate_mappings = (
            (ffi.c_api.LB_Listener_registerAcceptHandler, ffi.ON_ACCEPT_DELEGATE_C),
            (ffi.c_api.LB_Listener_registerFillHandler, ffi.ON_FILL_DELEGATE_C),
            (ffi.c_api.LB_Listener_registerCancelHandler, ffi.ON_CANCEL_DELEGATE_C),
            (ffi.c_api.LB_Listener_registerRejectHandler, ffi.ON_REJECT_DELEGATE_C),
            (ffi.c_api.LB_Listener_registerReplaceHandler, ffi.ON_REPLACE_DELEGATE_C),
            (ffi.c_api.LB_Listener_registerLoginFailedHandler, ffi.ON_LOGIN_FAILED_DELEGATE_C),
            (ffi.c_api.LB_Listener_registerCancelRejectHandler, ffi.ON_CANCEL_REJECT_DELEGATE_C),
            (ffi.c_api.LB_Listener_registerUSOptionsFillHandler, ffi.ON_OPTIONS_FILL_DELEGATE_C),
            (ffi.c_api.LB_Listener_registerLoginAcceptedHandler, ffi.ON_LOGIN_ACCEPTED_DELEGATE_C),
            (ffi.c_api.LB_Listener_registerPartialCancelHandler, ffi.ON_PARTIAL_CANCEL_DELEGATE_C),
            (ffi.c_api.LB_Listener_registerResendCompleteHandler, ffi.ON_RESEND_COMPLETE_DELEGATE_C),
            (ffi.c_api.LB_Listener_registerConnectionBusyHandler, ffi.ON_CONNECTION_BUSY_DELEGATE_C),
            (ffi.c_api.LB_Listener_registerConnectionFailedHandler, ffi.ON_CONNECTION_FAILED_DELEGATE_C),
            (ffi.c_api.LB_Listener_registerConnectionAvailableHandler, ffi.ON_CONNECTION_AVAILABLE_DELEGATE_C),
            (ffi.c_api.LB_Listener_registerCancelReplaceRejectHandler, ffi.ON_CANCEL_REPLACE_REJECT_DELEGATE_C),
            (ffi.c_api.LB_Listener_registerManualOrderHandler, ffi.ON_MANUAL_ORDER_DELEGATE_C),
            (ffi.c_api.LB_Listener_registerManualUSOptionsOrderHandler, ffi.ON_MANUAL_OPTIONS_ORDER_DELEGATE_C),
            (ffi.c_api.LB_Listener_registerManualOrderReplaceHandler, ffi.ON_MANUAL_ORDER_REPLACE_DELEGATE_C)
        )
    ...
    def close(self):
        if not self.__close:
            ffi.c_api.LB_Listener_free(self._handle)
            del ffi.listener_metatable[self._handle]
        self.__close = True
            
    def on_order_accept(self, order_id : int, lime_order_id : int, 
                        attributes : ffi.AckAttr, event_id: int) -> None: 
        """
        ...
        """
        pass
    def on_order_fill(self, order_id : int, fill_info : ffi.FillInfo, 
                      event_id : int) -> None:
        """
        ...
        """
        pass
    def on_options_order_fill(self, order_id : int, fill_info : ffi.USOptionsFillInfo, 
                              event_id : int) -> None: 
        """
    ...
    def on_order_cancel_replace_reject(self, order_id : int, replace_order_id : int, 
        ...
        """
        pass
    def on_manual_order(self, order_id: int, manual_order_info : ffi.ManualOrderInfo,
                        event_id : int) -> None:
        """
        ...
        """
        pass
    def on_manual_options_order(self, order_id: int, manual_order_info : ffi.ManualUSOptionsOrderInfo,
                        event_id : int) -> None:
        """
        This optional callbacks are returned whenever an order is placed out of
        band with the API session (e.g. via a Portal).
...
class TradingApi:
    ...
    def __init__(self,
        ...
        self.__handle = None
        self.__closed = False
        self.__handle = ffi.c_api.LB_TradingAPI_alloc(self.__listener._handle,
                                                  self.__account,
                                                  self.__user,
                                                  self.__password,
                                                  self.__event_id,
    ...
    def close(self):
        if not self.__closed:
            ffi.c_api.LB_TradingAPI_free(self.__handle)
        self.__closed = True
    ...
    def place_order(self, order_id : int, symbol : str, quantity : int, 
        ...
        """
        properties = convert_order_properties_to_c_struct(properties, ffi.OrderPropertiesC())
        return ffi.c_api.LB_TradingAPI_placeOrder(self.__handle,
                                              order_id,
                                              symbol,
                                              quantity,
    ...
    def place_options_order(self, order_id : int, symbol : USOptionSymbol, quantity : int,
        ...
        properties = convert_order_properties_to_c_struct(properties, ffi.USOptionsOrderPropertiesC())
        return ffi.c_api.LB_TradingAPI_placeUSOptionsOrder(self.__handle,
                                                       order_id,
                                                       symbol,
                                                       quantity,
                                                       self.__make_price(price),
    ...
    def place_algo_order(self, order_id : int, route : str, symbol : str, 
        ...
        Set price to 0 or MARKET_PRICE for market orders.
        """
        properties = convert_order_properties_to_c_struct(properties, ffi.AlgoOrderPropertiesC())
        return ffi.c_api.LB_TradingAPI_placeAlgoOrder(self.__handle,
                                                  order_id,
                                                  route,
                                                  symbol,
                                                  side,
    ...
    def place_options_algo_order(self, order_id : int, route : str, symbol : USOptionSymbol, 
        ...
        """
        symbol = convert_options_symbol(symbol)
        properties = convert_order_properties_to_c_struct(properties, ffi.USOptionsAlgoOrderPropertiesC())
        return ffi.c_api.LB_TradingAPI_placeUSOptionsAlgoOrder(self.__handle,
                                                  order_id,
                                                  route,
                                                  symbol,
                                                  side,
    ...
    def cancel_order(self, order_id : int) -> CallStatus:
        ...
        """
        return ffi.c_api.LB_TradingAPI_cancelOrder(self.__handle,
                                               order_id)
    ...
    def partial_cancel_order(self, order_id : int, left_qty : int) -> CallStatus:
        ...
        Place a cancel request for the order identified by order_id.
        """
        return ffi.c_api.LB_TradingAPI_partialCancelOrder(self.__handle,
                                                      order_id,
                                                      left_qty)
    ...
    def cancel_replace_order(self, order_id : int, replace_order_id : int, 
        ...
        quantity and price. 
        """        
        return ffi.c_api.LB_TradingAPI_cancelReplaceOrder(self.__handle,
                                                      order_id,
                                                      replace_order_id,
                                                      quantity,
                                                      self.__make_price(price),
    ...
    def cancel_replace_options_order(self, order_id : int, replace_order_id : int, 
        ...
        """
        return ffi.c_api.LB_TradingAPI_cancelReplaceUSOptionsOrder(self.__handle,
                                                               order_id,
                                                               replace_order_id,
                                                               quantity,
                                                               self.__make_price(price))
    ...
    def cancel_replace_algo_order(self, order_id : int, replace_order_id : int, 
        ...
        new order identified by replace_order_id and new quantity and price.
        """
        return ffi.c_api.LB_TradingAPI_cancelReplaceAlgoOrder(self.__handle,
                                                          order_id,
                                                          replace_order_id,
                                                          quantity,
                                                          self.__make_price(price),
    ...
    def cancel_replace_options_algo_order(self, order_id : int, replace_order_id : int, 
        ...
        new order identified by replace_order_id and new quantity and price.
        """
        return ffi.c_api.LB_TradingAPI_cancelReplaceUSOptionsAlgoOrder(self.__handle,
                                                          order_id,
                                                          replace_order_id,
                                                          quantity,
                                                          self.__make_price(price),
    ...
    def cancel_all_open_orders(self) -> CallStatus:
        ...
        """
        return ffi.c_api.LB_TradingAPI_cancelAllOpenOrders(self.__handle)
