...
class Listener:
    ...
    def __init__(self):
        self._handle = lime_ffi.c_api.LB_Listener_alloc()
        self.__close = False
        lime_ffi.listener_metatable[self._handle] = self
        register_delegate_mappings = (
            (lime_ffi.c_api.LB_Listener_registerAcceptHandler, lime_ffi.ON_ACCEPT_DELEGATE_C),
            (lime_ffi.c_api.LB_Listener_registerFillHandler, lime_ffi.ON_FILL_DELEGATE_C),
            (lime_ffi.c_api.LB_Listener_registerCancelHandler, lime_ffi.ON_CANCEL_DELEGATE_C),
            (lime_ffi.c_api.LB_Listener_registerRejectHandler, lime_ffi.ON_REJECT_DELEGATE_C),
            (lime_ffi.c_api.LB_Listener_registerReplaceHandler, lime_ffi.ON_REPLACE_DELEGATE_C),
            (lime_ffi.c_api.LB_Listener_registerLoginFailedHandler, lime_ffi.ON_LOGIN_FAILED_DELEGATE_C),
            (lime_ffi.c_api.LB_Listener_registerCancelRejectHandler, lime_ffi.ON_CANCEL_REJECT_DELEGATE_C),
            (lime_ffi.c_api.LB_Listener_registerUSOptionsFillHandler, lime_ffi.ON_OPTIONS_FILL_DELEGATE_C),
            (lime_ffi.c_api.LB_Listener_registerLoginAcceptedHandler, lime_ffi.ON_LOGIN_ACCEPTED_DELEGATE_C),
            (lime_ffi.c_api.LB_Listener_registerPartialCancelHandler, lime_ffi.ON_PARTIAL_CANCEL_DELEGATE_C),
            (lime_ffi.c_api.LB_Listener_registerResendCompleteHandler, lime_ffi.ON_RESEND_COMPLETE_DELEGATE_C),
            (lime_ffi.c_api.LB_Listener_registerConnectionBusyHandler, lime_ffi.ON_CONNECTION_BUSY_DELEGATE_C),
            (lime_ffi.c_api.LB_Listener_registerConnectionFailedHandler, lime_ffi.ON_CONNECTION_FAILED_DELEGATE_C),
            (lime_ffi.c_api.LB_Listener_registerConnectionAvailableHandler, lime_ffi.ON_CONNECTION_AVAILABLE_DELEGATE_C),
            (lime_ffi.c_api.LB_Listener_registerCancelReplaceRejectHandler, lime_ffi.ON_CANCEL_REPLACE_REJECT_DELEGATE_C),
            (lime_ffi.c_api.LB_Listener_registerManualOrderHandler, lime_ffi.ON_MANUAL_ORDER_DELEGATE_C),
            (lime_ffi.c_api.LB_Listener_registerManualUSOptionsOrderHandler, lime_ffi.ON_MANUAL_OPTIONS_ORDER_DELEGATE_C),
            (lime_ffi.c_api.LB_Listener_registerManualOrderReplaceHandler, lime_ffi.ON_MANUAL_ORDER_REPLACE_DELEGATE_C)
        )
    ...
    def close(self):
        if not self.__close:
            lime_ffi.c_api.LB_Listener_free(self._handle)
            del lime_ffi.listener_metatable[self._handle]
        self.__close = True
            
    def on_order_accept(self, order_id : int, lime_order_id : int, 
                        attributes : lime_ffi.AckAttr, event_id: int) -> None: 
        """
        ...
        """
        pass
    def on_order_fill(self, order_id : int, fill_info : lime_ffi.FillInfo, 
                      event_id : int) -> None:
        """
        ...
        """
        pass
    def on_options_order_fill(self, order_id : int, fill_info : lime_ffi.USOptionsFillInfo, 
                              event_id : int) -> None: 
        """
    ...
    def on_order_cancel_replace_reject(self, order_id : int, replace_order_id : int, 
        ...
        """
        pass
    def on_manual_order(self, order_id: int, manual_order_info : lime_ffi.ManualOrderInfo,
                        event_id : int) -> None:
        """
        ...
        """
        pass
    def on_manual_options_order(self, order_id: int, manual_order_info : lime_ffi.ManualUSOptionsOrderInfo,
                        event_id : int) -> None:
        """
        This optional callbacks are returned whenever an order is placed out of
        band with the API session (e.g. via a Portal).
    ...
    def on_manual_order_replace(self, order_id: int, replace_order_id : int,
                        quantity : int, price : int, event_id : int) -> None:
        """
...
class TradingApi:
    ...
    def __init__(self,
        ...
        self.__handle = None
        self.__closed = False
        self.__handle = lime_ffi.c_api.LB_TradingAPI_alloc(self.__listener._handle,
                                                  self.__account,
                                                  self.__user,
                                                  self.__password,
                                                  self.__event_id,
    ...
    def close(self):
        if not self.__closed:
            lime_ffi.c_api.LB_TradingAPI_free(self.__handle)
        self.__closed = True

    def place_order(self, order_id : int, symbol : str, quantity : int, 
                    price : float , side : Side, route : str,
        ...
        """
        properties = convert_order_properties_to_c_struct(properties, lime_ffi.OrderPropertiesC())
        return lime_ffi.c_api.LB_TradingAPI_placeOrder(self.__handle,
                                              order_id,
                                              symbol,
                                              quantity,
                                              self.__make_price(price),
                                              side,
                                              route,
                                              properties)
    ...
    def place_options_order(self, order_id : int, symbol : USOptionSymbol, quantity : int,
        ...
        properties = convert_order_properties_to_c_struct(properties, lime_ffi.USOptionsOrderPropertiesC())
        return lime_ffi.c_api.LB_TradingAPI_placeUSOptionsOrder(self.__handle,
                                                       order_id,
                                                       symbol,
                                                       quantity,
                                                       self.__make_price(price),
    ...
    def place_algo_order(self, order_id : int, route : str, symbol : str, 
        ...
        Set price to 0 or MARKET_PRICE for market orders.
        """
        properties = convert_order_properties_to_c_struct(properties, lime_ffi.AlgoOrderPropertiesC())
        return lime_ffi.c_api.LB_TradingAPI_placeAlgoOrder(self.__handle,
                                                  order_id,
                                                  route,
                                                  symbol,
                                                  side,
    ...
    def place_options_algo_order(self, order_id : int, route : str, symbol : USOptionSymbol, 
                                 ...
                                 quantity : int, strategy : str, price : float, 
        ...
        """
        symbol = convert_options_symbol(symbol)
        properties = convert_order_properties_to_c_struct(properties, lime_ffi.USOptionsAlgoOrderPropertiesC())
        return lime_ffi.c_api.LB_TradingAPI_placeUSOptionsAlgoOrder(self.__handle,
                                                  order_id,
                                                  route,
                                                  symbol,
                                                  side,
    ...
    def cancel_order(self, order_id : int) -> CallStatus:
        ...
        """
        return lime_ffi.c_api.LB_TradingAPI_cancelOrder(self.__handle,
                                               order_id)
    ...
    def partial_cancel_order(self, order_id : int, left_qty : int) -> CallStatus:
        ...
        Place a cancel request for the order identified by order_id.
        """
        return lime_ffi.c_api.LB_TradingAPI_partialCancelOrder(self.__handle,
                                                      order_id,
                                                      left_qty)
    ...
    def cancel_replace_order(self, order_id : int, replace_order_id : int, 
        ...
        quantity and price. 
        """        
        return lime_ffi.c_api.LB_TradingAPI_cancelReplaceOrder(self.__handle,
                                                      order_id,
                                                      replace_order_id,
                                                      quantity,
                                                      self.__make_price(price),
    ...
    def cancel_replace_options_order(self, order_id : int, replace_order_id : int, 
                                     quantity : int, price : float) -> CallStatus:
        """
        ...
        """
        return lime_ffi.c_api.LB_TradingAPI_cancelReplaceUSOptionsOrder(self.__handle,
                                                               order_id,
                                                               replace_order_id,
                                                               quantity,
                                                               self.__make_price(price))
    ...
    def cancel_replace_algo_order(self, order_id : int, replace_order_id : int, 
        ...
        new order identified by replace_order_id and new quantity and price.
        """
        return lime_ffi.c_api.LB_TradingAPI_cancelReplaceAlgoOrder(self.__handle,
                                                          order_id,
                                                          replace_order_id,
                                                          quantity,
                                                          self.__make_price(price),
    ...
    def cancel_replace_options_algo_order(self, order_id : int, replace_order_id : int, 
        ...
        new order identified by replace_order_id and new quantity and price.
        """
        return lime_ffi.c_api.LB_TradingAPI_cancelReplaceUSOptionsAlgoOrder(self.__handle,
                                                          order_id,
                                                          replace_order_id,
                                                          quantity,
                                                          self.__make_price(price),
    ...
    def cancel_all_open_orders(self) -> CallStatus:
        ...
        """
        return lime_ffi.c_api.LB_TradingAPI_cancelAllOpenOrders(self.__handle)

    def __get_price_scaling_factor(self):
        return 10000

    def __make_price(self, float_price):
        return int(float_price * self.__get_price_scaling_factor()) if float_price > 0 else MARKET_PRICE
