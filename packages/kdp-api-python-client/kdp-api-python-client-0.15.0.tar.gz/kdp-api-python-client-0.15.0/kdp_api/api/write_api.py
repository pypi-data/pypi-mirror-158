...
class WriteApi(object):
    ...
    def write(
        ...
        **kwargs
        ...
        Writes a batch of records to random partitions and returns a list of partitions data was written to  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.write(dataset_id, json_record, async_req=True)
        >>> result = thread.get()
