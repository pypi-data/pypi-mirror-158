...
class IngestApi(object):
    ...
    def create_ingest_job(
        ...
        **kwargs
        ...
        Accepts ingest request and create segments/jobs as well as publish a message to Kafka  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_ingest_job(ingest_request, async_req=True)
        >>> result = thread.get()
