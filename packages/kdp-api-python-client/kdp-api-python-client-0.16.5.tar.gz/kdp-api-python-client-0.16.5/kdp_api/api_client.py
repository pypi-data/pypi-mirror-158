...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'OpenAPI-Generator/0.16.5/python'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = IngestApi()
        api_instance.create_ingest_job  # this is an instance of the class Endpoint
        api_instance.create_ingest_job()  # this invokes api_instance.create_ingest_job.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_ingest_job.callable or self.callable in this class
