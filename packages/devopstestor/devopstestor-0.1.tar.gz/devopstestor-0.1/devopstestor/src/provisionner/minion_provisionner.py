...
class MinionProvisionner(AbstractProvisionner):
    ...
    def runStateApply(self, sls_cible=None, saltenv=None, pillar={}):
        ...
        ret, salt_stdout = self.run_salt_cmd(
            'salt-call state.apply {} {} {} -l quiet --log-file-level {} --retcode-passthrough  queue=True --out=json'.format(sls_cible, env, pillar, self.global_config.get('provisionner::log_level'))
        )
        output = ""
