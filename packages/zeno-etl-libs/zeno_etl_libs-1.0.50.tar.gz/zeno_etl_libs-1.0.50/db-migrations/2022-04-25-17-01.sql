CREATE TABLE IF NOT EXISTS "prod2-generico"."distributor-features-franchisee"
(
	...
	,"store-drug-type-level-dist-1" DOUBLE PRECISION   ENCODE RAW
	,"store-drug-type-level-dist-2" DOUBLE PRECISION   ENCODE RAW
	,"store-drug-type-level-dist-3" DOUBLE PRECISION   ENCODE RAW
...
ALTER TABLE "prod2-generico"."distributor-features-franchisee" owner to "admin";