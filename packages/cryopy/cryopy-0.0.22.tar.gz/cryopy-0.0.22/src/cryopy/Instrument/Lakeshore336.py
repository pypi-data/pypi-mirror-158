...
def query_identification(address):
    ...
    import cryopy
    manufacturer,model,instrument_serial,option_serial,firmware_version = cryopy.Instrument.Lakeshore336.identification_query('GPIB0::15::INSTR')
...
def query_temperature(address):
    ...
    import cryopy
    temperature_a,temperature_b,temperature_c,temperature_d = cryopy.Instrument.Lakeshore336.temperature_query('GPIB0::15::INSTR')
...
def query_input_reading_status(address):
    ...
    import cryopy
    input_reading_status = cryopy.Instrument.Lakeshore336.input_reading_status_query('GPIB0::15::INSTR')
...
def query_pid_parameters(address, output):
    ...
    import cryopy
    p,i,d= cryopy.Instrument.Lakeshore336.pid_parameters_query('GPIB0::15::INSTR')
...
def command_pid_parameters(address,p,i,d,output):
    ...
    import cryopy
    cryopy.Instrument.Lakeshore336.pid_parameters_command('GPIB0::15::INSTR',P,I,D)
...
def command_remote_interface_mode(address,mode):
    ...
    import cryopy
    cryopy.Instrument.Lakeshore336.remote_interface_mode_command('GPIB0::15::INSTR',1)
...
def command_autotune(address,output,mode):
    ...
    import cryopy
    cryopy.Instrument.Lakeshore336.autotune_command('GPIB0::15::INSTR',2,1)
