...
class ZTBaseBoard:
    ...
    def empty_positions(self) -> List[int]:
        """List containing the empty positions of the board
    ...
    def empty_corners(self) -> List[int]:
        """List containing the empty corners of the board
    ...
    def empty_edges(self) -> List[int]:
        """List containing the empty edges of the board
    ...
    def highlighted(self) -> List[int]:
        """Returns the highlighted positions of the board when there is a winner
    ...
    @on_move.setter
    def on_move(self, on_move: Callable[[int, int], None]):
        """Sets the on_move event trigger

        :param on_move: The on_move callable
        :type on_move: Callable[[int, int], None]
        :raise: TypeError if on_move is not a callable
        """

        if type(on_move) is not callable:
    ...
    def on_finish(self):
        ...
        :return: on_finish event trigger
        :rtype: Callable[[int], None]
        """
        return self._on_finish

    @on_finish.setter
    def on_finish(self, on_finish: Callable[[int], None]):
        """Sets the on_move event trigger

        :param on_finish: The on_finish callable
        :type on_finish: Callable[[int], None]
        :raise: TypeError if on_finish is not a callable
        """
        if type(on_finish) is not callable:
            raise TypeError('on_move must be a function')
    ...
    def _verify_pos(self, pos: int) -> None:
        ...
        :type pos: int
        :raise: ZTGameException if the position is not empty
        """
    ...
    def __play_player_move(self, player: int, pos: int) -> bool:
        ...
        :raise: ZTGameException if the move is invalid
        """
